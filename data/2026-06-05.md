...
### [1] [A microscopic design rule for spin supersolids in triangular-lattice magnets](https://arxiv.org/abs/2606.06111)
...
### [2] [Unveiling orbital landscapes in strongly correlated bulk nickelates with $s$-NIXS](https://arxiv.org/abs/2606.06144)
...
### [3] [Discovery of hidden order in the Shastry-Sutherland magnet Nd2Be2GeO7](https://arxiv.org/abs/2606.06279)
...
### [5] [Revealing quantum geometry effects in magic angle twisted bilayer graphene using the circular photogalvanic effect](https://arxiv.org/abs/2606.06389)
...
### [7] [Enhancement of charge correlations and real-space topological marker on an interacting non-Hermitian Su-Schrieffer-Heeger model](https://arxiv.org/abs/2606.06466)
...
### [8] [Ideal Quantum Geometry for Fractional Chern Insulators](https://arxiv.org/abs/2606.05496)
...
### [9] [Odd-parity magnons in the Haldane-Hubbard model from topological exciton condensation](https://arxiv.org/abs/2606.05837)
...
### [10] [Majorana-like fermion physics: Emergence of topologically protected vortical states in graphene interacting with an electromagnetic field](https://arxiv.org/abs/2606.05746)
...
### [11] [Breakdown of Fluctuational Electrodynamics in the Extreme Near Field](https://arxiv.org/abs/2606.05845)
...
### [12] [Quantum Thermal Logic Gates](https://arxiv.org/abs/2606.06432)
...
### [13] [1/3 Fractional and Gapless Integer Quantum Anomalous Hall States in Rhombohedral Graphene](https://arxiv.org/abs/2606.06450)
...
### [14] [Superconducting triode effect in a quantum-dot Josephson junction with a biased top gate](https://arxiv.org/abs/2606.06465)
...
### [15] [Realistic quantum device data synthesized by consumer AI and how to identify it](https://arxiv.org/abs/2606.05472)
...
### [16] [Coherent room-temperature dipole synchronization in nanocavity sheets](https://arxiv.org/abs/2606.06490)
...
### [17] [Magnetic-field driven hybridization of heavy- and light-hole Rydberg excitons in GaAs quantum wells](https://arxiv.org/abs/2606.05267)
...
### [18] [Towards stable and accurate electron dynamics via neural network based time-dependent variational Monte Carlo](https://arxiv.org/abs/2606.05850)
...
### [20] [2.4 GHz Flip-flop Device within Nonequilibrium Superconducting Diode](https://arxiv.org/abs/2606.06152)
...
### [21] [Particle-Hole Ghost Interference in Superconductors](https://arxiv.org/abs/2606.06437)
...
### [22] [Fermiology and the Candidate Chiral Superconductor in Rhombohedral Tetralayer Graphene](https://arxiv.org/abs/2606.05356)
...
### [24] [Superconductivity beyond band geometry: emergence of pair quantum geometry](https://arxiv.org/abs/2606.06017)
...
### [25] [Heavy-element paleodetectors for Higgsino dark matter](https://arxiv.org/abs/2606.05299)
...
### [26] [NNLO+PS Higgs-pair production in MiNNLOPS](https://arxiv.org/abs/2606.05300)
...
### [27] [Interference effects in gluon-fusion Higgs boson production](https://arxiv.org/abs/2606.05309)
...
### [28] [Gravitational Wave Imprints of a High-Quality Axion and the Origin of Flavor Hierarchies](https://arxiv.org/abs/2606.05320)
...
### [29] [Muon-induced di-tau production as a probe of new physics](https://arxiv.org/abs/2606.05406)
...
### [30] [BSMArt 2: simpler and faster parameter space scans](https://arxiv.org/abs/2606.05410)
...
### [31] [Diffractive open charm photoproduction in ultraperipheral lead-lead and proton-lead collisions at the LHC](https://arxiv.org/abs/2606.05469)
...
### [32] [Pion structure in Holographic QCD](https://arxiv.org/abs/2606.05583)
*Jiali Deng,Defu Hou*
...
### [33] [QCD Sum Rule Analysis of a Compact $D^{+}D^{-}K^{+}$-Like Hidden-Charm Hexaquark with $J^{P}=0^{-}$](https://arxiv.org/abs/2606.05638)
...
### [34] [Probing Quantum Numbers and Decay Branching Ratios of Exotic States via Entanglement-Enabled Spin Interference](https://arxiv.org/abs/2606.05691)
...
### [35] [Pion transitions in the Born-Oppenheimer Effective Field Theory: a long distance approach](https://arxiv.org/abs/2606.05791)
...
### [36] [Search for heavy Majorana neutrinos at muon-proton colliders via lepton-number-violating signals](https://arxiv.org/abs/2606.05962)
*Yao-Bei Liu*
...
### [37] [Bulk viscosity of a binary mixture: the role of the intra-species interaction](https://arxiv.org/abs/2606.06105)
...
### [38] [Vector charmonium(-like) states in the energy range of 4.1-4.6 GeV](https://arxiv.org/abs/2606.06180)
...
### [39] [Spin-orbit correlation of quarks within quarkonium](https://arxiv.org/abs/2606.06263)
...
### [40] [Diffusion of multiple conserved charges from entropy production](https://arxiv.org/abs/2606.06283)
...
### [41] [Probing SU(2) Quark Flavor Asymmetry with W Bosons at RHIC](https://arxiv.org/abs/2606.06383)
...
### [42] [Wave-Tide Locking in Thin Stellar Streams: A Phenomenological Mass Spectrometer for an Intermediate Ultralight Axion](https://arxiv.org/abs/2606.06394)
*Peter H. Tsang*
...
### [43] [Machine Learning for Predicting the Proton Structure Function $F_2^P$ in QCD](https://arxiv.org/abs/2606.06414)
...
### [44] [Probing anomalous quartic gauge couplings in same-sign $W$ boson scattering with polarization and spin correlation](https://arxiv.org/abs/2606.06436)
...
### [45] [Method to study $CP$ violation in $B_s^0\to K_S K^\pm π^\mp$ decays](https://arxiv.org/abs/2606.06446)
...
### [46] [Hydrogen-induced lattice cohesion weakening favors atomic displacement](https://arxiv.org/abs/2606.05325)
...
### [47] [Interplay of non-local transport and local scattering during electron thermalization and spatial equilibration in laser-excited metals](https://arxiv.org/abs/2606.05457)
...
### [48] [Resolving room temperature microscale fracture and plasticity of iron oxides along the cascade of iron ore reduction via nanoindentation and microcantilever bending](https://arxiv.org/abs/2606.06001)
...
### [49] [Stacking-Dependent Magnetism and Tunable Half-Metallicity in Bilayer Janus 1T-MnSSe](https://arxiv.org/abs/2606.06146)
...
### [50] [Endowing variational phase-field fracture models with custom strength criteria](https://arxiv.org/abs/2606.06169)
...
### [51] [Optical Signature of Moiré Superlattices Formed by Twisted SrTiO$_3$ Membranes](https://arxiv.org/abs/2606.06289)
...
### [52] [PolyGraphPy: A unified Python framework for atomistic simulation and machine learning-driven polymer design](https://arxiv.org/abs/2606.06415)
