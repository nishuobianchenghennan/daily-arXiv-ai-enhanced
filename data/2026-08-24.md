...
### [20] [Note on proliferation transitions of non-Abelian anyons](https://arxiv.org/abs/2608.20604)
*Meng Cheng*
...
### [21] [Neural quantum states in condensed matter: advances, best practices, and prospects](https://arxiv.org/abs/2608.21291)
...
### [22] [Distinguishing Mott and strain-induced anisotropic semimetals in magic-angle twisted bilayer graphene using Landau level spectroscopy](https://arxiv.org/abs/2608.20694)
...
### [23] [Electronic Toroidal Metals: Landau Theory and Magnetoelectric Fingerprints](https://arxiv.org/abs/2608.20838)
...
### [24] [Doping-driven Mott transition from steady-state density functional theory](https://arxiv.org/abs/2608.21029)
...
### [25] [Berry-Curvature Effect in Anomalous Transport](https://arxiv.org/abs/2608.21161)
*V. P. Mineev*
...
### [26] [Emergent Vibronic Spectral Hierarchy in a Kagome Flat-Band Insulator](https://arxiv.org/abs/2608.21250)
...
### [27] [Two distinct gap structures in the mid-infrared optical conductivity of the Hubbard model](https://arxiv.org/abs/2608.21284)
...
### [28] [Ultralow-Field Triplon Condensation in a Spin-Ladder Magnet](https://arxiv.org/abs/2608.21316)
...
### [29] [Calibrating Inelastic Markets to Options: The Lean Marketron and the Generalized Langevin Equation](https://arxiv.org/abs/2608.20589)
*Andrey Itkin*
...
### [30] [Scalable photoexcitation-induced molecular dynamics with machine-learned Hamiltonians](https://arxiv.org/abs/2608.20994)
...
### [31] [On Transmission Function Amplitude and Phase Recovery in Multislice Electron Ptychography](https://arxiv.org/abs/2608.21007)
...
### [32] [An LLM agent for end-to-end computational materials discovery](https://arxiv.org/abs/2608.20434)
...
### [33] [Carrier Capture at Defects from Finite-Temperature Lattice Dynamics](https://arxiv.org/abs/2608.20491)
...
### [34] [Revealing the Role of Confined Molecular H$_2$ in the Passivation of Defective Silicon Using First-Principles Simulations](https://arxiv.org/abs/2608.20514)
...
### [35] [Interplay of nonrelativistic and relativistic spin splittings in altermagnets](https://arxiv.org/abs/2608.20528)
...
### [36] [AutoMOOSE: Use Case and Logical Views of Agentic Phase-Field Simulation Software](https://arxiv.org/abs/2608.20571)
...
### [37] [Machine Learning Guided Discovery of Corundum High Entropy Oxides](https://arxiv.org/abs/2608.20596)
...
### [38] [Orbital-Selective Spin Splitting in the Altermagnetic Ti$_2$XX' Monolayers](https://arxiv.org/abs/2608.20695)
...
### [39] [Magnetic-Field Selection of Magnetic Order in Altermagnets and Noncollinear Antiferromagnets](https://arxiv.org/abs/2608.20700)
...
### [40] [Prediction of a layer nonlinear Hall effect in bilayer nonmagnetic or antiferromagnetic systems](https://arxiv.org/abs/2608.20724)
...
### [41] [First-principles design of main-group dimer defects in ZnO as candidate quantum defects](https://arxiv.org/abs/2608.20837)
...
### [42] [Quasi-one-dimensional topological band structure and van Hove singularities in monolayer TaIrTe$_4$ from laser $μ$-ARPES](https://arxiv.org/abs/2608.20978)
...
### [43] [Systematic and accurate anharmonic formation free energies of metastable defects via a constrained Bayesian Adaptive Biasing Force framework](https://arxiv.org/abs/2608.20902)
...
### [44] [Broken Inversion Symmetry via a Magic Methyl Effect](https://arxiv.org/abs/2608.20957)
...
### [45] [Scalable Cyclic Olefin Copolymer Encapsulation for High Optical Quality of TMD Monolayers](https://arxiv.org/abs/2608.20973)
...
### [46] [Identification of the length scale parameter of simplified strain gradient elasticity from standard Mode I fracture tests](https://arxiv.org/abs/2608.21016)
...
### [47] [Soft and chiral phonons in chiral phase of K3NiO2](https://arxiv.org/abs/2608.21025)
...
### [48] [Sulfur-rich Spirofluorene-Bridged N Heterotriangulene Redox-Active Polymers](https://arxiv.org/abs/2608.21037)
...
### [49] [Symmetry-engineering ferroelectricity in silicon dioxides](https://arxiv.org/abs/2608.21149)
*Yin Dai,Menghao Wu*
...
### [50] [Chemical Control of Electronic Structure and Topology in Tellurium-Encapsulated Silicene](https://arxiv.org/abs/2608.21295)
...
### [51] [Dirac Surface States and Nonlocal Quantum Tunneling in Topological Semiconductor Mo$_2$SeTe$_3$ for High-Performance Tunnel FETs](https://arxiv.org/abs/2608.21333)
...
### [52] [Resolving positive semi-definiteness in physics-informed kernels for scientific machine learning](https://arxiv.org/abs/2608.20985)
...
### [53] [Tunneling from a Slowly Rolling Multifield Background Using Tadpole Subtraction](https://arxiv.org/abs/2608.20451)
*Masaki Yamada*
...
### [54] [Poles in $πN$ scattering from forward dispersion relations and revised total cross-section data](https://arxiv.org/abs/2608.20458)
...
### [55] [First Search for Ultraheavy Dark Matter Using a Magnetically Levitated Particle](https://arxiv.org/abs/2608.20464)
...
### [56] [Muon Capture on the Proton with Heavy-Light Currents](https://arxiv.org/abs/2608.20468)
...
### [57] [Intensity-Frontier Signals of Warped Extra Dimensions](https://arxiv.org/abs/2608.20482)
...
### [58] [Probing Non-Holomorphic Modular $A_4$ Double Seesaw: Signatures in Neutrino Oscillation Experiments and Implications for Leptogenesis](https://arxiv.org/abs/2608.20508)
...
### [59] [A window for the mixed same-sign signature in the type-II seesaw models](https://arxiv.org/abs/2608.20708)
*Cheng-Wei Chiang*
...
### [60] [Dielectric Response for Light Dark Matter Direct Detection Beyond the Longitudinal Approximation](https://arxiv.org/abs/2608.20715)
...
### [61] [Qubits for Dark Matter Hunting](https://arxiv.org/abs/2608.20745)
*Takeo Moroi*
...
### [62] [Anomaly-free axion-like particle in Nelson-Barr models](https://arxiv.org/abs/2608.20773)
...
### [63] [The role of triangle singularity in the $B^0 \to D^- π^+ a_0(980)(π^0 η)$ decay](https://arxiv.org/abs/2608.20835)
...
### [64] [The excited baryon spectrum from a unified quark model](https://arxiv.org/abs/2608.20892)
...
### [65] [The ABC of RPV III: Classification of R-parity Violating Signatures from LQD Couplings and their Coverage at the LHC](https://arxiv.org/abs/2608.21033)
...
### [66] [Unraveling QCD dynamics with heavy quark energy correlators](https://arxiv.org/abs/2608.21145)
*Ivan Vitev*
...
### [67] [The electron parton distribution functions at the NNLO in QED](https://arxiv.org/abs/2608.21181)
...
### [68] [Higgs Boson plus Quark Pair Production at High Energies as di-Higgs Background](https://arxiv.org/abs/2608.21195)
...
### [69] [Implications of two-channel rescattering for charm CP violation from precise dispersive data](https://arxiv.org/abs/2608.21212)
...
### [70] [Efficient Event Generation for High-Multiplicity LHC Processes: An End-to-End GPU Workflow with Normalizing Flows](https://arxiv.org/abs/2608.21338)
