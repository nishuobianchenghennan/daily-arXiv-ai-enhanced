...
### [1] [Testing Lepton Wave Function Factorization in $^{71}\text{Ge}$ Electron Capture](https://arxiv.org/abs/2608.00120)
...
### [2] [Low-lying singly heavy baryon states based on the rigorous calculation with the relativized quark model](https://arxiv.org/abs/2608.00142)
...
### [3] [Extra-dimensional Origins of Chemical Potentials at the Cosmological Collider](https://arxiv.org/abs/2608.00158)
...
### [4] [Ubiquitous Corotation of Dark Matter Halos: Implications for Direct Detection](https://arxiv.org/abs/2608.00161)
...
### [5] [The flavour of SU(15) composite quarks and leptons](https://arxiv.org/abs/2608.00166)
...
### [6] [Large-Field Vacuum Decay in General Multi-Scalar Theories](https://arxiv.org/abs/2608.00216)
...
### [7] [Determination of the $η$-$η^{\prime}$ Mixing Angle from $F_{η^{(\prime)}γ}(Q^2)$ within the Self-consistent Light-front Quark Model](https://arxiv.org/abs/2608.00407)
*Shuai Xu*
...
### [8] [Matter-Induced CPT Violation and Earth-Density Stratification Effects in Long-Baseline Neutrino Oscillation Experiments](https://arxiv.org/abs/2608.00436)
...
### [9] [Kinetic backreaction cannot suppress axion quantum pressure](https://arxiv.org/abs/2608.00472)
...
### [10] [Nelson-Barr Inflation](https://arxiv.org/abs/2608.00498)
*Fuminobu Takahashi*
...
### [11] [Dipole-dipole scattering at high energy in the Pomeron field theory with Braun Hamiltonian and beyond](https://arxiv.org/abs/2608.00506)
*Eugene Levin*
...
### [12] [Mass spectra of Tetraquark States from the Spinless Salpeter Equation](https://arxiv.org/abs/2608.00553)
...
### [13] [Pion-photon transition form factor with analytic coupling](https://arxiv.org/abs/2608.00564)
...
### [14] [Complex chromoelectric polarizability of a heavy-quarkonium resonance: pole definition and channel-complete pNRQCD matching](https://arxiv.org/abs/2608.00611)
*Arkadiy I. Syamtomov*
...
### [15] [Scalaron-driven Dark Matter during Warm Inflation via UV Freeze--in](https://arxiv.org/abs/2608.00874)
*F. Millo*
...
### [16] [Misconceptions About the Physics of the QCD Trace Anomaly from Renormalization in a Reducible Basis](https://arxiv.org/abs/2608.01002)
*Chen Yang*
...
### [17] [Thermal Evolution and Hydrodynamic Filtering of Pseudoscalar Dark Matter](https://arxiv.org/abs/2608.01100)
...
### [18] [Model analysis on the effectiveness of the HAL QCD method for hadron-hadron interactions](https://arxiv.org/abs/2608.01225)
...
### [19] [A femtoscopic tale of two $C$-parities: the $Z_c(3900)$ and the isovector partner of the $X(3872)$](https://arxiv.org/abs/2608.01237)
...
### [20] [Properties of the $D_{s0}^*(2317)^\pm$ in hot and dense nuclear matter](https://arxiv.org/abs/2608.01272)
...
### [21] [Constraints on Light Self-Interacting Dark Matter from Plasmon-Enhanced Direct Detection](https://arxiv.org/abs/2608.01305)
...
### [22] [Impact of Higgs precision measurements at the LHC and FCC-ee on the spectrum of composite Higgs models](https://arxiv.org/abs/2608.01353)
...
### [23] [The CKM sector of the exceptional-Jordan programme: finite-Dirac mass moduli, two conditional angle estimates, and the weak-to-mass bridge](https://arxiv.org/abs/2608.01445)
*Tejinder P. Singh*
...
### [24] [What are the consequences of independent factorization and renormalization scales?](https://arxiv.org/abs/2608.01489)
...
### [25] [Search for active-sterile neutrino transitions using Pierre Auger Observatory data](https://arxiv.org/abs/2608.01496)
...
### [26] [Magnetic field modifications to the pion-quark vertex in the Linear Sigma Model with quarks](https://arxiv.org/abs/2608.01701)
...
### [28] [Odderon exchange in high-energy $K^0_S$ regeneration at the LHC](https://arxiv.org/abs/2608.01768)
...
### [29] [Gluon condensate effects on heavy quarkonium spectral functions and thermal dissociation](https://arxiv.org/abs/2608.01801)
...
### [30] [Measuring the trilinear Higgs self-coupling in Higgs boson pair production at multi-TeV muon colliders](https://arxiv.org/abs/2608.01888)
...
### [31] [Thermal Leptogenesis in the BNT Model of Neutrino Mass](https://arxiv.org/abs/2608.01890)
...
### [32] [A quality-coupling relation in chiral $U(1)_{B-L}$ axion model](https://arxiv.org/abs/2608.01897)
*Yu-Cheng Qiu*
...
### [33] [The $(2+1)$-dimensional Gross-Neveu-Yukawa model at finite temperature, density, and magnetic field within the Functional Renormalization Group](https://arxiv.org/abs/2608.02280)
...
### [34] [FCC precision requests: challenges for Monte Carlos and phenomenology tools](https://arxiv.org/abs/2608.02476)
*Z. Was*
...
### [35] [Two-loop amplitude for $t\bar{t}W$ production at hadron colliders in the leading colour approximation](https://arxiv.org/abs/2608.02527)
*Mattia Pozzoli*
...
### [36] [Ion Flow under an Applied Electric Field in Semiconducting and Metallic Carbon Nanotubes](https://arxiv.org/abs/2608.00211)
*J. B. Sokoloff*
...
### [37] [Universal scaling of the Anomalous Hall voltage of magnetic layer with the adjacent conducting layer](https://arxiv.org/abs/2608.00385)
...
### [38] [Planar Interfaces for Transmission of Chiral Spin Textures](https://arxiv.org/abs/2608.00388)
...
### [39] [Skyrmion Excitations in the $ν=-1$ Quantum Hall state in Monolayer Graphene](https://arxiv.org/abs/2608.00390)
...
### [40] [Correlated Insulator Moiré Bolometer](https://arxiv.org/abs/2608.00488)
...
### [41] [Spin selectivity induced by non-collinear spins in Rashba wires](https://arxiv.org/abs/2608.00599)
...
### [42] [How NOT to build control-target gates in semiconductor quantum dots and beyond](https://arxiv.org/abs/2608.00733)
...
### [43] [Magnetoelastic control of quantum correlations and field sensitivity in a spin-1/2 Heisenberg dimer](https://arxiv.org/abs/2608.00777)
...
### [44] [Time-dependent Berry curvature and quantum metric of Floquet-Bloch states](https://arxiv.org/abs/2608.01096)
...
### [45] [Suppressed plasmon excitations, enhanced damping and static screening in Kek-Y strained $α-\mathcal{T}_3$ model](https://arxiv.org/abs/2608.01213)
...
### [46] [Microwave Response of the Superconducting Diode Effect in Proximitized Bilayer Graphene Interferometers](https://arxiv.org/abs/2608.01313)
...
### [47] [Bulk-Boundary Correspondence in Semi-Infinite Chains from Sublattice Zeros](https://arxiv.org/abs/2608.01368)
...
### [48] [Layer-Hybridized Wigner Crystals in MoSe2/WS2 Moiré Superlattice](https://arxiv.org/abs/2608.01553)
...
### [49] [Non-linear spin current in the surface states of topological insulators](https://arxiv.org/abs/2608.01782)
...
### [50] [Wannier-Stark localization, confinement and edge states](https://arxiv.org/abs/2608.01902)
...
### [51] [Extracting higher-order nonlinearities in nanomechanical resonators using the backbone relation](https://arxiv.org/abs/2608.02008)
...
### [52] [Emission dynamics in zincblende InAsxP1-x quantum dots in InP nanowires: influence of quantum dot size, composition and nanowire geometry](https://arxiv.org/abs/2608.02029)
...
### [53] [Resolving High-Energy States of Interlayer Excitons in MoSe$_2$/WSe$_2$ Heterostructures](https://arxiv.org/abs/2608.02040)
...
### [54] [Complete Structural Determination of Mesostructural Dodecagonal Quasicrystalline Particles](https://arxiv.org/abs/2608.02142)
...
### [55] [Time reversal symmetry broken quantum spin hall effect in pseudospin-1 Dirac-Rashba system](https://arxiv.org/abs/2608.02152)
...
### [56] [Band topology and symmetry-driven magneto-optical response in two-dimensional d-wave altermagnets with staggered spin-orbit coupling](https://arxiv.org/abs/2608.02155)
...
### [57] [Charge Tunable Optical Nonlinearity of Moiré Exciton-Polaritons](https://arxiv.org/abs/2608.02165)
...
### [58] [Proximity effects of chiral magnetization on transition metal dichalcogenides monolayers](https://arxiv.org/abs/2608.02241)
...
### [59] [Valley-controlled chiral magnetism in transition metal dichalcogenide monolayers](https://arxiv.org/abs/2608.02260)
...
### [60] [Optical switching of magnetic order in few-layer CrSBr](https://arxiv.org/abs/2608.02337)
...
### [61] [Second-harmonic generation in twisted double bilayer graphene: Double-resonant enhancement from moiré flat bands](https://arxiv.org/abs/2608.02384)
...
### [62] [Floquet spin-group framework and its application to light-tailored spin splitting in collinear magnets](https://arxiv.org/abs/2608.02393)
...
### [63] [Discrete states and ballistic interference in quantum wires approaching macroscopic lengths](https://arxiv.org/abs/2608.02431)
...
### [64] [Comparison of Lindblad and circuit approaches for quantum heat transport](https://arxiv.org/abs/2608.02511)
*Bayan Karimi*
...
### [65] [Strain engineering of transient exciton diffusion in WSe2 monolayers at cryogenic temperatures](https://arxiv.org/abs/2608.02513)
...
### [66] [Thermal Stability of Two-Dimensional Crystals with Extended OH Hydrogen-Bonded Chains](https://arxiv.org/abs/2608.02544)
*Alexander V. Savin*
...
### [67] [Magnetic Skyrmion Interacting with Optical Skyrmion](https://arxiv.org/abs/2608.02552)
...
### [68] [Rhombohedral Graphene: A Tale of Many Crystals](https://arxiv.org/abs/2608.00167)
...
### [69] [Shape of Wigner Crystals and Hole Self-Doping in a Mexican-Hat Dispersion](https://arxiv.org/abs/2608.00170)
...
### [70] [Chiral Magnon Mixing by Symmetry-Breaking in Collinear Ferrimagnets](https://arxiv.org/abs/2608.00210)
...
### [71] [Interplay of spin-orbit coupling, crystal field splitting and correlations: a ghost rotationally invariant slave boson treatment](https://arxiv.org/abs/2608.00254)
...
### [72] [Breakdown of Universal Whirling Order in a Heisenberg Tsai-Type Approximant](https://arxiv.org/abs/2608.00467)
...
### [73] [Negative thermal expansion, lattice dynamics, and complex magnetism in TbFeO$_3$](https://arxiv.org/abs/2608.00469)
...
### [74] [Spin-orbit-entangled frustrated magnetism in fcc Ba$_2$(Yb,Nd)NbO$_6$ double perovskites](https://arxiv.org/abs/2608.01022)
...
### [75] [Magnetic circular dichroism of THz modes and selection rules of Raman-active optical phonons in the polar altermagnet candidate \ce{Mn2Mo3O8}](https://arxiv.org/abs/2608.01062)
...
### [76] [Pressure-induced self-doping and Fermi surface reconstruction in UAs2](https://arxiv.org/abs/2608.01244)
...
### [77] [All-Electric Topological Phase Transitions in Proximity-Coupled Bilayer MnBi2Te4 Heterostructures](https://arxiv.org/abs/2608.01312)
...
### [78] [Quantum geometry and RKKY in flat bands](https://arxiv.org/abs/2608.01363)
...
### [79] [Emergent modular Luttinger liquid from spin-partitioned entanglement in the one-dimensional Hubbard model](https://arxiv.org/abs/2608.01817)
...
### [80] [Topological Defects in Triple-$Q$ Magnetic Orders: A Fixed-Lattice Homotopy Classification](https://arxiv.org/abs/2608.01838)
*Jin-Tao Jin,Yi Zhou*
...
### [81] [Diodes and capacitors for the transport of monopoles in fragmented spin ice](https://arxiv.org/abs/2608.01883)
...
### [82] [Microscopic magnetic phase evolution in the Weyl semimetal Mn$_3$Sn revealed by $μ^+$SR](https://arxiv.org/abs/2608.01892)
...
### [83] [Pressure-Driven Evolution of Electronic and Magnetic Correlations in Bilayer Nickelate La3Ni2O7](https://arxiv.org/abs/2608.02261)
...
### [84] [Long and short time linear response of metals: a geometric approach](https://arxiv.org/abs/2608.02298)
...
### [85] [Optimized Tensor-Network Renormalization for Quantum Dynamics: Resolving the Spectral Function of $\mathrm{K_2Co(SeO_3)_2}$](https://arxiv.org/abs/2608.02473)
...
### [86] [Latent Flow Matching for Arbitrage-Aware Implied Volatility Surface Generation](https://arxiv.org/abs/2608.00616)
...
### [87] [Battery Storage Co-Optimization in Day-Ahead and Real-Time Markets with Bayesian Optimization](https://arxiv.org/abs/2608.00911)
...
### [88] [Analytical Charge Density Profile of Vortex Core in Weak-Coupling Superconductor](https://arxiv.org/abs/2608.00226)
*Chi-Ken Lu*
...
### [89] [Ferroelectric superconductivity in noncentrosymmetric metals](https://arxiv.org/abs/2608.00338)
...
### [90] [{\it Ab initio} prediction of $d_{x^2-y^2}$-wave superconductivity in infinite-layer nickelates](https://arxiv.org/abs/2608.00512)
...
### [91] [Evidence for superconductivity at 190 K in a pressure-overdoped cuprate](https://arxiv.org/abs/2608.00942)
...
### [92] [Anisotropic transport of Josephson vortices in atomic-layer superconductors on vicinal surfaces](https://arxiv.org/abs/2608.01196)
...
### [93] [Bulk Ising superconductivity in an intercalated TaSe2 bilayer structure](https://arxiv.org/abs/2608.01209)
...
### [94] [$d$-spacing distributions as a probe of nematoelastic response in iron-based superconductors](https://arxiv.org/abs/2608.01264)
...
### [95] [Electron-like high-temperature superconductivity induced by compressive strain in La2PrNi2O7 thin films](https://arxiv.org/abs/2608.01295)
...
### [96] [Spin Josephson diode effect induced by higher-harmonic spin Josephson currents in a diffusive Josephson junction](https://arxiv.org/abs/2608.01991)
*Shin-ichi Hikino*
...
### [97] [Enhanced and robust superconductivity in La0.8Sr0.2NiO2 membranes compressed up to 210 GPa](https://arxiv.org/abs/2608.02042)
...
### [98] [Pressure-induced concurrent amorphization and superconductivity in topological material NbNiTe5](https://arxiv.org/abs/2608.02342)
...
### [99] [Cryogenic focused-ion-beam microstructuring enabling quantitative $c$-axis transport measurements in Tl$_2$Ba$_2$CuO$_{6+δ}$](https://arxiv.org/abs/2608.02344)
...
### [100] [Superconducting ternary compounds Li-X-B (X=Mo, W) within the mild pressure range: First-principles predictions](https://arxiv.org/abs/2608.02362)
...
### [101] [Emergence of Double-Dome Superconductivity in the Pressurized Dirac Semimetal BaMg2Bi2](https://arxiv.org/abs/2608.02394)
...
### [102] [Screening phonon-mediated superconductors from static orbital Hamiltonians](https://arxiv.org/abs/2608.02426)
...
### [103] [Composite quantum geometry of superconductors](https://arxiv.org/abs/2608.02434)
...
### [104] [Superconducting dome due to the Fano-Feshbach shape resonance in artificial high-Tc superlattices](https://arxiv.org/abs/2608.02501)
...
### [105] [Mitigating ray effects in rarefied flow simulations using an ensemble-of-subproblems strategy with stochastic discrete velocities](https://arxiv.org/abs/2608.00514)
...
### [106] [A memory-efficient deterministic method for multiscale gas flows using an ensemble-of-subproblems strategy with stochastic discrete velocities](https://arxiv.org/abs/2608.00521)
*Shuyang Zhang,Weidong Li,Ming Fang,Zhaoli Guo*
...
### [107] [Consistent and bound-preserving finite-volume WENO scheme for compressible two-/$N$-phase flows with Phase-Field mechanism](https://arxiv.org/abs/2608.00746)
*Ziyang Huang*
...
### [108] [Centimeter-scale fully suspended metal and metal oxide thin films by one-step transfer-free liquid metal capillary forming](https://arxiv.org/abs/2608.00112)
...
### [109] [AC Field-driven orientational crossover and energy dissipation in suspended magnetic nanoparticles](https://arxiv.org/abs/2608.00116)
...
### [110] [Wrinkling of Randomly Heterogeneous Film-Substrate Systems](https://arxiv.org/abs/2608.00131)
...
### [111] [Vibrational spectroscopy identifies the bond asymmetry of hexagonal diamond](https://arxiv.org/abs/2608.00138)
*Li Zhu*
...
### [112] [Machine-Learning-Accelerated Metallene Stabilization from High-Throughput Sandwich Modeling](https://arxiv.org/abs/2608.01779)
...
### [113] [Configuration averaging of X-ray absorption spectra of disordered systems within the augmented-space full multiple-scattering formalism](https://arxiv.org/abs/2608.00179)
*Maurizio Benfatto*
...
### [114] [Resonant Raman spectroscopies beyond density-functional theory](https://arxiv.org/abs/2608.00269)
...
### [115] [Transient Liquid Phase Bonding of NiTi Using Cu- and Nb-base Interlayers](https://arxiv.org/abs/2608.00319)
...
### [116] [An essay on $d_0$ in neutron-based strain measurement techniques: equilibrium-based methods for non-destructive $d_0$ estimation](https://arxiv.org/abs/2608.00362)
...
### [117] [The AFLOW Library of Crystallographic Prototypes: Part 5](https://arxiv.org/abs/2608.00425)
...
### [118] [Machine Learning Compatible CALPHAD-type Optimization from Phase Equilibria by Auto-differentiation](https://arxiv.org/abs/2608.00516)
...
### [119] [Spin- and Angle-resolved Photoelectron Spectroscopy Study of the Quantum Spin Hall Insulator Bismuthene and its Precursor Phase](https://arxiv.org/abs/2608.00526)
...
### [120] [Uncertainty-guided active learning for surrogate prediction of stream-finishing wear fields](https://arxiv.org/abs/2608.00593)
...
### [121] [Ultrahigh Intrinsic Hole Mobilities in $M$N$_2$ ($M$= Mo and W) at Room Temperature](https://arxiv.org/abs/2608.00699)
...
### [122] [Atomic-scale reactivity of the CeO$_2$~(100) surface reconstructions by scanning probe microscopy](https://arxiv.org/abs/2608.00704)
...
### [123] [Conditional grain-graph diffusion for property-guided inverse design of polycrystalline microstructures](https://arxiv.org/abs/2608.00707)
...
### [124] [High-speed and high-gain graphene photovoltaic phototransistor gated by a van der Waals heterojunction](https://arxiv.org/abs/2608.00771)
...
### [125] [A Large-scale Parallel Implementation of Quasi-Four-Component Relativistic Density Functional Theory with Numeric Atom-centered Orbitals](https://arxiv.org/abs/2608.00773)
...
### [126] [Non-relativistic spin splitting in a triangular metal-excess magnet Fe$_{1+δ}$Sb](https://arxiv.org/abs/2608.00871)
...
### [127] [Spin-chirality-driven nonrelativistic Edelstein effects in two-dimensional antiferromagnets](https://arxiv.org/abs/2608.00948)
...
### [128] [Synthesis and structural validation of close-to-stoichiometric NiTe$_2$ single crystals](https://arxiv.org/abs/2608.02334)
...
### [129] [EBSD and Subtle Crystallographic Differences - A Study of Resolving Interlayer Spacings in Nb-Ni and Nb-Co mu-phases](https://arxiv.org/abs/2608.01210)
...
### [130] [Gradient expansion approximation of the inhomogeneous electron-gas revisited: Higher-order corrections](https://arxiv.org/abs/2608.02524)
...
### [131] [Twist-induced magnetic topological phase transition in stacked altermagnetic CrO](https://arxiv.org/abs/2608.01235)
...
### [132] [Why Ammoniated Lithium Borohydrides Liquefy and Resolidify?](https://arxiv.org/abs/2608.01266)
...
### [133] [Performance of Tkatchenko-Scheffler Dispersion Method with Updated van der Waals Radii: Importance for Alkali-Containing Systems](https://arxiv.org/abs/2608.01501)
...
### [134] [Physics-Informed Neural Networks for Sparse Strain-Field Reconstruction in 4D-STEM](https://arxiv.org/abs/2608.01601)
...
### [135] [Dual-Mode Exciton Coupling in Epitaxially Registered Organic-Inorganic 2D Heterocrystals](https://arxiv.org/abs/2608.01813)
...
### [136] [Machine Learning Assisted Design of Complex and High Entropy Alloys by Hybrid HiPIMS/Pulsed-DC PVD Process for Low Carbon Energy Applications in Extreme Environments](https://arxiv.org/abs/2608.01903)
...
### [137] [Resonantly-enhanced Raman response in graphene-capped bismuthene on SiC](https://arxiv.org/abs/2608.01961)
...
### [138] [Exciton-induced magnons carrying orbital angular momentum in CrI3](https://arxiv.org/abs/2608.02010)
...
### [139] [Transient Ferromagnetism in Ultrafast Phase Transitions in Perovskites under XUV Irradiation: A Comparative Study of SrTiO3 and KTaO3](https://arxiv.org/abs/2608.02106)
...
### [140] [Ab initio High-Pressure Phase Diagrams of Al-Mg Alloys in the Low Solute Concentration Limit](https://arxiv.org/abs/2608.02225)
...
### [141] [Polaron-mediated metal-insulator transition and proton conduction in hydrogenated nickelate perovskites](https://arxiv.org/abs/2608.02243)
...
### [142] [Second-Harmonic Imaging of Magnetic Domains in Thin Film Hematite](https://arxiv.org/abs/2608.02263)
...
### [143] [GRADAR: orientation-map-driven detection and ranking of grains for targeted two-beam electron channeling contrast imaging](https://arxiv.org/abs/2608.02400)
...
### [144] [Magnetically tunable symmetry-enforced nodal lines producing huge anomalous Hall conductivity in altermagnetic $α$-MnTe](https://arxiv.org/abs/2608.02416)
...
### [145] [Real-time dynamics of the two-step charge-density-wave transition in bulk 1T-TaS$_2$](https://arxiv.org/abs/2608.02456)
...
### [146] [Revealing Intrinsic Anisotropy of Collective Magnetic Excitations in Twinned Crystals of a Kitaev-Heisenberg Quantum Magnet](https://arxiv.org/abs/2608.02531)
