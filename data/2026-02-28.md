...
### [1] [Non-anomalous axions: lessons from the Majoron](https://arxiv.org/abs/2602.22311)
...
### [2] [One Sum To Rule Them All: A Second Order Master Rate Sum Rule for Charm Decays](https://arxiv.org/abs/2602.22320)
...
### [3] [Parity violation in atoms and electron scattering revisited](https://arxiv.org/abs/2602.22466)
...
### [4] [ACT-Consistent B-L Higgs Inflation in Supergravity](https://arxiv.org/abs/2602.22473)
*C. Pallis*
...
### [5] [Charmed nuclei and exotic charmed meson production at CBM@FAIR and ALICE@LHC](https://arxiv.org/abs/2602.22676)
...
### [6] [Weak dual symmetries of two color QCD phase diagram](https://arxiv.org/abs/2602.22820)
...
### [7] [Testing beyond the Standard Model scenarios in next-generation long-baseline neutrino oscillation experiments](https://arxiv.org/abs/2602.22849)
*Pragyanprasu Swain*
...
### [8] [Bottom-charmed meson states in inverse problem of QCD](https://arxiv.org/abs/2602.22872)
...
### [9] [Isospin symmetry breaking and the mass of the QCD axion in a three-flavor linear sigma model](https://arxiv.org/abs/2602.22946)
*András Patkós*
...
### [10] [NNLO QCD corrections to hadron production in DIS at finite transverse momentum](https://arxiv.org/abs/2602.22972)
...
### [11] [A Predictive Non-Holomorphic Modular $A_4$ Linear Seesaw Framework Testable at DUNE](https://arxiv.org/abs/2602.23018)
...
### [12] [Ruling Out Spiky WIMP Dark Matter using Indirect Searches](https://arxiv.org/abs/2602.23348)
...
### [13] [First-principles and tight-binding analysis of thermoelectricity in irradiated WSe$_2$](https://arxiv.org/abs/2602.22789)
...
### [14] [Coupling-energy driven pumping through quantum dots: the role of coherences](https://arxiv.org/abs/2602.23099)
...
### [15] [Dimensional and doping stability of Peierls charge density waves](https://arxiv.org/abs/2602.23208)
...
### [16] [Extrinsic Spin Splitter Currents in Altermagnets](https://arxiv.org/abs/2602.23273)
...
### [17] [Electromechanical Switching and Momentum-Selective Transport in Geometry-Defined Blue Phosphorus Homojunctions](https://arxiv.org/abs/2602.23298)
...
### [20] [Threefold error in the reported zero-field cooled magnetic moment of single crystal $La_2SmNi_2O_7$](https://arxiv.org/abs/2602.23240)
...
### [21] [Memory-Dominated Quantum Criticality as a Universal Route to High-Temperature Superconductivity](https://arxiv.org/abs/2602.22626)
*Byung Gyu Chae*
...
### [22] [Quantum Monte Carlo study of the metal-insulator crossover in the square-lattice Hubbard model](https://arxiv.org/abs/2602.22705)
...
### [23] [Phonons reflect dynamic spin-state order in LaCoO$_3$](https://arxiv.org/abs/2602.22725)
...
### [24] [Quantum magnetic phase transitions in a Kugel-Khomskii model including spin-orbit coupling](https://arxiv.org/abs/2602.23011)
...
### [25] [$Z_3$ confined and deconfined Coulomb liquids in $S_{\rm eff} = 3/2$ pyrochlore magnets](https://arxiv.org/abs/2602.23041)
...
### [26] [Extended Ashkin-Teller transition in two coupled frustrated Haldane chains](https://arxiv.org/abs/2602.23187)
...
### [27] [Magnetic order and excitations in Ce$_3$TiBi$_5$ and Ce$_3$ZrBi$_5$](https://arxiv.org/abs/2602.23316)
...
### [28] [Arrested Relaxation in a Disorder-Free Coulomb Spin Liquid](https://arxiv.org/abs/2602.23362)
...
### [29] [Mimicking the earth core conditions with ultrafast laser materials interaction](https://arxiv.org/abs/2602.22460)
...
### [30] [Many-Body effects beyond excitons in second-harmonic generation of monolayer MoS$_{2}$](https://arxiv.org/abs/2602.22463)
...
### [31] [The Surface Sensitivity of X-ray Second Harmonic Generation as a Function of Energy](https://arxiv.org/abs/2602.22497)
...
### [32] [Interpretable self-driving sputter epitaxy: from black-box optimization to human-usable growth rules](https://arxiv.org/abs/2602.22531)
...
### [33] [Symmetry-Protected Minimum of Four Conventional Weyl Points in Nonmagnetic Crystals](https://arxiv.org/abs/2602.22566)
...
### [34] [Single Pair of Charge-two Weyl Fermions in Chiral Boron Allotropes](https://arxiv.org/abs/2602.22622)
...
### [35] [LLM-driven discovery for carbon allotropes with bond-network entropy](https://arxiv.org/abs/2602.22706)
...
### [36] [Role of the Nephelauxetic Effect in Engineering Mn4+ Luminescence Kinetics for Lifetime-Based Thermometry](https://arxiv.org/abs/2602.22728)
...
### [37] [Anti-Thermal Quenching Phosphors based on Metal Halides](https://arxiv.org/abs/2602.22737)
...
### [38] [Self-foaming, Sintering-resistant Iron-Tungsten Powders Enable High-Cycle Thermochemical Hydrogen Storage](https://arxiv.org/abs/2602.22807)
...
### [39] [Substrate induced optimization of the Electrocatalytic Hydrogen Evolution Reaction (HER) performances of MoS2 thin film](https://arxiv.org/abs/2602.22869)
...
### [40] [A Comparative Study of Structural Representations for 2D Materials: Insights from Dynamic Collision Fingerprint and Matminer](https://arxiv.org/abs/2602.22950)
...
### [41] [Growth-controlled photochromism in yttrium oxyhydride thin films deposited by HiPIMS and pulsed-DC magnetron sputtering](https://arxiv.org/abs/2602.22951)
...
### [42] [Chalcogen Impurity Barriers in 2D Systems via Semi-Empirical/Machine Learning Modeling: A Survey over 4000 Materials](https://arxiv.org/abs/2602.22978)
...
### [43] [Mechanistic Insights into Li+ Transport Enabled by Isolated Sulfur Species in Li3PS4 Glasses](https://arxiv.org/abs/2602.22989)
...
### [44] [Influence of Hydrogen on Dislocation Relaxation in BCC Iron: Atomistic Mechanisms and Implications](https://arxiv.org/abs/2602.22995)
...
### [45] [Engineering in-plane anisotropy in 2D materials via surface-bound ligands](https://arxiv.org/abs/2602.23138)
...
### [46] [Highly Efficient Second/Third Harmonic Generation in van der Waals Layered Material AgScP2S6 with Anisotropic Polarization and Temperature Dependence](https://arxiv.org/abs/2602.23014)
...
### [47] [Tracking the Lithiation State of Li$_x$Si from Machine-Learned XPS Binding Energies](https://arxiv.org/abs/2602.23028)
...
### [48] [Machine Learning for Electron-phonon Interactions From Finite Difference](https://arxiv.org/abs/2602.23084)
...
### [49] [Landau level spectroscopy in current solid state physics](https://arxiv.org/abs/2602.23129)
...
### [50] [Efficient training of generative models from multireference simulations and its application to the design of Dy complexes with large magnetic anisotropy](https://arxiv.org/abs/2602.23230)
...
### [51] [Accounting for the length-scale dependence of thermal diffusivity in 3C-SiC measured with transient thermal gratings](https://arxiv.org/abs/2602.23247)
...
### [52] [Molecular Beam Epitaxy Growth of Wafer-scale SnSe van der Waals Ultrathin Layers](https://arxiv.org/abs/2602.23346)
...
### [53] [Discovery of Interpretable Physical Laws in Materials via Language-Model-Guided Symbolic Regression](https://arxiv.org/abs/2602.22967)
...
### [54] [Ceci n'est pas un committor, yet it samples like one: efficient sampling via approximated committor functions](https://arxiv.org/abs/2602.23236)
...
### [55] [mrfmsim: a modular, extendable, and readable simulation platform for magnetic resonance force microscopy experiments](https://arxiv.org/abs/2602.23337)
