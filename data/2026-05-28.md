...
### [1] [Influence of the QCD Analogue of the Inverse Compton Effect on the Transverse Momentum and Pseudorapidity Distributions of Secondary Particles in pp Collisions at sqrt (s)= 30 GeV, 510 GeV, and 14 TeV](https://arxiv.org/abs/2605.27468)
...
### [2] [Neutrino-antineutrino superfluidity](https://arxiv.org/abs/2605.27506)
...
### [3] [Constraints on a Light Leptophilic Scalar from Dark-Sector Couplings](https://arxiv.org/abs/2605.27513)
...
### [4] [Probing Dynamical Inverse Seesaw with Low-frequency Gravitational Waves](https://arxiv.org/abs/2605.27519)
...
### [5] [From WIMP to FIMP during reheating: collider vs non-collider probes for p-wave annihilation](https://arxiv.org/abs/2605.27521)
...
### [6] [Hunting New Animalcula with Flavour Changing Processes](https://arxiv.org/abs/2605.27525)
*Andrzej J. Buras*
...
### [7] [Multiplicity distributions in DIS for heavy nucleus](https://arxiv.org/abs/2605.27857)
...
### [8] [$CP$ phase structure of QCD from functional renormalization group](https://arxiv.org/abs/2605.27868)
...
### [9] [Matching second-order classical and 1-loop quantum tensor power spectra in de Sitter spacetime](https://arxiv.org/abs/2605.27910)
*A. Hauser,M. Laine*
...
### [10] [Tensor molecule $J/ψJ/ψ$: A candidate to the resonance $X(6200) $](https://arxiv.org/abs/2605.28015)
...
### [11] [Sensitivity Analysis of the Top-Quark Sector](https://arxiv.org/abs/2605.28147)
...
### [12] [Neutrinoless double beta decay in a flipped trinification model with left-right symmetry](https://arxiv.org/abs/2605.28156)
*D. N. Dinh*
...
### [13] [A first extraction of gluon TMDs from Higgs data at the LHC](https://arxiv.org/abs/2605.28216)
...
### [14] [Using the Pericentre Precession of LAGEOS II to Constrain Quadratically Coupled Ultralight Dark Matter](https://arxiv.org/abs/2605.28248)
...
### [15] [Dark Matter Interpretation of the Super-Kamiokande Antineutrino Excess in $\mathrm{U}(1)_{L_μ-L_τ}$ model](https://arxiv.org/abs/2605.28275)
...
### [16] [Probing hidden-charm pentaquarks from the $πN\rightarrow J/ψN$ reaction](https://arxiv.org/abs/2605.28285)
...
### [17] [Topological Diagram Analysis of Charmed Baryon Decays with Vector Mesons](https://arxiv.org/abs/2605.28410)
...
### [18] [Double D meson production in ultraperipheral $pp$, $pPb$ and $PbPb$ collisions](https://arxiv.org/abs/2605.28568)
...
### [19] [Two-loop QCD corrections to $ H \rightarrow b + \bar{b} + g $ at higher powers in the dimensional regulator](https://arxiv.org/abs/2605.28590)
...
### [20] [Generation as Compositeness: A Subconstituent Interpretation of the $B$-Lattice Flavor Hierarchy](https://arxiv.org/abs/2605.28608)
*Vernon Barger*
...
### [21] [Towards the two-loop electroweak corrections to the Drell-Yan process: the complete fermionic contributions](https://arxiv.org/abs/2605.28667)
...
### [22] [Nonequilibrium coherent effects at finite chemical potential](https://arxiv.org/abs/2605.28724)
...
### [23] [Linking the Gauge Hierarchy with Neutrino Masses and Dark Matter via Two-step Cosmological Selection](https://arxiv.org/abs/2605.28728)
...
### [24] [Maximum phase-space density of linearly polarized gluon TMDs in the saturation region](https://arxiv.org/abs/2605.28747)
*Lei Wang*
...
### [25] [Critique of Breit-Wigner resonance scattering](https://arxiv.org/abs/2605.28756)
*Philip D. Mannheim*
...
### [26] [Energy-energy correlators inside single inclusive jets in heavy-ion collisions with CoLBT-hydro model](https://arxiv.org/abs/2605.28788)
...
### [27] [Application of Reinforcement Learning for Multigroup Energy Grid Optimization for Neutron Transport Criticality Problems](https://arxiv.org/abs/2605.27895)
...
### [28] [Surface Contact Approximation for Magneto-Thermal Finite Element Analysis of No-Insulation HTS Coils](https://arxiv.org/abs/2605.28574)
...
### [29] [Dirac-Line Criticality and Emergent Horizons in Weyl Lifshitz Transitions](https://arxiv.org/abs/2605.27453)
...
### [30] [Emergence of an antiferromagnetic topological Anderson insulator in the interacting Haldane model](https://arxiv.org/abs/2605.27524)
...
### [31] [MATBG Josephson diode as an universal thermal machine](https://arxiv.org/abs/2605.27560)
...
### [32] [A supersymmetric study of charge and spin transport in Weyl semimetals under axionic electrodynamic response](https://arxiv.org/abs/2605.27657)
...
### [33] [Spin-Hall-Like Magnon Transport in a Synthetic Antiferromagnetic Skyrmion Lattice](https://arxiv.org/abs/2605.27822)
...
### [34] [Quantum anomalous Hall effect in chiral semimetals](https://arxiv.org/abs/2605.27826)
...
### [35] [Taming quantum interference: a route to high electrical conductance in carbon nanotube assemblies](https://arxiv.org/abs/2605.28250)
...
### [37] [Nanoscale Confinement Enhances Ultrafast Demagnetization](https://arxiv.org/abs/2605.28307)
...
### [38] [Unity-order coupling between free electrons and multiphoton waveguided Fock states](https://arxiv.org/abs/2605.28383)
...
### [39] [Symmetry-Selective Topological Magnon Engineering by Phonon Angular Momentum](https://arxiv.org/abs/2605.28425)
...
### [40] [Substrate-driven topological engineering in plasmonic Su-Schrieffer-Heeger chains](https://arxiv.org/abs/2605.28463)
...
### [41] [Electrically driven Rabi dynamics of magnetic-field-induced corner states in a two-dimensional topological insulator](https://arxiv.org/abs/2605.28499)
...
### [42] [Photon correlation microscopy of quantum matter](https://arxiv.org/abs/2605.28623)
...
### [43] [Multiscale Vectorial Determination of Magnetic Order Parameters using Electron Magnetic Linear Dichroism](https://arxiv.org/abs/2605.28790)
...
### [44] [High-temperature instability of artificial cuprorivaite: a study using thermal analysis, X-ray powder diffractometry and polarized light microscopy](https://arxiv.org/abs/2605.27455)
...
### [45] [Atomic Structure of Amorphous Optical Coatings of TiO$_2$-doped GeO$_2$ by Grazing-Incidence Total X-ray Scattering Measurements](https://arxiv.org/abs/2605.27462)
...
### [46] [Can MACE Potentials Accurately Describe Magnetism and Phase Stability in Fe-Ni Alloys? A Systematic Benchmark](https://arxiv.org/abs/2605.28395)
...
### [47] [Atomic-Scale Observation of Symmetry Breaking in Altermagnetic MnTe](https://arxiv.org/abs/2605.27543)
...
### [48] [Relaxation-driven topological domains in moiré materials](https://arxiv.org/abs/2605.27548)
...
### [49] [Magneto-Optical Detection of Anisotropic Spin Currents in Altermagnetic RuO2](https://arxiv.org/abs/2605.27830)
...
### [50] [Machine-learning-accelerated discovery of synthesizable high-temperature altermagnets with giant spin splitting](https://arxiv.org/abs/2605.27888)
...
### [51] [Effect of Vacancies on Hydrogen Mobility and Trapping in Elemental Fe and Cr: A DFT and kMC Study](https://arxiv.org/abs/2605.27983)
...
### [52] [Analytical solution of the Langmuir model for moisture diffusion in cylindrical coordinates](https://arxiv.org/abs/2605.28117)
...
### [53] [Search for high-pressure phases of yttrium via a data assimilation approach](https://arxiv.org/abs/2605.28171)
...
### [54] [Nonlinear Elasticity at the Damage Threshold of Semiconductor Nanocrystals](https://arxiv.org/abs/2605.28235)
...
### [55] [High Temperature Jahn-Teller Distortion and Short Range Order in CsCuCl$_3$](https://arxiv.org/abs/2605.28288)
...
### [56] [Energy and Scaling Limits of Phase-Change Memory](https://arxiv.org/abs/2605.28336)
...
### [57] [SC-1 Etching of Niobium and Titanium Nitride Thin Films](https://arxiv.org/abs/2605.28343)
...
### [58] [Engineering Molecular Rectification: Mechanisms, Modulation Strategies, and Device Integration](https://arxiv.org/abs/2605.28381)
...
### [59] [Global magnetic phase diagram and multiple unconventional magnets in NiAs-type compounds](https://arxiv.org/abs/2605.28391)
...
### [60] [Electron-beam induced methane decomposition for in-situ carbon doping of hexagonal boron nitride](https://arxiv.org/abs/2605.28564)
...
### [61] [Ultrafast dynamics of excitons in black phosphorus](https://arxiv.org/abs/2605.28611)
...
### [62] [Universal Stability of Ga Split Vacancies across α-, β-, and κ-Ga2O3 Polymorphs: A Machine-Learning Accelerated Study](https://arxiv.org/abs/2605.28743)
...
### [63] [Synthesis and properties of bulk Mg$_3$WN$_4$ in a wurtzite-derived structure](https://arxiv.org/abs/2605.28799)
...
### [64] [A GPU-based Solver for Polarization Dynamics in Ferroelectric Materials](https://arxiv.org/abs/2605.28800)
...
### [65] [Quantum criticality of the ferromagnetic Dicke-Ising model](https://arxiv.org/abs/2605.27484)
...
### [66] [Inelastic Neutron Scattering of the layered Kitaev ferromagnet Li$_3$Co$_2$SbO$_6$](https://arxiv.org/abs/2605.27518)
...
### [67] [Zero modes of non-abelian Dirac operator in topologically non-trivial band insulator](https://arxiv.org/abs/2605.27608)
...
### [68] [Spontaneous breaking of non-invertible symmetries and duality to beyond-Landau transitions](https://arxiv.org/abs/2605.27672)
...
### [69] [Chirality in Structural Phase Transitions](https://arxiv.org/abs/2605.27812)
...
### [70] [Direction-selective intertwined charge, orbital, and lattice orders under uniaxial strain in hole-doped manganite: La0.75Ca0.25MnO3](https://arxiv.org/abs/2605.27979)
...
### [71] [Cascade of magnetic-field-induced quantum spin states in a spin-1 honeycomb magnet](https://arxiv.org/abs/2605.28118)
...
### [72] [Zero-Field Thermal Hall Effect in Insulator](https://arxiv.org/abs/2605.28249)
...
### [73] [Change in charge density wave order beyond the Lifshitz transition in 2H-Ta\textsubscript{1$\pmδ$}S\textsubscript{2}](https://arxiv.org/abs/2605.28259)
...
### [74] [Anisotropic magnetism and Kondo-lattice behavior in the frustrated antiferromagnet Ce3MgBi5](https://arxiv.org/abs/2605.28540)
...
### [75] [Topological lattice gauge theory enriched by non-invertible symmetry](https://arxiv.org/abs/2605.28688)
...
### [76] [Magnetic order, magnons, and crystal fields in van der Waals CeSiI](https://arxiv.org/abs/2605.28698)
...
### [77] [Odd spin symmetry and anisotropy switching in p-wave magnet CeNiAsO](https://arxiv.org/abs/2605.28701)
...
### [78] [Avoided Stoner instability at a single ordinary Van Hove point](https://arxiv.org/abs/2605.28761)
...
### [79] [Non-invertible symmetry enriched string net topological orders](https://arxiv.org/abs/2605.28794)
...
### [80] [Realization of the Ruby Lattice Antiferromagnet in Layered Transition-Metal Fluorides](https://arxiv.org/abs/2605.28821)
...
### [81] [Three-component superconductivity: the effect of second-order Josephson couplings](https://arxiv.org/abs/2605.28221)
...
### [82] [Absolute measurement of penetration depth of superconducting thin films using microwave stripline resonators](https://arxiv.org/abs/2605.28759)
