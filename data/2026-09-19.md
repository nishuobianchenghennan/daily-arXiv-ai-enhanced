...
### [3] [Bad metallicity in the semi-quantum regime of the Hubbard model](https://arxiv.org/abs/2609.19264)
...
### [4] [Non-Abelian Anyon Condensation: a Path-Integral Monte Carlo Approach](https://arxiv.org/abs/2609.19282)
...
### [5] [Machine-Learning Exploration of Defect Topologies and Thermodynamic Stability in Graphene with Atomic Vacancies](https://arxiv.org/abs/2609.19191)
...
### [6] [Comprehensive First-Principles Investigation of the Structural, Mechanical, Electronic, and Optical Properties of Homoelemental Phase T-GaN Monolayer](https://arxiv.org/abs/2609.19192)
...
### [7] [Melting of corundum (α-Al2O3) under compression to 8 GPa: A decreasing melting slope](https://arxiv.org/abs/2609.19229)
...
### [8] [Electron $g$-value comparison of paramagnetic muonium and hydrogen centers in rutile TiO$_2$](https://arxiv.org/abs/2609.19338)
...
### [9] [Pressure-dependent melting and crystallization of B2-NiAl from neural-network molecular dynamics](https://arxiv.org/abs/2609.19355)
...
### [10] [The Origin of the Observed Raman Peaks in α-MnTe](https://arxiv.org/abs/2609.19467)
...
### [13] [Ultralow-Tensile Strain Enables Exciton Funneling and Energy Transfer to Boost MoSe2 Photoluminescence Quantum Yield](https://arxiv.org/abs/2609.20387)
...
### [14] [Orbital fingerprinting of magnetism across the Mn-Ni-Ga Heusler ternary](https://arxiv.org/abs/2609.19835)
...
### [15] [Machine Learning for High-Entropy Catalysts: Methods and Applications](https://arxiv.org/abs/2609.19837)
...
### [26] [How durable are high-performance racing shoes?](https://arxiv.org/abs/2609.20485)
...
### [27] [Testing Higgs-Coupled Minimal Dark Matter with Solar Neutrinos after the LZ High-Recoil Event](https://arxiv.org/abs/2609.19174)
*Mattia Di Mauro*
...
### [28] [Interpreting quantum coherence of neutrinos in asymptotically flat spacetimes via effective distances: Solution to the paradoxes of the Leggett-Garg inequality and quantum information quantities](https://arxiv.org/abs/2609.19198)
...
### [29] [Collective flavor conversion in dense neutrino plasmas](https://arxiv.org/abs/2609.19256)
...
### [30] [A phenomenological profile of Higgs portals at future colliders](https://arxiv.org/abs/2609.19258)
...
### [31] [SHiP as a (post-)discovery machine: identifying the diphoton signals' origin](https://arxiv.org/abs/2609.19269)
...
### [32] [Lukewarm inflation, primordial black holes and gravitational waves](https://arxiv.org/abs/2609.19270)
...
### [33] [Probing Scalar-Induced First-Order Phase Transitions with the Diffuse Supernova Neutrino Background](https://arxiv.org/abs/2609.19271)
...
### [34] [Lukewarm inflation and the QCD axion](https://arxiv.org/abs/2609.19284)
*Paulo B. Ferraz,António Torres Manso,João G. Rosa*
...
### [35] [Resonant Di-Higgs Searches in $b\bar{b}τ^+τ^-$ at HL-LHC: Supersymmetry versus Compositeness Benchmarks](https://arxiv.org/abs/2609.19305)
...
### [36] [Generalized parton distributions: Theory meets experiment](https://arxiv.org/abs/2609.19544)
...
### [37] [T-odd Effect from Two-Photon Exchange in SIDIS at Low Transverse Momentum](https://arxiv.org/abs/2609.19574)
*J. P. Ma,G. P. Zhang*
...
### [38] [Higher twists in QCD](https://arxiv.org/abs/2609.19620)
*W. Melnitchouk*
...
### [39] [Strange Two-Photon Exchange in Time-Like Electromagnetic Form Factors](https://arxiv.org/abs/2609.19652)
...
### [40] [Clarifying the puzzling mass shift of the $ψ(4160)$ via a reanalysis of $R$-value data with unquenched charmonium spectroscopy](https://arxiv.org/abs/2609.19673)
...
### [41] [Neutralino Dark Matter in SU(5) after H.E.S.S. and Direct-Detection Searches](https://arxiv.org/abs/2609.19675)
...
### [42] [Displacement field stabilizes even-denominator and partonic fractional quantum Hall states in the $\mathcal{N}{=}2$ Landau levels of Bernal-stacked bilayer graphene](https://arxiv.org/abs/2609.19379)
...
### [43] [Quantum transport across normal-superlattice-normal graphene junctions: Fabry-Pérot interference, Hofstadter butterfly, and supersnake states](https://arxiv.org/abs/2609.19627)
