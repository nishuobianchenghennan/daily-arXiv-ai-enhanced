...
### [3] [Neutrino mixing and gravitational production via inflation](https://arxiv.org/abs/2605.11062)
...
### [4] [Electronic Direct Detection of Light Dark Matter with Intermediate-Mass Mediators](https://arxiv.org/abs/2605.11063)
...
### [5] [An approximate formula for the entropy of the negative binomial distribution](https://arxiv.org/abs/2605.11147)
*Sándor Lökös*
...
### [6] [Gluon Entanglement Entropy inside a Nucleon: A Toy Model](https://arxiv.org/abs/2605.11171)
...
### [7] [Detection of Gravitons: Graviton Absorption and Excess of Photon Luminosity from Interstellar Hydrogen](https://arxiv.org/abs/2605.11278)
...
### [8] [Reviving primordial black hole formation in slow first-order phase transitions](https://arxiv.org/abs/2605.11332)
...
### [9] [Long-lived sterile neutrinos from axionlike particles at the Super Tau-Charm Facility](https://arxiv.org/abs/2605.11630)
...
### [10] [SMEFT everywhere: a NLO study of $\boldsymbol{pp \to t\bar{t}H}$ with decaying tops](https://arxiv.org/abs/2605.11747)
...
### [11] [In-medium Y(1S,2S,3S) suppression in Pb-Pb collisions at sqrt(s_NN)=5.02 TeV](https://arxiv.org/abs/2605.11765)
...
### [12] [Formulation of parton shower evolution beyond leading order for electron-positron annihilation](https://arxiv.org/abs/2605.11792)
...
### [13] [Trace anomaly, effective degrees of freedom, and chemical potential effects near the QCD crossover](https://arxiv.org/abs/2605.11952)
...
### [14] [Probing the small-scale primordial power spectrum via relic neutrinos and acoustic reheating](https://arxiv.org/abs/2605.11956)
...
### [15] [Quantumness of top quark pairs produced at LHC within SMEFT framework](https://arxiv.org/abs/2605.12033)
*Amir Subba,Yu Shi*
...
### [16] [Explicit Conditions for Diagnosing Tree-Level Unitarity](https://arxiv.org/abs/2605.12057)
...
### [17] [A Phenomenological Study of Semileptonic $B^+$ and $B_s^0$ Decays into Axial-Vector Mesons $\big(D_1(2420),\, D_1^\prime(2430),\, D_{s1}(2460),\, \text{and } D_{s1}^\prime(2536)\big)$ within the Standard Model](https://arxiv.org/abs/2605.12065)
...
### [18] [Photoproduction of $J/Ψ$ in peripheral Oxygen-Oxygen collisions](https://arxiv.org/abs/2605.12123)
...
### [19] [Comparison of the hadronic vacuum polarization between hadronic $τ$-decay data and lattice QCD](https://arxiv.org/abs/2605.12205)
...
### [20] [Open LHC Monte Carlo Event Generation](https://arxiv.org/abs/2605.12229)
...
### [21] [Toward Charge-Dependent Tests of the Equivalence Principle: A Phenomenological Parameter and an Unexplored Frontier](https://arxiv.org/abs/2605.12246)
...
### [22] [A New Look at the X Compositeness from its Lineshape](https://arxiv.org/abs/2605.12274)
...
### [23] [Quasi Parton Distribution Functions in Covariant Quark Models](https://arxiv.org/abs/2605.12373)
...
### [24] [Fast and Accurate Prediction of Lattice Thermal Conductivity via Machine Learning Surrogates](https://arxiv.org/abs/2605.11610)
...
### [25] [Homogenization of rod-like metamaterials as a special Cosserat rod](https://arxiv.org/abs/2605.10952)
*Vinayak,Ajeet Kumar*
...
### [26] [Adamantane plasma polymers: fluorine-free vacuum-processable triboelectric thin films for all-triboelectric nanogenerator configurations](https://arxiv.org/abs/2605.11052)
...
### [27] [Synergistic improvement of specific strength and plasticity achieved in Ti-based metallic glass designed based on quasicrystal structure](https://arxiv.org/abs/2605.11729)
...
### [28] [Universality of magnetic susceptibility in the conical state of kagome ferromagnet Fe$_3$Sn$_2$](https://arxiv.org/abs/2605.11851)
...
### [29] [Tailoring the material properties, nanostructure and grain alignment of Alnico magnets through micromagnetic simulations](https://arxiv.org/abs/2605.11982)
...
### [30] [Vacancy-Enhanced $N-N$ Bonding and Deep Level Complex Defect Formation in $β-Ga_2O_3$](https://arxiv.org/abs/2605.12029)
...
### [31] [Discovery of High-Voltage Magnesium-Ion Cathodes using Machine Learning and First-Principles Calculations](https://arxiv.org/abs/2605.12067)
...
### [32] [Symmetry Guided Band-Gap Opening via Periodic Topological Defects in Graphene](https://arxiv.org/abs/2605.11183)
...
### [33] [Enhanced Impact Mitigation via 3D-Multilayered Material Architectures](https://arxiv.org/abs/2605.12093)
...
### [34] [Mechanical detection of sub-band mobilities of two-dimensional electron gas on reduced SrTiO$_3$(001) surface](https://arxiv.org/abs/2605.12101)
...
### [35] [Automated multiphase identification and refinement in powder diffraction using mismatch-tolerant machine learning](https://arxiv.org/abs/2605.12478)
...
### [36] [Competing crystallization pathways and cold crystallization kinetics in 10OS5 liquid crystal](https://arxiv.org/abs/2605.12108)
...
### [37] [Probing Non-Equilibrium Grain Boundary Dynamics with XPCS and Domain-Adaptive Machine Learning](https://arxiv.org/abs/2605.12194)
...
### [38] [Engineering few-layer graphene by S-doping: from sustaining linear dispersion to flat bands](https://arxiv.org/abs/2605.12256)
...
### [39] [Ordering governs magnetic tunability in FePt-based Janus particles independent of curvature](https://arxiv.org/abs/2605.12283)
...
### [40] [Graphene lattice recoil in hard X-ray photoemission: Experiment and Theory](https://arxiv.org/abs/2605.12330)
...
### [41] [Equivariant Space Group and Hamiltonian for Collinear Magnetic Systems](https://arxiv.org/abs/2605.12440)
...
### [42] [The Meissner effect does not require radial charge flow](https://arxiv.org/abs/2605.10945)
*A. V. Nikulov*
...
### [43] [Geometry-enabled magnetic resilience in superconducting nanowire single-photon detectors](https://arxiv.org/abs/2605.10968)
...
### [44] [First-principles real-space embedding theory of the superconducting proximity effect](https://arxiv.org/abs/2605.11211)
...
### [46] [Experimental Progress in Ambient-Pressure Superconducting Bilayer Nickelate Films](https://arxiv.org/abs/2605.11584)
*Meng Zhang,Xi Yan*
...
### [47] [Nematicity in LaFeAsO single crystals studied by elastoresistance, high-resolution thermal expansion and shear-modulus measurements](https://arxiv.org/abs/2605.11955)
...
### [48] [Phase-slip residual-order spin state in FeSe](https://arxiv.org/abs/2605.12293)
...
### [49] [Euler Topology in Superconducting Honeycomb Lattices](https://arxiv.org/abs/2605.11587)
...
### [50] [Bound States in Second-order Topological Graphitic Structures](https://arxiv.org/abs/2605.11164)
...
### [51] [Strain-controlled crossover between Majorana and Andreev bound states in disordered superconductor-semiconductor heterostructures](https://arxiv.org/abs/2605.11066)
...
### [52] [Valley-Controlled Viscosity of Two-Dimensional Dirac Fluids](https://arxiv.org/abs/2605.11069)
...
### [53] [Photon Momentum Enabled Symmetry Breaking and Nonlinear Photocurrents in the Centrosymmetric Dirac Semimetal PdTe](https://arxiv.org/abs/2605.11113)
...
### [54] [Flow bistability in non-Newtonian electron fluid](https://arxiv.org/abs/2605.12150)
...
### [55] [Probing charge noise in bilayer graphene quantum dots by Landau-Zener-Stückelberg-Majorana spectroscopy](https://arxiv.org/abs/2605.12257)
...
### [56] [Magnon polaritons in a van der Waals ferromagnet coupled to a superconducting resonator](https://arxiv.org/abs/2605.12298)
...
### [57] [Optical signatures of antiferromagnetic correlations in a strongly interacting quantum Hall MoSe2 monolayer](https://arxiv.org/abs/2605.11249)
...
### [58] [Optical Response of a screw dislocated GaAs Quantum Wire: Temperature and Pressure Effects](https://arxiv.org/abs/2605.12371)
...
### [59] [Magnetic-field-tunable cyclotron hyperbolic polaritons](https://arxiv.org/abs/2605.11185)
...
### [60] [CERTIFY-ED: A Multi-Layer Verification Framework for Exact Diagonalization of Quantum Many-Body Systems](https://arxiv.org/abs/2605.11787)
...
### [61] [Contrasting structural reversibility and magnetic correlations in isostructural honeycomb magnets CrCl$_3$ and $α$-RuCl$_3$](https://arxiv.org/abs/2605.11106)
...
### [62] [Unbiased large-$N$ approach to competing vestigial orders of density-wave and superconducting instabilities](https://arxiv.org/abs/2605.11281)
...
### [63] [Emergent Vortex Ordering in a Multiflavor Pyrochlore-Lattice Compound GeCo$_2$O$_4$](https://arxiv.org/abs/2605.12042)
...
### [64] [Magnetism and spin dynamics of Na\textsubscript{5}Yb(MoO\textsubscript{4})\textsubscript{4}: A weakly interacting rare-earth stretched diamond lattice](https://arxiv.org/abs/2605.12045)
...
### [65] [$H$-linear magnetoresistance in NbSe$_2$ due to impeded cyclotron motion](https://arxiv.org/abs/2605.12048)
