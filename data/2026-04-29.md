...
### [7] [Validity of DFT+U band gaps in all its known functional forms](https://arxiv.org/abs/2604.25706)
...
### [8] [Dielectric signatures of crystal-field and low-temperature correlated dynamics in NdMgAl11O19](https://arxiv.org/abs/2604.24937)
...
### [9] [Topochemical Fluorination of La$_2$NiO$_{4+δ}$ Single Crystals](https://arxiv.org/abs/2604.25575)
...
### [10] [Crystal-Field Symmetry Constraints in Layered Honeycomb ErBr$_3$](https://arxiv.org/abs/2604.24951)
...
### [11] [Tunable thermal conductivity through dual spin-phonon coupling in van der Waals ferromagnetic insulator Cr2Ge2Te6](https://arxiv.org/abs/2604.25115)
...
### [12] [Identifying strong correlation using only the Kohn-Sham density of one-electron states](https://arxiv.org/abs/2604.25125)
...
### [13] [Piezomagnetic effect of a rare-earth-based altermagnet TbPt6Al3](https://arxiv.org/abs/2604.25282)
...
### [14] [Robust Metal-Insulator Transition Despite Surface Dead-Layer Growth in Sub-10-nm Cr-Doped V2O3 Nanocrystals](https://arxiv.org/abs/2604.25488)
...
### [15] [Flat band in multiband-metal MnSb$_2$](https://arxiv.org/abs/2604.25324)
...
### [16] [Intrinsic magnetotransport and orientation dependent topological Hall effect in EuAuBi](https://arxiv.org/abs/2604.25365)
...
### [17] [Raman Characterization of Two-Dimensional Quasiperiodic Antiferromagnets on Various Lattices: Spin-Orbit Mechanism](https://arxiv.org/abs/2604.25401)
...
### [18] [Highly fluctuating double-$q$ magnetic order in the van der Waals metal CeTe$_3$](https://arxiv.org/abs/2604.25436)
...
### [19] [Non-magnetic floating phases in frustrated Haldane chains with a single-ion anisotropy](https://arxiv.org/abs/2604.25493)
...
### [20] [The odd-parity ALM induced reconstruction of the Chern-insulating phase in Haldane-Hubbard model](https://arxiv.org/abs/2604.25537)
...
### [32] [Kohn-Sham Hamiltonian from Effective Field Theory: Quasiparticle Band Narrowing from Frozen Core Dynamics](https://arxiv.org/abs/2604.25199)
...
### [33] [Ultrafast Energy Absorption in Silicon Controlled by Two-Color Double Pulses](https://arxiv.org/abs/2604.25093)
...
### [39] [Physical properties of transition metal hydride superconductors Mg2TmH6 (Tm = Rh, Pd, Ir, Pt) by first-principles calculations](https://arxiv.org/abs/2604.25626)
...
### [40] [Reversible Modulation of Thermal Conductivity in GaN via Strain-Driven Reorganization of Dislocation Ensembles](https://arxiv.org/abs/2604.25287)
...
### [41] [Proximity Ferroelectricity Driven by Mobile High-Miller-Index Domain Walls](https://arxiv.org/abs/2604.25343)
...
### [42] [Determination of Burgers vectors of dislocations in monoclinic $β$-Ga$_2$O$_3$ crystals by large-angle convergent-beam electron diffraction](https://arxiv.org/abs/2604.25428)
...
### [43] [From Ultrafast Demagnetization to Ultrafast Spintronics : a 30 years story](https://arxiv.org/abs/2604.25431)
...
### [44] [Thermodynamic surface reconstruction governs catalytic behavior in high-entropy alloys](https://arxiv.org/abs/2604.25454)
...
### [45] [Probing sliding ferroelectricity in bilayer T$_\mathrm{d}$-WTe$_2$ with high-harmonic generation](https://arxiv.org/abs/2604.25483)
...
### [46] [Electronic structures of spin-orbit-coupled metal candidate PbRe$_2$O$_6$: one dimensionality and molecular orbital formation](https://arxiv.org/abs/2604.25539)
...
### [47] [Benchmarking bandgap prediction in semiconductors under experimental and realistic evaluation settings](https://arxiv.org/abs/2604.25568)
...
### [48] [Tuning magnitude and direction of lattice thermal conductivity in transition metal dichalcogenide heterobilayers](https://arxiv.org/abs/2604.25576)
...
### [53] [Next-to-next-to-leading QCD corrections to the $\mathbf{B^+}$-$\mathbf{B_d^0}$, $\mathbf{D^+}$-$\mathbf{D^0}$, and $\mathbf{D_s^+}$-$\mathbf{D^0}$ lifetime ratios](https://arxiv.org/abs/2604.24841)
...
### [54] [Accidental Peccei-Quinn Symmetry from Chiral Gauge Symmetry and Mirror QCD](https://arxiv.org/abs/2604.24849)
...
### [55] [The Angular Observables of $Λ_b \to Λ_c(\to Λ^0 π^+) \, τ^-(\to π^- ν_τ)\, \barν_τ$ within the Paradigm of FCCC Anomalies](https://arxiv.org/abs/2604.24922)
...
### [56] [Forward backward CP asymmetry in $τ^- \to K πν_τ$ in the Left-Right Inverse seesaw model](https://arxiv.org/abs/2604.24924)
...
### [57] [Muon $g$$-$$2$: correlation-induced uncertainties in precision data combinations](https://arxiv.org/abs/2604.25004)
...
### [58] [NMSSMScanner: Efficient Scans in the NMSSM Parameter Space Proof of Concept](https://arxiv.org/abs/2604.25009)
...
### [59] [Can LLP detectors probe the reheating temperature? A case study of vector dark matter](https://arxiv.org/abs/2604.25090)
...
### [61] [Jarvis-HEP: A lightweight Python framework for workflow composition and parameter scans in high-energy physics](https://arxiv.org/abs/2604.25557)
...
### [62] [On the Role of Prompt Photons in the Anisotropic Emission of Direct Photons -- Direct Photons from Au+Au collisions at $\sqrt{s_{NN}}=200$ GeV with IP-Glasma Initial Condition](https://arxiv.org/abs/2604.25165)
*Fu-Ming Liu*
...
### [63] [Big Dipper, Help Me Find A Way -- Dip-hunting at hadron colliders](https://arxiv.org/abs/2604.25407)
...
### [64] [A study of $J/ψ$ mass shift and bound states: Impact of $D D$ and $DD^*$ meson loops](https://arxiv.org/abs/2604.25449)
...
### [65] [Les Houches study on inclusive jet production at NNLO+NNLL](https://arxiv.org/abs/2604.25490)
...
### [66] [$\texttt{cuSkyrmion}$: A CUDA-OpenGL framework for interactive simulation and visualization of nuclei as Skyrmions](https://arxiv.org/abs/2604.25876)
...
### [67] [The EDM inverse problem: Identifying the sources of CP violation and PQ breaking with electric dipole moments](https://arxiv.org/abs/2604.25516)
...
### [68] [A Speculative Benchmark for the AMS-02 Electron and Positron Spectra from a Time-Symmetric Transport Hypothesis](https://arxiv.org/abs/2604.25542)
*Yi Yang*
...
### [69] [Determination of the $Z_c(3900)$ and the $Z_{cs}(3985)$ states from joint analysis of experimental and lattice data](https://arxiv.org/abs/2604.25607)
...
### [70] [Probing the hadronic molecular nature of the $Ω(2012)$, $Ω(2380)$, and $Ω_c(3120)$ via femtoscopy correlation functions](https://arxiv.org/abs/2604.25630)
...
### [71] [Axion-like particle-meson production in semileptonic $τ$ decays](https://arxiv.org/abs/2604.25673)
...
### [72] [Coherent deeply virtual Compton scattering on helium-4 beyond leading power](https://arxiv.org/abs/2604.25677)
...
### [73] [Collective neutrino-antineutrino pair oscillations](https://arxiv.org/abs/2604.25687)
...
### [74] [Imprint of domain wall annihilation on induced gravitational waves](https://arxiv.org/abs/2604.25726)
*Rishav Roshan*
...
### [75] [Covariant Construction of Generalized Form Factors](https://arxiv.org/abs/2604.25771)
...
### [76] [Four-Loop Gluon Anomalous Dimension of General Lorentz Spin: Transcendental Part](https://arxiv.org/abs/2604.25833)
...
### [77] [Analysis of quarkonium polarization in proton-proton (p-p) collisions at LHC using PYTHIA model](https://arxiv.org/abs/2604.25838)
...
### [78] [Precision predictions for trilinear scalar couplings and Higgs pair production in models with extended scalar sectors](https://arxiv.org/abs/2604.25874)
*Johannes Braathen*
...
### [79] [$CP$ violation in singly Cabibbo suppressed $D\to πa_0(980)$ decays](https://arxiv.org/abs/2604.25875)
...
### [80] [Explainable AI for Jet Tagging: A Comparative Study of GNNExplainer, GNNShap, and GradCAM for Jet Tagging in the Lund Jet Plane](https://arxiv.org/abs/2604.25885)
...
### [81] [Gauging Axionic Symmetries and Dark Matter: In memory of George Lazarides](https://arxiv.org/abs/2604.25888)
*Claudio Corianò*
...
### [82] [Implied Volatility Expansions for VIX Options in Forward Variance Models](https://arxiv.org/abs/2604.25123)
...
### [83] [Nonlocal Cooper pairs in finite topological superconductors and their relation to Majorana nonlocality](https://arxiv.org/abs/2604.25169)
...
### [84] [High-field magneto-optical imaging of superconducting critical states beyond 10 T using a paramagnetic garnet sensor](https://arxiv.org/abs/2604.25274)
...
### [85] [Differentiation of electron doping and oxygen reduction in electron-doped cuprates](https://arxiv.org/abs/2604.25450)
...
### [86] [Critical Role of Hydrogen in Unconventional Superconductors: The Case of Hydrogenated FeSe Layers](https://arxiv.org/abs/2604.25500)
...
### [87] [Geometric Rashba Control of Polar Pairing at LaAlO$_3$/KTaO$_3$ Interfaces](https://arxiv.org/abs/2604.25805)
*Yi Zhou*
...
### [88] [Bragg-Williams order competes with superconductivity](https://arxiv.org/abs/2604.25843)
...
### [89] [Thermodynamic Identification of the Internal Superconducting Phase Boundary in UTe$_2$ for $H \parallel b$](https://arxiv.org/abs/2604.25896)
