...
### [22] [Excitonic Condensation in an Asymmetric Electron-Hole Biwire](https://arxiv.org/abs/2606.17086)
...
### [23] [Kohn--Luttinger Superconductivity in Flat Chern Bands](https://arxiv.org/abs/2606.17205)
...
### [24] [Room-temperature tuning and probing of Fermi polarons in atomically thin semiconductors on a plasmonic metasurface](https://arxiv.org/abs/2606.17278)
...
### [25] [Vortex-Beam-Driven Dirac Materials: Impurity and Polarization Effects on Light-Induced Vortex and Edge States](https://arxiv.org/abs/2606.17341)
...
### [26] [Operator ordering as an emergent gauge field in twisted bilayer graphene: singular spectral signatures at the magic angle](https://arxiv.org/abs/2606.17349)
*C. A. S. Almeida*
...
### [27] [Dispersive mode coupling in $p$-doped semiconductor nanomechanical resonators](https://arxiv.org/abs/2606.17392)
...
### [28] [Surface-switchable nonreciprocity protected by Fermi arcs in Weyl semimetal TaAs](https://arxiv.org/abs/2606.17395)
...
### [29] [Anomalous Pairing Currents and a Second Topological Edge Channel in Bosonic Lattices](https://arxiv.org/abs/2606.17538)
...
### [30] [Beyond the interface: Persistent Hopping Transport and Frequency Dispersion in Strong-inversion Cryogenic MOSFETs](https://arxiv.org/abs/2606.17547)
...
### [31] [Atomic-scale sensing of photoexcitation processes in electronically isolated molecules via atomic force microscopy](https://arxiv.org/abs/2606.17623)
...
### [32] [Effect of inter-edge interaction in a quantum Hall collider](https://arxiv.org/abs/2606.17753)
...
### [33] [Spin-Wave Phase Shifter Controlled by a Domain Wall Racetrack](https://arxiv.org/abs/2606.17804)
...
### [34] [Tunneling amplifies chirality-induced spin selectivity and explains its current-direction invariance](https://arxiv.org/abs/2606.17823)
...
### [35] [Higher-order topological metasurface based on split-ring resonators with dipole-quadrupole couplings](https://arxiv.org/abs/2606.17855)
...
### [36] [Chirality-induced spin selectivity without intrinsic spin-orbit coupling: Role of current-induced molecular orbital moment](https://arxiv.org/abs/2606.17865)
...
### [37] [Robust Signatures of Fragile Topology](https://arxiv.org/abs/2606.17870)
...
### [38] [Torsion-controlled spin transport and tunable intersubband absorption in a screw-dislocated semiconductor nanowire](https://arxiv.org/abs/2606.17943)
...
### [39] [Highly nonlinear Moiré exciton and trion polaritons](https://arxiv.org/abs/2606.18077)
...
### [40] [Coherent effects in quantum transport models and their classical counterparts](https://arxiv.org/abs/2606.18224)
...
### [41] [Tensor network compression using fluid dynamics as a testbed: Analytical foundations in one dimension](https://arxiv.org/abs/2606.17064)
...
### [42] [Constitutive modelling of magneto-active polymers at finite strains: A survey](https://arxiv.org/abs/2606.17576)
...
### [43] [Latent Residual-Closure Fourier Neural Operator for Robust Multi-Field Solving in Particle-in-Cell Simulations](https://arxiv.org/abs/2606.17733)
...
### [44] [High-Order Simulation of Particle-Laden Flows in Moving Domains Using Coupled ALE and Sliding Mesh Approaches](https://arxiv.org/abs/2606.17969)
...
### [45] [Singular Vector Finite Element Basis Functions for Tetrahedra in Complex Electromagnetic Geometries](https://arxiv.org/abs/2606.18140)
...
### [46] [Are neutrinos Majorana? Fixed-target and high-energy astrophysical searches decide](https://arxiv.org/abs/2606.17132)
...
### [47] [Short-Range Correlations Between Partons in a Proton](https://arxiv.org/abs/2606.17133)
...
### [48] [PineAPPLv1: fast and flexible theory predictions for present and future colliders](https://arxiv.org/abs/2606.17134)
...
### [49] [$|V_{cb}|$ determinations from $\bar{B} \to D^{(*)} \ell \barν$ decays within the SM and beyond](https://arxiv.org/abs/2606.17138)
...
### [52] [Quantum decoherence of hyperon spin correlations in QCD hadronization](https://arxiv.org/abs/2606.17240)
...
### [56] [Semi-analytical results for $e^+e^-\to J/ψ+ X_{{\rm non\,}c\bar{c}}$ up to $\mathcal{O}(α_s v^2)$ at B factories](https://arxiv.org/abs/2606.17827)
...
### [57] [From target to projectile: CSS evolution of quark TMD in different light-cone gauges](https://arxiv.org/abs/2606.17993)
...
### [58] [Ultra-High-Energy Cosmic Ray Boosted Relic Neutrinos](https://arxiv.org/abs/2606.18088)
...
### [59] [Twist-3 contributions to $γγ\toπ^0π^0,\,K_S^0K_S^0$ in $k_T$ factorization](https://arxiv.org/abs/2606.18233)
...
### [60] [PIVOT: Bridging Black-Scholes Implied-Volatility and Price Objectives via Differentiable Jäckel Operator](https://arxiv.org/abs/2606.17065)
...
### [61] [Martingale Doppelgänger-Eval: An Identification Framework for Auditing Candlestick Understanding in Vision-Language Models](https://arxiv.org/abs/2606.17423)
*Ziyao Wang*
...
### [62] [Exotic magnetism and persistent spin dynamics in a frustrated Jeff = 1/2 triangular lattice antiferromagnet](https://arxiv.org/abs/2606.17166)
...
### [63] [Antisite-disorder driven tuning of magnetic properties and exchange-bias in Nd$_{2-x}$Sr$_{x}$CoMnO$_{6-δ}$ $(0 \leq x \leq 1)$ ($δ\sim 0.5$) double perovskites](https://arxiv.org/abs/2606.17244)
...
### [64] [II. Exploring the role of the Crystal Electric Field in the vicinity of a Quantum Critical Point](https://arxiv.org/abs/2606.17305)
...
### [65] [Emergent Antiphase Stacking in a Transient Charge Density Wave](https://arxiv.org/abs/2606.17326)
...
### [66] [Flat-Band Stoner Instability and Peierls-Phase Origin of the Transdimensional Anomalous Hall Effect in Rhombohedral Graphite](https://arxiv.org/abs/2606.17535)
*Yang Zhou*
...
### [67] [Probing La-based nickelates with Ni 1$s$ core-level photoelectron spectroscopy](https://arxiv.org/abs/2606.17663)
...
### [68] [The antiferromagnetic transition in the frustrated bixbyite $β$-Fe$_2$O$_3$ magnet](https://arxiv.org/abs/2606.17842)
...
### [69] [Nonlinear Optical Probing of Ferroic-Octupolar Order Parameter in Collinear Altermagnet](https://arxiv.org/abs/2606.17848)
...
### [70] [Three-dimensional repulsive Hubbard model](https://arxiv.org/abs/2606.17933)
*Alexei Sherman*
...
### [71] [Theory of clusterization in orbitally degenerate transition-metal compounds driven by lattice instabilities](https://arxiv.org/abs/2606.18014)
...
### [72] [High-temperature ferromagnetism and antiferromagnetism in monolayer \ce{CrTe2}: Roles of strong spin-lattice coupling and charge doping](https://arxiv.org/abs/2606.18148)
...
### [73] [Superconductivity from emergent dipolar interactions in a fractionalized Fermi liquid](https://arxiv.org/abs/2606.17159)
...
### [74] [Hybrid Ferromagnet-SNSPDs: Single photon induced order-to-disorder transition in ferromagnets coupled to thin film superconductors](https://arxiv.org/abs/2606.17177)
...
### [75] [How twist angle inhomogeneity masks the BKT transition and the order parameter symmetry](https://arxiv.org/abs/2606.17191)
...
### [76] [Tunable Superconductivity in 1313-La$_3$Ni$_2$O$_7$: Suppressed under Compression and Possible $s^{\pm}$ Pairing under Tension](https://arxiv.org/abs/2606.17273)
...
### [77] [Distinguishing Majorana zero modes from trivial defect states on the surface of the iron-based superconductor Fe(Te,Se)](https://arxiv.org/abs/2606.17499)
...
### [78] [Graphene Josephson diodes from inherent asymmetric disorder](https://arxiv.org/abs/2606.17673)
...
### [79] [AC-flux-driven SQUID diode spectroscopy as a probe of current-phase relations](https://arxiv.org/abs/2606.17704)
...
### [80] [AC calorimetric study of magneto-quantum oscillations in anisotropic multiband V$_2$Ga$_5$ superconductor](https://arxiv.org/abs/2606.17750)
...
### [81] [Cavity-enhanced superconducting response in an underdoped cuprate](https://arxiv.org/abs/2606.18084)
...
### [82] [Superconductivity from interband coupling to ferroelectric quantum critical fluctuations in two dimensions](https://arxiv.org/abs/2606.18251)
