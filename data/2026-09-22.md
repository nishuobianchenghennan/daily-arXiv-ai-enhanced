...
### [15] [Experimentally validated process-microstructure-property relations of bainitic steels derived from phase-field simulations](https://arxiv.org/abs/2609.23737)
...
### [16] [Perspective: The HSE Screened Hybrid and the Band Gap Problem: Origins, Impact, and the Contenders](https://arxiv.org/abs/2609.23225)
*Gustavo E. Scuseria*
...
### [17] [Trade-off between interface morphology and compositional homogeneity in AlGaAs/GaAs quantum wells revealed by multislice electron ptychography](https://arxiv.org/abs/2609.23245)
...
### [18] [Ultralow-Barrier Ion Transport in the Subnitride Electride Ba$_3$N for High-Rate Sodium Storage](https://arxiv.org/abs/2609.23391)
...
### [19] [Sapphire-Side hBN Formation by Ni--Cr-Mediated Growth in a Stacked Ni--Cr/Boron/Sapphire Configuration: Effect of Boron Supply](https://arxiv.org/abs/2609.23447)
...
### [20] [Deterministic control of antiferromagnetic domain walls by circular phonons](https://arxiv.org/abs/2609.23563)
...
### [21] [Dual Role of Mobile Interstitials in Defect Kinetics: From Retardation to Acceleration](https://arxiv.org/abs/2609.23564)
...
### [22] [Transitions between bulk and interfacial fracture in diamond/$c$BN heterostructures](https://arxiv.org/abs/2609.23963)
...
### [23] [Phase field modelling of microstructure transformations in Zr-Sn alloy during irradiation](https://arxiv.org/abs/2609.23623)
...
### [24] [Enhanced thermal conductivity of (010) (AlxGa1-x)2O3 epitaxial films utilizing indium-catalyzed molecular beam epitaxy](https://arxiv.org/abs/2609.24081)
...
### [25] [Tailoring structural, electronic, optical, and magnetic properties of rare-earth gallates RGaO$_3$ (R = Ho, Er, Tm) via first-principles investigations](https://arxiv.org/abs/2609.23636)
...
### [26] [Computational investigation of a perovskite LaBiO$_{3}$ for photovoltaic, thermoelectric, and optoelectronic applications](https://arxiv.org/abs/2609.23641)
...
### [27] [Revealing tilt-driven structural heterogeneity in hybrid improper ferroelectrics by spatially-resolved crystallography](https://arxiv.org/abs/2609.24383)
...
### [28] [Electronic energy structure and optical properties of In$_{4}$CdI$_{6}$ from $\textit{ab initio}$ calculations](https://arxiv.org/abs/2609.23644)
...
### [29] [A small-distortion geometric model for elasto-plasticity in single crystals driven by the motion of dislocations](https://arxiv.org/abs/2609.23728)
*Filip Rindler*
...
### [30] [Polar vibrational excitations and glass-like response in relaxor PMN](https://arxiv.org/abs/2609.24100)
...
### [31] [Ferroelectric switching of odd-parity magnon spin splitting](https://arxiv.org/abs/2609.24182)
...
### [32] [Ultrahigh Thermal Conductivity in Isotopically Ultrapure Single-Crystal Diamond](https://arxiv.org/abs/2609.24191)
...
### [33] [Electronic-Entropy-Driven Phase Transitions in Compressed Iron Oxides](https://arxiv.org/abs/2609.24281)
...
### [34] [Small-supercell and Small-dataset Training Strategy of Machine Learning Interatomic Potentials for Point Defects](https://arxiv.org/abs/2609.24293)
...
### [35] [Vacancy aggregation enhances NV- spin coherence in diamond: a cluster-correlation-expansion study of multi-vacancy spin baths in semiconductors](https://arxiv.org/abs/2609.24295)
*Chikara Shinei*
...
### [36] [Amorphous insulating MoS$_x$ films deposited by magnetron sputtering as a low-index optical coating](https://arxiv.org/abs/2609.24326)
...
### [37] [Axial thermal expansion from free-energy minimization with temperature-dependent force constants in phonopy: a technical report, with $α$- and $ω$-Ti as the worked example](https://arxiv.org/abs/2609.24336)
*Atsushi Togo*
...
### [38] [On the dual character of Zn impurity in SnTe: Tuning thermoelectric and topological properties](https://arxiv.org/abs/2609.24459)
...
### [39] [III-V antiphase boundaries are not generated by Si or Ge substrate step edges](https://arxiv.org/abs/2609.24792)
...
### [40] [Scandium diboride: a semi-metallic, lattice, thermally matched substrate for vertical AlGaN power electronics](https://arxiv.org/abs/2609.24856)
...
### [41] [Face-to-face anneal temperature controls lattice parameter in Ta(C,N) virtual substrates for AlGaN power electronics](https://arxiv.org/abs/2609.24893)
...
### [42] [Stochastic consensus dynamics for decentralized decision systems](https://arxiv.org/abs/2609.22454)
...
### [43] [TubeLab: Interactive inverse design of wind instrument bores with hard spectral constraints](https://arxiv.org/abs/2609.22468)
...
### [44] [Exact ballistic energy transport and emergent XXZ dynamics in an integrable three-state chain](https://arxiv.org/abs/2609.22817)
...
### [45] [Diff-NekRS: A Scalable Differentiable Framework for Multi-Timestep Solver-in-the-Loop Training](https://arxiv.org/abs/2609.23208)
...
### [46] [MadVfold: accelerating NLO event generation and reducing negative weights with SIMD vectorization and GPUs](https://arxiv.org/abs/2609.23500)
*Andrea Valassi*
...
### [47] [A subcell-refined entropy-residual-driven limiting strategy for high-order discontinuous Galerkin methods](https://arxiv.org/abs/2609.24268)
...
### [48] [VNS Tokamak for Medical Isotope Production](https://arxiv.org/abs/2609.24371)
...
### [49] [Vanadium doping induced valley asymmetries in WS$_2$ monolayers](https://arxiv.org/abs/2609.22580)
...
### [50] [Electrical Probing of Dark Excitons through Microwave Permittivity](https://arxiv.org/abs/2609.22710)
...
### [51] [Non-Hermitian Topology from Edge Transport in Hermitian Quantum Anomalous Hall Systems](https://arxiv.org/abs/2609.23099)
...
### [52] [Magnetic Quadrupole Lens and Current-Induced Quadrupolar Dynamics of Antiskyrmion](https://arxiv.org/abs/2609.23129)
...
### [53] [Collective depinning of dipolar skyrmion chains: thermal and athermal rounding of an elastic polymer in a quenched landscape](https://arxiv.org/abs/2609.23181)
...
### [54] [Non-Markovian Quantum Dynamics of Exciton-Polaritons](https://arxiv.org/abs/2609.23295)
...
### [55] [Non-Hermitian Quantum Mechanics I: Instantaneous Self-Energy](https://arxiv.org/abs/2609.23426)
...
### [56] [Sub-Thermionic Switching in a Negative-Capacitance Bandgap-Change Field-Effect Transistor](https://arxiv.org/abs/2609.23505)
...
### [57] [Universal Generalized Brillouin Zone Theory I: Review of the Spectral Approach](https://arxiv.org/abs/2609.23523)
...
### [58] [Interplay of spin-orbit coupling and magnetic chirality: Multidirectional spin polarization in a helical antiferromagnet](https://arxiv.org/abs/2609.23618)
...
### [59] [Multiscale Modeling of Ion Transport in Nanopores: Fitting Implicit-Water Radial Diffusion Profiles to Explicit-Water Molecular Dynamics](https://arxiv.org/abs/2609.23575)
...
### [60] [Scalable Multiple Electron Transport Architectures for Feedback Traceable Current Sources](https://arxiv.org/abs/2609.24015)
...
### [61] [The Superconducting Talbot Effect in Phased-Array Josephson Junctions](https://arxiv.org/abs/2609.24572)
...
### [62] [Corbino-Enhanced Supersonic Acoustic-Emission Threshold in a GaAs Two-Dimensional Electron System](https://arxiv.org/abs/2609.24585)
...
### [63] [Observation of Kondo Effect in Rhombohedral Graphene Superlattices](https://arxiv.org/abs/2609.24734)
...
### [64] [Modified Low-Temperature Scanning Tunneling Microscope for Ultrafast Pump-Probe Spectroscopy](https://arxiv.org/abs/2609.24916)
...
### [65] [Model of the magnon Kerr effect in a highly anisotropic ferromagnet](https://arxiv.org/abs/2609.24959)
...
### [66] [Collective Coordinate Dynamics of Antiferromagnet: Gravity by Quantum Metric](https://arxiv.org/abs/2609.24975)
...
### [67] [Universal Diffusion Models for Implied Volatility Surfaces: Learning Shared Dynamics Across Stocks](https://arxiv.org/abs/2609.22893)
...
### [68] [OrderFusion+: Probabilistic Buy--Sell Price Trajectory Forecasting in Intraday Electricity Markets](https://arxiv.org/abs/2609.23598)
...
### [69] [Bootstrap certification of string order in quantum spin chains](https://arxiv.org/abs/2609.22420)
...
### [70] [Approaching the Inverse Neutron Scattering Problem with Neural Networks](https://arxiv.org/abs/2609.22535)
...
### [71] [Structural and magnetic properties of TbCuAs$_2$ studied by X-ray and neutron scattering](https://arxiv.org/abs/2609.22589)
...
### [72] [Probing $d$-wave pairing in the $t$-$t'$-$U$ Hubbard model with tensor-backflow wave functions](https://arxiv.org/abs/2609.22618)
*Xiao Liang*
...
### [73] [On the precise boundary of the Néel antiferromagnetic phase in the Shastry-Sutherland model](https://arxiv.org/abs/2609.22907)
...
### [75] [Hund-driven local-itinerant duality of Eu-4$f$ electrons in infinite-layer nickelates](https://arxiv.org/abs/2609.23645)
...
### [76] [Electronic structure and anisotropic magnetotransport in the topological kagome ferromagnet MgMn6Sn6](https://arxiv.org/abs/2609.23699)
...
### [77] [Decoupling the Magnetic Field Operator as an Independent Operator Class in Stochastic Series Expansion Quantum Monte Carlo](https://arxiv.org/abs/2609.23978)
*Shijie Jin,Lu Liu*
...
### [78] [A Majorana Formulation of Time-Dependent Two-Particle Reduced-Density-Matrix Dynamics](https://arxiv.org/abs/2609.23993)
...
### [79] [Slave-Rotor and Auxiliary Chain Analysis of the Mott Transition in a Modified Periodic Anderson Model](https://arxiv.org/abs/2609.24315)
...
### [80] [Spin-Orbit Induced Confinement of Correlated Bound States in the Continuum](https://arxiv.org/abs/2609.24429)
...
### [81] [Charge-4e Superconducting Ground State without Pair Condensation: Exact Quartet Dynamics, Rigorous Order, and a Microscopic Route](https://arxiv.org/abs/2609.24445)
...
### [82] [Carrier-mediated spin helices in low-dimensional systems: Josephson-interference features and correlation renormalization](https://arxiv.org/abs/2609.24502)
...
### [83] [Quantum-interference-driven orbital density wave and high-temperature superconductivity in trilayer nickelates](https://arxiv.org/abs/2609.24857)
...
### [84] [Raman Scattering Evidence for Fluctuating Kagome-Plane Moments in $\mathrm{B} \parallel [111]$ in Pr$_2$Zr$_2$O$_7$ pyrochlore](https://arxiv.org/abs/2609.24696)
...
### [85] [Infrared evidence for strong $C_{3}$ symmetry breaking in 1$T$-TiSe$_{2}$](https://arxiv.org/abs/2609.24705)
...
### [86] [Rapidly prototyping kagome flat band physics with acoustic metamaterials](https://arxiv.org/abs/2609.24721)
...
### [87] [Anisotropic Surface State Band Splitting and Low Energy Flat Bands in 3d Correlated Topological Kondo Insulator Candidate FeSb$_2$](https://arxiv.org/abs/2609.24854)
...
### [88] [Staged emergence of anomalous Hall transport in a correlated uranium Weyl semimetal](https://arxiv.org/abs/2609.24897)
...
### [89] [Raman scattering in cuprate oxychlorides high-temperature superconductors single-crystals](https://arxiv.org/abs/2609.22400)
...
### [90] [Comment on "Topography of Fermi arcs in t-PtBi$_2$ using high-resolution angle-resolved photoemission spectroscopy" arXiv:2503.08841 (cond-mat)](https://arxiv.org/abs/2609.22776)
*Sergey Borisenko*
...
### [91] [Pressure-induced unconventional charge-density-wave states in kagome metal AV3Sb5 (A = K, Rb, Cs)](https://arxiv.org/abs/2609.22794)
...
### [92] [Bulk Superconductivity in Rocksalt LaN$_{1-x}$](https://arxiv.org/abs/2609.23213)
...
### [93] [Coexistence and Interconversion of Multiple-Order Majorana Modes in Topological Superconductor Films with Varying Thickness](https://arxiv.org/abs/2609.24311)
...
### [94] [Parallel Simulation of Josephson Junctions With Multiplicative Noise](https://arxiv.org/abs/2609.24461)
...
### [95] [Detection of signals in presence of noise through Josephson junction switching currents](https://arxiv.org/abs/2609.24533)
...
### [96] [New theoretical model of the dynamic anomalies in HTc superconductors](https://arxiv.org/abs/2609.24607)
*J. Sosnowski*
...
### [97] [Interface engineering of spin triplet Cooper pairs for spin-valve implementation](https://arxiv.org/abs/2609.24803)
...
### [98] [Generalized conditions for odd-frequency pairing in superconducting systems](https://arxiv.org/abs/2609.24827)
...
### [99] [Electronic Reconstruction Towards Topological Superconductivity in FeTe](https://arxiv.org/abs/2609.24843)
...
### [100] [Coherent deeply virtual Compton scattering on helium-4 beyond the leading twist approximation](https://arxiv.org/abs/2609.22405)
...
### [101] [Resonant Gravitational Production of Chiral Dark Photons](https://arxiv.org/abs/2609.22423)
...
### [102] [Gravitational Waves from Long Strings and Loops](https://arxiv.org/abs/2609.22430)
...
### [103] [Non-Perturbative Modulus Decay and Multi-Component Dark Matter](https://arxiv.org/abs/2609.22438)
...
### [104] [Machine Learning for Invisible Dark Boson Searches at the Electron-Ion Collider](https://arxiv.org/abs/2609.22484)
...
### [105] [Heavy-quark spin precession as a magnetic field chronometer](https://arxiv.org/abs/2609.22492)
...
### [106] [Probing light axion-like particles in vector boson fusion at CMS with data parking and scouting](https://arxiv.org/abs/2609.22570)
...
### [107] [New bounds on light scalars from the tip of the red giant branch](https://arxiv.org/abs/2609.22638)
...
### [108] [Kaluza--Klein Dark-Photon Mediation of Inelastic Dark Matter at LUX-ZEPLIN](https://arxiv.org/abs/2609.22739)
...
### [109] [Gamma-Ray Echo as a Probe of Supernova Neutrino Emission Anisotropy and Long-Baseline Effects](https://arxiv.org/abs/2609.22806)
...
### [110] [CP violation in $B_{(s)}\toφK$ decays: Standard Model and isospin-dependent New Physics](https://arxiv.org/abs/2609.22970)
...
### [111] [The 248 keV LZ Recoil: A Possible Hint of Non-SM-Like Quark Yukawa Couplings with a Scalar-Portal Dark Matter](https://arxiv.org/abs/2609.23096)
*Bibhabasu De*
...
### [112] [Tackling the noisy truncated moment problem with Gaussian Processes: An application to parton distribution functions](https://arxiv.org/abs/2609.23196)
*Rohith Karur*
...
### [113] [New results for the 4-loop massive cusp anomalous dimension](https://arxiv.org/abs/2609.23247)
*Nikolaos Kidonakis*
...
### [114] [Initial-state control of vorticity--shear competition in longitudinal $Λ$ polarization in Pb--Pb collisions at $\sqrt{s_{\mathrm{NN}}}=5.36\,\mathrm{TeV}$](https://arxiv.org/abs/2609.23266)
...
### [115] [QCD thermodynamics through the crossover as a gas of confining strings with repulsive interactions](https://arxiv.org/abs/2609.23292)
...
### [116] [Exploring interference between $P_{c \bar c}$ resonances and background in the pion-induced reaction](https://arxiv.org/abs/2609.23300)
...
### [117] [LLM-Based FORM Code Generation with Verification-Driven Fine-Tuning](https://arxiv.org/abs/2609.23367)
*Bakar Chargeishvili*
...
### [118] [Heavy-Quark Production in DIS: Mellin Moments for Phenomenology](https://arxiv.org/abs/2609.23452)
...
### [119] [Dark photon portal dark matter with low-temperature reheating](https://arxiv.org/abs/2609.23475)
...
### [120] [The LUX-ZEPLIN Event as Hyperfine Spectroscopy of Composite Dark Matter](https://arxiv.org/abs/2609.23477)
...
### [121] [Investigation of the difference in the angular distributions of $Z\to \ell^{+}\ell^{-}$ events produced in quark-antiquark, quark-gluon and gluon-gluon collisions](https://arxiv.org/abs/2609.23552)
...
### [122] [Toponium Production at Future Muon Colliders and in heavy ion ultraperipheral collisions](https://arxiv.org/abs/2609.23576)
...
### [123] [LZ-Motivated Pseudo-Dirac Higgsinos in the Supersymmetric 331 Model from the Supersymmetric \texorpdfstring{$SU(6)$}{SU(6)} GUT Model](https://arxiv.org/abs/2609.23691)
...
### [124] [Probing Matter Unification through Higgs Physics at the LHC](https://arxiv.org/abs/2609.23708)
...
### [125] [Baryogenesis and dark matter freeze-in from Higgs interactions](https://arxiv.org/abs/2609.23829)
...
### [126] [Non-standard cosmic strings with amazing profiles](https://arxiv.org/abs/2609.23920)
...
### [127] [Three-Body Holonomy as a Toy-Model Mechanism for Family Triplication and Mass Hierarchy in (1+1) Dimensions](https://arxiv.org/abs/2609.24022)
*Tadashi YOSHIKAWA*
...
### [128] [Deciphering the production mechanism of the LHCb $P_c$ states](https://arxiv.org/abs/2609.24231)
...
### [129] [Holonomic techniques for massive 3-loop form factors: the gluonic case](https://arxiv.org/abs/2609.24279)
...
### [130] [Multitask Jet Analysis with Vision-Language Models: A Physics-Informed Four-Panel Representation](https://arxiv.org/abs/2609.24334)
...
### [131] [Probing Massive Invisible Dark Photons in Higgs Decays via Gluon--Gluon Fusion at ATLAS Run 3](https://arxiv.org/abs/2609.24527)
...
### [132] [Spectroscopic parameters of $B_c$ meson](https://arxiv.org/abs/2609.24536)
...
### [133] [Probing axion-like particle couplings to leptons via the $γγjj$ signal at the FCC-ee](https://arxiv.org/abs/2609.24566)
...
### [134] [Resolving the universality and polarization puzzles in $J/ψ$ hadroproduction](https://arxiv.org/abs/2609.24674)
...
### [135] [The phenomenology of Axion Relic Pockets](https://arxiv.org/abs/2609.24714)
...
### [136] [Impact of nuclear shell model uncertainties on silicon and germanium WIMP-nucleus limits](https://arxiv.org/abs/2609.24764)
...
### [137] [Comparative Study of Color Glass Condensate and Collinear Frameworks for Large-Transverse-Momentum Semi-Inclusive Deep Inelastic Scattering](https://arxiv.org/abs/2609.24783)
...
### [138] [A New Probe of Strongly-Interacting Dark Sector using Neutrino Telescopes](https://arxiv.org/abs/2609.24887)
...
### [139] [Two-loop amplitude for the associated production of a top-anti-top pair and a $W$ boson at hadron colliders](https://arxiv.org/abs/2609.24910)
*Mattia Pozzoli*
...
### [140] [On the failure of the $12\%$ rule in $J/ψ$ and $ψ(2S)$ decays](https://arxiv.org/abs/2609.24961)
...
### [141] [A closer look at the LZ 248 keV event through the lens of cosmic-ray boosted dark matter](https://arxiv.org/abs/2609.24982)
...
### [142] [Interpreting the LZ 248 keV Event using Dark QCD](https://arxiv.org/abs/2609.24988)
...
### [143] [Three-Flavoured Thermal Leptogenesis Without Tuning](https://arxiv.org/abs/2609.24990)
*Angus Spalding*
