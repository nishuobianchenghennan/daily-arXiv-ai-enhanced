...
### [1] [Electrostatically-induced topological phase transitions in polyacetylene molecules](https://arxiv.org/abs/2603.03473)
...
### [2] [Multimode cavity magnonics in mumax+: from coherent to dissipative coupling in ferromagnets and antiferromagnets](https://arxiv.org/abs/2603.03706)
...
### [3] [Graphene Zero-Bias Sub-Terahertz Turnkey Detector with Above 43 GHz Bandwidth](https://arxiv.org/abs/2603.03554)
...
### [4] [Analysis of an all-to-all connected star array of transmon qubits](https://arxiv.org/abs/2603.03586)
*Ricardo A. Pinto*
...
### [5] [Symmetry selection rules for the intrinsic nonlinear thermal Hall effect in altermagnets: Role of quantum metric and $C_{2}$ rotational symmetry](https://arxiv.org/abs/2603.03599)
*Gunn Kim*
...
### [6] [Impact of the out-of-plane conductivity on spin transport evaluation in a van der Waals material](https://arxiv.org/abs/2603.03609)
...
### [7] [Coulomb interaction unlocks Majorana-mediated electron teleportation between Quantum dots](https://arxiv.org/abs/2603.03699)
...
### [8] [Non-reciprocity and exchange-spring delay of domain-wall Walker breakdown in magnetic nanowires with azimuthal magnetization](https://arxiv.org/abs/2603.03715)
...
### [9] [Imaging asymmetric Coulomb blockade phenomena across metallic nanoislands](https://arxiv.org/abs/2603.03783)
...
### [10] [Demonstration of robust chiral edge transport in Chern insulator MnBi2Te4 devices with engineered geometric defects](https://arxiv.org/abs/2603.03927)
...
### [11] [Trainable Neuromorphic Spintronic Hardware Via Analog Finite-Difference Gradient Methods](https://arxiv.org/abs/2603.03947)
...
### [12] [Probing pure spin-rotation quantum geometry in persistent spin textures via nonlinear transport](https://arxiv.org/abs/2603.04023)
...
### [13] [Interfering trajectories in a ballistic Andreev cavity](https://arxiv.org/abs/2603.04046)
...
### [14] [Generating Exceptional Knots and Links with Arbitrary Braiding Topology](https://arxiv.org/abs/2603.04143)
...
### [15] [Progress on artificial flat band systems: classifying, perturbing, applying](https://arxiv.org/abs/2603.04248)
...
### [16] [Ab initio study of saddle-point excitons in monolayer SnS2](https://arxiv.org/abs/2603.04294)
...
### [17] [Hanle lineshapes and spin-rotation signatures from in-plane anisotropic spin relaxation in heterogeneous spin devices](https://arxiv.org/abs/2603.04297)
...
### [18] [Sub-wavelength mid-infrared imaging of locally driven photocurrents using diamond campanile probes](https://arxiv.org/abs/2603.04318)
...
### [19] [Dynamics of Charge-Density-Wave puddles in 2$H$-NbSe$_2$](https://arxiv.org/abs/2603.03980)
...
### [20] [Symmetry-protected topology and deconfined solitons in a multi-link $\mathbb{Z}_2$ gauge theory](https://arxiv.org/abs/2603.03374)
...
### [21] [A Fermi Surface Driven Spiral Spin Liquid](https://arxiv.org/abs/2603.03434)
...
### [22] [Mixed-state Phases from Higher-order SSPTs with Kramers-Wannier Symmetry](https://arxiv.org/abs/2603.03455)
...
### [23] [Kondo driven suppression of charge density wave in Van der Waals material UTe$_3$](https://arxiv.org/abs/2603.03509)
...
### [24] [Coupled-cluster approach to vibronic effects in resonant inelastic x-ray scattering of quantum materials: Application to a $5d^1$ rhenium oxide](https://arxiv.org/abs/2603.03551)
...
### [25] [Magnetic Signature of Chiral Phonons Revealed by Neutron Spectroscopy in Ferrimagnetic Fe$_{1.75}$Zn$_{0.25}$Mo$_3$O$_8$](https://arxiv.org/abs/2603.03635)
...
### [26] [X-ray magnetic circular dichroism evidence of intrinsic $d$-wave altermagnetism in rutile-structure NiF$_2$](https://arxiv.org/abs/2603.03694)
...
### [27] [Contribution of remote bands to orbital magnetization in twisted bilayer graphene](https://arxiv.org/abs/2603.03702)
...
### [28] [NMR evidence of spin supersolid and Pomeranchuk effect behaviors in the triangular-lattice antiferromagnet Rb$_2$Ni$_2$(SeO$_3$)$_3$](https://arxiv.org/abs/2603.03703)
...
### [29] [Skyrmion generation via Laguerre-Gaussian beam irradiation in frustrated magnets](https://arxiv.org/abs/2603.03773)
...
### [30] [Dualities and Topological Classification of the $S=1$ Pyrochlore Spin Ice](https://arxiv.org/abs/2603.03852)
...
### [31] [Quantum oscillations and linear magnetoresistance in ultraclean CaVO$_3$ thin films](https://arxiv.org/abs/2603.04138)
...
### [32] [Emergent dimensional reduction in a distorted kagome magnet $\mathrm{YCa_3(CrO)_3(BO_3)_4}$ driven by exchange hierarchy](https://arxiv.org/abs/2603.04253)
...
### [33] [Higgs Boson Production in Association with a Single Top Quark as a Probe of the Top Yukawa Coupling](https://arxiv.org/abs/2603.03404)
...
### [34] [Unitarity bounds and sum rules in the SMEFT](https://arxiv.org/abs/2603.03423)
...
### [35] [The COSMIC WISPers White Paper: The physics case for Weakly Interacting Slim Particles](https://arxiv.org/abs/2603.03433)
...
### [36] [New Thermal-Relic Targets for sub-GeV Dark Matter Direct Detection](https://arxiv.org/abs/2603.03444)
...
### [37] [Emergent axion and Higgs boson from strong dynamics](https://arxiv.org/abs/2603.03449)
...
### [38] [Flavor in Ninths and a Discrete Gauge Origin of the QCD Axion](https://arxiv.org/abs/2603.03631)
*Vernon Barger*
...
### [39] [Searching for ALP Lepton Flavor Violation via ALP Decays at the LHC](https://arxiv.org/abs/2603.03647)
...
### [40] [Method of regions for dual conformal integrals](https://arxiv.org/abs/2603.03728)
*Roman N. Lee*
...
### [41] [Understanding the Structure of Doubly-Heavy Tetraquarks based on the Diquark Model](https://arxiv.org/abs/2603.03764)
...
### [42] [Leptogenesis from the Dirac CP-violating phase in the minimal left-right symmetric model](https://arxiv.org/abs/2603.03874)
...
### [43] [Interpretation of $Ω(2012)$ as a $Ξ(1530)K$ molecular state](https://arxiv.org/abs/2603.03976)
...
### [44] [Weak Interaction Contribution to the Muonium Hyperfine Structure in the Standard Model](https://arxiv.org/abs/2603.04026)
...
### [45] [NNLO DGLAP splitting functions from collinear matching of TMDs](https://arxiv.org/abs/2603.04039)
*Yu Jiao Zhu*
...
### [46] [Features of Spacetime-Symmetry Breaking and the Standard-Model Extension in Riemann-Cartan Geometry](https://arxiv.org/abs/2603.04079)
*Robert Bluhm*
...
### [47] [Topological observables and domain wall tension from finite temperature chiral perturbation theory](https://arxiv.org/abs/2603.04116)
...
### [48] [Dark matters are Inert, or FIMPy, or WIMPy or UFOy: An inflationary gravitational particle production](https://arxiv.org/abs/2603.04155)
*Ayan Chakraborty,Debaprasad Maity,Rajesh Mondal*

Main category: hep-ph

TL;DR: 这篇论文研究了在宇宙暴胀期间由引力产生的暗物质如何影响其后续演化，发现这一机制能增加暗物质的数量，从而扩展了现有暗物质理论模型的可能性。


<details>
  <summary>Details</summary>
Motivation: 传统的暗物质模型正面临越来越严格的实验限制。该研究旨在探索一种新的粒子产生机制——暴胀时期的引力粒子产生，以期为暗物质物理学开辟新的可能性并扩大其参数空间。

Method: 论文将暴胀时期产生的暗物质涨落视为引力粒子，并分析其在暴胀后重新进入视界时对暗物质玻尔兹曼方程的影响。作者引入了一个非守恒的源项来描述这一过程，并据此分析了四种不同相互作用强度的暗物质类型（惯性、WIMPy、UFOy、FIMPy）。

Result: 研究发现，引力产生的低动量暗物质模式在宇宙晚期不断进入视界，从而增强了暗物质的数密度。这种增强效应扩大了热暗物质和非热暗物质模型的可行参数空间。

Conclusion: 该研究提出的引力粒子产生机制可以显著扩展现有暗物质模型的参数空间，并且该扩展后的空间与当前的宇宙学观测（如有效中微子数和莱曼α森林）限制相符，证明了此机制的可行性。
...
### [49] [Nuclear $μ-e$ conversion via Lorentz and CPT violation](https://arxiv.org/abs/2603.04171)
*William P. McNulty*
...
### [50] [A baryon-calibrated unified quark-diquark effective mass formalism for heavy multiquarks](https://arxiv.org/abs/2603.04175)
...
### [51] [Quantum Kinetic Theory for Quantum Chromodynamics](https://arxiv.org/abs/2603.04263)
*Shu Lin*
...
### [52] [A framework for missing-energy searches with anomalous light vectors](https://arxiv.org/abs/2603.04394)
...
### [53] [TritonDFT: Automating DFT with a Multi-Agent Framework](https://arxiv.org/abs/2603.03372)
...
### [54] [Computational discovery of bifunctional organic semiconductors for energy and biosensing](https://arxiv.org/abs/2603.03392)
...
### [55] [Nine-element machine-learned interatomic potentials for multiphase refractory alloys](https://arxiv.org/abs/2603.04147)
...
### [56] [Quantum Theory of Functionally Graded Materials](https://arxiv.org/abs/2603.03424)
...
### [57] [Machine-learned Interatomic Potential for Ti$_{n+1}$C$_n$ MXenes: Application to Ion Irradiation Simulations](https://arxiv.org/abs/2603.04152)
*Jesper Byggmästar*
...
### [58] [Strain effects on $n$-type doping in AlN](https://arxiv.org/abs/2603.03528)
...
### [59] [Probing Interface-Driven Mechanisms of Non-Classical Light in van der Waals Heterostructures](https://arxiv.org/abs/2603.03534)
...
### [60] [Predicting Spin-Crossover Behavior in Metal-Organic Frameworks from Limited and Noisy Data Using Quantile Active Learning](https://arxiv.org/abs/2603.03545)
...
### [61] [A Pathway Selection Process for Dynamically Self-Organizing Systems](https://arxiv.org/abs/2603.03557)
*J. A. Sekhar*
...
### [62] [Plasmonic polaron in self-intercalated 1T-TiS2](https://arxiv.org/abs/2603.03663)
...
### [63] [Nonvolatile Control of Nonlinear Hall and Circular Photogalvanic Effects via Berry Curvature Dipole in Multiferroic Monolayer CrNBr2](https://arxiv.org/abs/2603.03670)
...
### [64] [Insights into hydrogen-induced vacancy stability and creep in chemically complex alloys](https://arxiv.org/abs/2603.03707)
...
### [65] [Ultralow and Tunable Thermal Conductivity of Parylene C for Thermal Insulation in Advanced Packaging](https://arxiv.org/abs/2603.03737)
...
### [66] [Remote Plasma Polymers of Iron (II) Phthalocyanine in Polyacrylonitrile-Derived Carbon Electrospun Fibers as Electrode for Supercapacitors](https://arxiv.org/abs/2603.03900)
...
### [67] [Hydrostatic Pressure Driven Band Gap Tuning and Self-Trapped Exciton Formation in (4FPEA)$_2$SnBr$_{4}$ Halide Perovskite](https://arxiv.org/abs/2603.03931)
...
### [68] [Machine learning assisted High-Throughput study of M$_4$X$_3$T$_x$ MXenes](https://arxiv.org/abs/2603.04103)
...
### [69] [Dispersion and lifetimes of magnons in non-collinear magnets from time dependent density functional theory](https://arxiv.org/abs/2603.04111)
...
### [70] [Chemical Vapor Deposition of Epitaxial Chromium Nitride Thin Films](https://arxiv.org/abs/2603.04154)
...
### [71] [Electronic and structural properties of V$_2$O$_5$ layered polymorphs](https://arxiv.org/abs/2603.04193)
...
### [72] [The effect of chemical vapor infiltration process parameters on flexural strength of porous α-SiC: A numerical model](https://arxiv.org/abs/2603.04287)
...
### [73] [Study on the Effect of Annealing on Ga$_2$O$_3$ Thin Films Deposited on Silicon by RF Sputtering](https://arxiv.org/abs/2603.04327)
...
### [74] [Enhanced superconductivity in palladium hydrides by non-perturbative electron-phonon effects](https://arxiv.org/abs/2603.03492)
...
### [75] [Limited coincidence between ultrahigh-field superconductivity and line of metamagnetic endpoints in UTe$_2$](https://arxiv.org/abs/2603.03500)
