...
### [23] [Anomalous Hall and Nernst effects driven by static and fluctuating spin chiralities on Kagome lattice](https://arxiv.org/abs/2607.06966)
...
### [24] [Ab initio thermodynamic statistical modeling of the miscibility gap and the metal-insulator phase transition in SrTi$_{1-x}$V$_x$O$_{3}$](https://arxiv.org/abs/2607.07067)
...
### [25] [Floquet-Weyl states at one-photon resonances in three-dimensional topological insulators](https://arxiv.org/abs/2607.07199)
...
### [26] [Critical SO(5) scaling of entanglement entropy at honeycomb lattice deconfined criticality](https://arxiv.org/abs/2607.07248)
...
### [27] [Magnetocaloric properties of centered molecular quantum spin systems](https://arxiv.org/abs/2607.07307)
*H. Meel,J. Schnack*
...
### [28] [Pressure-induced PT Symmetry Breaking in LaMnSi](https://arxiv.org/abs/2607.07310)
...
### [29] [Magnetotransport Properties of Iron-Based Ladder Compounds BaFe2S3 and BaFe2Se3 under High Pressure](https://arxiv.org/abs/2607.07326)
...
### [30] [Ab Initio Investigation of Pressure Effects in the Spin-Liquid Candidate Y-Kapellasite](https://arxiv.org/abs/2607.07341)
...
### [31] [Quantitative DFT+DMFT description of spectra and transport in the moderately correlated metal SrVO$_3$](https://arxiv.org/abs/2607.07378)
...
### [32] [Crossover and Changeover in Spin-1 Kitaev-$Γ$ Chain with Uniaxial Single-ion Anisotropy](https://arxiv.org/abs/2607.07501)
...
### [33] [Strain-tunable charge localization coupled to complex magnetic orders in EuAl$_4$](https://arxiv.org/abs/2607.07544)
...
### [34] [Raman spectroscopic signature of Kitaev magnetism and complex spin-lattice coupling in S = 1/2 antiferromagnet SrLaCoNbO$_6$ double perovskite](https://arxiv.org/abs/2607.07630)
...
### [37] [Moiré Phonon Condensation in Magic-Angle Twisted Bilayer Graphene](https://arxiv.org/abs/2607.06711)
...
### [38] [Mesoscopic routers and single-pole double-throw switches for electronic heat](https://arxiv.org/abs/2607.06716)
...
### [39] [Driven square lattice of quantum dots in a magnetic field coupled to a cylindrical FIR-photon cavity](https://arxiv.org/abs/2607.06812)
...
### [40] [High-frequency nonlinear conductivity of a Wigner crystal](https://arxiv.org/abs/2607.06846)
...
### [41] [Disorder signatures in coherent electronic waveguides](https://arxiv.org/abs/2607.06866)
...
### [42] [Scanning tunneling microscopy of resonant-impurity in altermagnets: dual Fano resonance and Landau-quantization-induced nodal spin contrast](https://arxiv.org/abs/2607.06885)
...
### [43] [Visualizing modified spin-wave wavefronts near magnetic defects and domains using nitrogen-vacancy centers](https://arxiv.org/abs/2607.06941)
...
### [44] [Perspectives on inverse design for AI magnonics](https://arxiv.org/abs/2607.07324)
...
### [45] [Spin-polarized electron transport for the altermagnet CrSb](https://arxiv.org/abs/2607.07334)
...
### [46] [Force-Isosurface Simulations Probe the Limits of High-Resolution AFM on Three-Dimensional Molecules](https://arxiv.org/abs/2607.07363)
...
### [47] [Nonlinear Dynamics of Hopfion for Frequency Multiplication](https://arxiv.org/abs/2607.07499)
...
### [48] [Tunnel-rate controlled local heat distribution in mesoscopic circuits](https://arxiv.org/abs/2607.07559)
...
### [49] [Unveiling the Spin-Valley Structure of Dipolar Exciton Ladders in R-stacked WSe$_2$/WS$_2$ Moiré Heterobilayers](https://arxiv.org/abs/2607.07590)
...
### [50] [Geometric Interpretation of Sum Photon Blockade](https://arxiv.org/abs/2607.07591)
...
### [51] [Non-Hermitian Edge State Endocytosis](https://arxiv.org/abs/2607.07703)
...
### [52] [BatteryMat: a hierarchical machine-learning and DFT framework for average-voltage screening of lithium-ion cathode materials](https://arxiv.org/abs/2607.06645)
...
### [53] [Origin of the reaction temperature in solid-state materials synthesis](https://arxiv.org/abs/2607.06685)
...
### [54] [Fluctuation-Driven Enhancement of Spin-Orbit Torque near the Curie Temperature of Ultrathin Ferromagnets](https://arxiv.org/abs/2607.06703)
...
### [55] [Physical exact conditions as regularizers for exchange-correlation in solids and surface chemistry](https://arxiv.org/abs/2607.06729)
*Johannes Voss*
...
### [56] [Spin-orbit magnetism in altermagnets](https://arxiv.org/abs/2607.06730)
...
### [57] [First-Principles Investigation of the Al-V Phase Diagram](https://arxiv.org/abs/2607.06741)
...
### [58] [Topological charge, helicity and vorticity conservation and the reverse spin-current model in the II-nd type multifferoics](https://arxiv.org/abs/2607.06756)
*Pavel A. Andreev*
...
### [59] [Symmetry-Enforced Chiral Phonons in Altermagnets via Magnon-Phonon Coupling](https://arxiv.org/abs/2607.06792)
...
### [60] [Are Machine Learning Interatomic Potentials Truly Practical? A Benchmark of 23 Mainstream Models](https://arxiv.org/abs/2607.07647)
...
### [61] [Large-scale pseudopotential density functional theory calculations using orthogonalized enriched finite element basis](https://arxiv.org/abs/2607.06848)
...
### [62] [Thermoelectric and Magnetic Properties in Doped Fe$_2$VAl within a Bipolar Random Anderson Model](https://arxiv.org/abs/2607.06878)
...
### [63] [Negative and Zero Linear Compressibility in MCN (M = Ag, Au, Cu): A First-Principles Study](https://arxiv.org/abs/2607.06904)
...
### [64] [AI2Pot: A scalable and unified framework for machine-learning interatomic potential development and large-scale molecular dynamic simulations](https://arxiv.org/abs/2607.06969)
...
### [65] [Surface-Reconstruction-Driven Insulating Behavior in Metallic Charge-Density-Wave 1T-TaSe$_{2}$](https://arxiv.org/abs/2607.06995)
...
### [66] [Size focusing in core-shell precipitates: A phase-field study](https://arxiv.org/abs/2607.07002)
...
### [67] [Minimizing propagated density errors of atomic core-electron for simultaneously accurate bandgaps and lattice constants in closed-shell Copper semiconductors](https://arxiv.org/abs/2607.07037)
...
### [68] [A modified Moss rule highlights underexplored classes of high refractive index materials](https://arxiv.org/abs/2607.07086)
...
### [69] [Non-Hermitian control of helicity-selective antiferromagnetic resonance](https://arxiv.org/abs/2607.07488)
...
### [70] [Phonon scattering mechanisms in WTe$_2$ observed by ultrafast coherent phonon spectroscopy](https://arxiv.org/abs/2607.07087)
...
### [71] [Ethaline deep eutectic solvent under nanoconfinement: Unveiling structural and dynamical changes](https://arxiv.org/abs/2607.07090)
...
### [72] [Unveiling Nanoscale Surface Damage Dynamics in Swift Heavy Ion Irradiated Gallium Nitride](https://arxiv.org/abs/2607.07092)
...
### [73] [Interplay of Umklapp scattering and Sb-Au hybridization in surface-reconstructed Sb/Au(111)](https://arxiv.org/abs/2607.07132)
...
### [74] [Terahertz Phase Inversion via Field-Free Spin-Orbit Torque Switching in an Antenna-Integrated Spintronic Heterostructure](https://arxiv.org/abs/2607.07220)
...
### [75] [Understanding surface potential dynamics of passivated perovskites via Kelvin Probe Force Microscopy](https://arxiv.org/abs/2607.07221)
...
### [76] [Improving feature resolution and pore back effect in focused ion beam tomography of porous GaN thin films](https://arxiv.org/abs/2607.07273)
...
### [77] [Bayesian Optimization of Genetic Algorithm Hyperparameters in a Multi-Fidelity Framework for Efficient Lattice Material Design](https://arxiv.org/abs/2607.07289)
...
### [78] [A Topotactic Phase Transition in the Uranium Oxide System](https://arxiv.org/abs/2607.07291)
...
### [79] [Electrical manipulation and detection of perpendicular altermagnetic order via proximitized Dirac semimetal](https://arxiv.org/abs/2607.07299)
...
### [80] [Machine Learning Materials Properties by Encoding Orbital-Projected Density of States](https://arxiv.org/abs/2607.07339)
...
### [81] [Optimizing high-temperature electron mobility in single-crystal Bi$_2$O$_2$Se based on its unconventional dependence on concentration](https://arxiv.org/abs/2607.07384)
...
### [82] [Growth of (111)-textured SrTiO3 thin films on Pt(111)/Al2O3(1-102) substrates by rf magnetron sputter deposition](https://arxiv.org/abs/2607.07428)
...
### [83] [A Multi-Scale Machine Learning Framework for Coupled Chemical, Spin, and Structural Disorder in Alloys](https://arxiv.org/abs/2607.07456)
...
### [84] [Stress calculation in linear scaling DFT: convergence and dynamics](https://arxiv.org/abs/2607.07472)
...
### [85] [Monolithic GaN Systems Combining Non-Volatile Memory and Analog Computing via Area-Ratio-Engineered Ferroelectric AlScN Gate Stacks](https://arxiv.org/abs/2607.07577)
...
### [86] [Human and LLM Collaboration for Accelerated Materials Synthesis and Discovery](https://arxiv.org/abs/2607.07604)
...
### [87] [MLIP Studio: An Open Platform for Interactive Benchmarking and Atomistic Simulations Using Machine Learning Interatomic Potentials](https://arxiv.org/abs/2607.07606)
...
### [88] [Acoustic-phonon-driven spin-lattice relaxation of the hBN boron vacancy in the sub-THz regime](https://arxiv.org/abs/2607.07642)
...
### [89] [Decoding magnetic texture](https://arxiv.org/abs/2607.07685)
...
### [90] [Impact of Courant number on the results of numerical simulating of signal propagation in non-dispersive homogeneous media](https://arxiv.org/abs/2607.06707)
...
### [91] [Path Integral Monte Carlo for Fictitious Identical Particles with ξ-Ensemble](https://arxiv.org/abs/2607.06955)
*Yunuo Xiong*
...
### [92] [Radiation Damage Cascades in Fullerite Using Molecular Dynamics](https://arxiv.org/abs/2607.06962)
...
### [93] [Inverse Low-Dimensional Manifold Reconstruction Framework for Spatiotemporal Reconstruction of Compressible Physical Fields](https://arxiv.org/abs/2607.07084)
...
### [94] [Collaborate to decorrelate in path space: Hamiltonian replica exchange transition interface sampling (HRETIS)](https://arxiv.org/abs/2607.07453)
...
### [95] [Semilocal exchange functionals from the exact-exchange condition for the hydrogen atom: Hydrogenic exactness and recovery of Rydberg-like bound states](https://arxiv.org/abs/2607.07648)
*Fumihiro Imoto*
...
### [96] [Scaling WaterLily.jl with MPI and an improved geometric multigrid solver](https://arxiv.org/abs/2607.07687)
...
### [97] [Synthesis of Bulk Superconducting LiNbO$_2$ Crystals through CaH$_2$ Reduction](https://arxiv.org/abs/2607.06819)
...
### [98] [Emergent superconductivity upon disordering a topological insulator](https://arxiv.org/abs/2607.07163)
...
### [99] [Nucleation and Enhancement of Superconductivity under Tip-Induced Strain Fields](https://arxiv.org/abs/2607.07210)
...
### [100] [Pressure-induced Structural Phase Transition, Metallization, and Superconductivity in layered metalloid dichalcogenide 1T-SiTe$_2$](https://arxiv.org/abs/2607.07569)
