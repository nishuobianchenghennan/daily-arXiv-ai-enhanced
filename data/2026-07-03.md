...
### [3] [Efficient Large-Scale STEM-EELS Simulations With Torched-TACAW](https://arxiv.org/abs/2607.02236)
...
### [15] [From Bloch to Néel: Anisotropy-dependent Domain-Wall Character in FePd Thin Films](https://arxiv.org/abs/2607.02256)
...
### [24] [Neutron stars as thermometers for reheating induced dipole dark matter](https://arxiv.org/abs/2607.01390)
*Sahabub Jahedi*
...
### [25] [One-loop matching of QCD currents to power-suppressed two-jet operators](https://arxiv.org/abs/2607.01413)
...
### [26] [The theory of electric dipole moments: the view from below](https://arxiv.org/abs/2607.01443)
*Jordy de Vries*
...
### [27] [An introduction to Hammer v2: Helicity Amplitude Module for Matrix Element Reweighting](https://arxiv.org/abs/2607.01459)
...
### [28] [Hadronization of $Λ_c^+$ baryons from recombination model in Pb+Pb collisions at the Large Hadron Collider](https://arxiv.org/abs/2607.01637)
...
### [29] [Gravitational Waves from Multiple First-Order Phase Transitions in a Scenario with Early Matter Domination](https://arxiv.org/abs/2607.01697)
...
### [30] [Subensemble Acceptance Method 3.0: General Corrections to Cumulants from Exact Conservation Constraints](https://arxiv.org/abs/2607.01783)
...
### [31] [Hybrid Residual Correction of VMC Charmonium Masses with a Screened Funnel Interaction](https://arxiv.org/abs/2607.01797)
...
### [32] [Phenomenology of genuine twist-three distributions from a global QCD analysis](https://arxiv.org/abs/2607.01866)
...
### [33] [Refined Sensitivity Estimates for Single-Molecule Magnet Dark Matter Detectors](https://arxiv.org/abs/2607.01868)
...
### [34] [Dynamics of Self-Interacting Dark Sectors](https://arxiv.org/abs/2607.01920)
*Esau Cervantes*
...
### [35] [One-loop proton decay from Peccei-Quinn symmetry](https://arxiv.org/abs/2607.02026)
*H. B. Câmara*
...
### [36] [$Λ$ hyperons in core-collapse supernovae: Equilibration and neutrino opacities](https://arxiv.org/abs/2607.02086)
...
### [37] [Light tetraquark states with $J^{PC}=1^{--}$ from QCD sum rules](https://arxiv.org/abs/2607.02109)
...
### [38] [Searching for single production of a vector-like $Y$ quark decaying into $bW$ at the FCC-eh](https://arxiv.org/abs/2607.02177)
...
### [40] [A Comprehensive Analysis of $B_s \to D_s^{**}\ellν_\ell$ Decays Within and Beyond the Standard Model](https://arxiv.org/abs/2607.02276)
...
### [41] [A Maximum-Entropy Method for Zero-Skewness Valence GPDs Constrained by Nucleon Electromagnetic Form Factors](https://arxiv.org/abs/2607.02302)
*Seung-il Nam*
...
### [42] [New constraints on non-unitary neutrino mixing from 8 years of IceCube DeepCore atmospheric neutrino data](https://arxiv.org/abs/2607.02355)
...
### [43] [Symmetry Analysis of Compact Tetraquark States and Implications for the Level Ordering of the Fully Charmed Candidates $X(6600)$, $X(6900)$, and $X(7100)$](https://arxiv.org/abs/2607.02382)
...
### [44] [Chebyshev Approximations of Feynman Integrals for Collider Physics](https://arxiv.org/abs/2607.02411)
...
### [45] [Event-axis TMD measurements in $e^+e^-$ and SIDIS](https://arxiv.org/abs/2607.02438)
...
### [50] [Fermiology and spin polarization of topological surface states in PtBi$_2$](https://arxiv.org/abs/2607.01947)
...
### [51] [Fabrication of high-quality topological insulator nanodevices from bulk-insulating air-sensitive Sb-Bi$_2$Se$_3$](https://arxiv.org/abs/2607.01439)
...
### [52] [An efficient formalism for inertial spin waves: Dzyaloshinskii-Moriya antiferromagnets as case studies](https://arxiv.org/abs/2607.02021)
...
### [53] [Anisotropic tunneling through magnetic barriers in 8-Pmmn borophene](https://arxiv.org/abs/2607.02077)
...
### [54] [The Wigner function for Integer quantum Hall effect](https://arxiv.org/abs/2607.02094)
...
### [55] [Quantum-geometric shift of quasiequilibrium: Origin of nonreciprocal current driven by quantum-metric dipole](https://arxiv.org/abs/2607.02100)
...
### [56] [A 2048-spin bulk acoustic wave Ising machine for number partitioning and Sudoku](https://arxiv.org/abs/2607.02112)
...
### [57] [Electrical transport in ultra-thin films: from Fuchs-Sondheimer to quantum-confinement](https://arxiv.org/abs/2607.02120)
*Alessio Zaccone*
...
### [58] [Entropy of Non-Abelian Anyons from Slow Quasiparticle Dynamics in Quantum Hall Interferometers](https://arxiv.org/abs/2607.02188)
...
### [59] [Josephson and Spin Currents in Coupled Polariton Condensates](https://arxiv.org/abs/2607.02265)
...
### [60] [Coupled Spin-Orbital $p$-Wave Magnetism via Structural and Magnetic Chirality](https://arxiv.org/abs/2607.02378)
...
### [61] [Intrinsic orbital Hall effect in a nonuniform electric field](https://arxiv.org/abs/2607.02418)
...
### [63] [Ultrasonic Observation of Slowing Down of Multipole Fluctuations in Sr$_2$RuO$_4$](https://arxiv.org/abs/2607.01720)
...
### [64] [Nonperturbative Nonlinear Hall Effect in Nonequilibrium Steady States](https://arxiv.org/abs/2607.01519)
