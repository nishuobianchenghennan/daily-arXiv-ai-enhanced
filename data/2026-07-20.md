...
### [16] [Loss of positive definiteness is a symptom, not the cause, of high-Weissenberg-number breakdown](https://arxiv.org/abs/2607.15334)
...
### [17] [Atomic Design Transformer: Scaffold-Conditioned 3D Molecule Generation via xTB-Reward Reinforcement Learning](https://arxiv.org/abs/2607.15918)
*Takao Kotani*
...
### [18] [CADAQUES: A Cost-Aware Dual Architecture for Query-Efficient Autonomous Discovery](https://arxiv.org/abs/2607.16127)
*Jorge Bravo-Abad*
...
### [19] [Field-induced first order transitions and phase coexistence in the Kitaev quantum spin liquid candidate BaCo2(AsO4)2](https://arxiv.org/abs/2607.15346)
...
### [20] [Data-efficient reconstruction of critical quantum dynamics via blind fractional-envelope extrapolation](https://arxiv.org/abs/2607.15458)
...
### [21] [Topology and compact molecular orbitals in twisted bilayer WSe$_2$](https://arxiv.org/abs/2607.15611)
...
### [22] [Machine-learning test of the single-ion model for $dd$ excitations in cuprates](https://arxiv.org/abs/2607.15763)
...
### [23] [Thermal Order by Disorder in Resonating-Valence Bond States on the Checkerboard Lattice](https://arxiv.org/abs/2607.15813)
...
### [24] [Altermagnetism without a long-range order](https://arxiv.org/abs/2607.15954)
...
### [25] [Deconfined quantum critical point in a dissipative spin-1/2 chain](https://arxiv.org/abs/2607.16039)
...
### [26] [Quantum Fisher information of magnetic quantum phase transition on Kondo lattice](https://arxiv.org/abs/2607.16150)
...
### [27] [1D Luttinger Modes in Carbon Nanotubes as keV Dark Matter Detector](https://arxiv.org/abs/2607.15338)
...
### [28] [Multiboson Signatures of Doubly Charged Scalars at a Same-Sign Muon Collider](https://arxiv.org/abs/2607.15356)
...
### [29] [Muon Bremsstrahlung as a New Probe of Dark Sector at Neutrino Experiments](https://arxiv.org/abs/2607.15368)
...
### [30] [Charge-Odd Hyperon Polarization from Magnetic Spin Precession](https://arxiv.org/abs/2607.15384)
...
### [31] [Solar-System Abundances of $p$-Nuclides Probe Collective Neutrino Oscillations in Supernovae](https://arxiv.org/abs/2607.15392)
...
### [32] [PBH formation and Gravitational Waves as Multi-messenger Signals of First-order Phase Transitions](https://arxiv.org/abs/2607.15479)
...
### [33] [JetCoRD: Reliability-Aware Cross-Experiment Distillation of Jet Taggers with Adaptive Corrective Representation](https://arxiv.org/abs/2607.15531)
...
### [34] [Enhanced Rydberg-Atom Superheterodyne Detection of Hidden-Photon Dark Matter on Chips](https://arxiv.org/abs/2607.15612)
...
### [35] [Nonequilibrium approach to heavy-quark transport](https://arxiv.org/abs/2607.15618)
*Juhee Hong*
...
### [36] [Portal Matter and Scotogenic-like Dirac Neutrino Masses](https://arxiv.org/abs/2607.15965)
*Thomas G. Rizzo*
...
### [37] [Gluon Saturation](https://arxiv.org/abs/2607.15985)
*Alfred H. Mueller*
...
### [38] [$P_{c}(4312)$, $P_{c}(4440)$, and $P_{c}(4457)$ productions in $e^{+} e^{-}$ collisions](https://arxiv.org/abs/2607.16041)
...
### [39] [Minimalist Seesaw-Scotogenic Mechanism as a Source for Neutrino Physics](https://arxiv.org/abs/2607.16049)
...
### [40] [Learning Standard Model structure from LHC data with Riemannian flow matching](https://arxiv.org/abs/2607.16144)
...
### [41] [Order-reversed Kubo formulas in relativistic kinetic theory](https://arxiv.org/abs/2607.16148)
...
### [42] [Geometric scaling in elastic $pp$ collisions](https://arxiv.org/abs/2607.16182)
*Michał Praszałowicz*
...
### [43] [First-Order Topological FFLO Transition and Superconducting Diode Sign Reversal in Altermagnetic Nanowires](https://arxiv.org/abs/2607.15720)
...
### [44] [Contactless terahertz mapping of wafer-scale superconducting NbTiN thin films](https://arxiv.org/abs/2607.15757)
...
### [45] [Drosophila of phonon-mediated superconductivity: Full Eliashberg theory of the jellium model](https://arxiv.org/abs/2607.15996)
...
### [46] [Coherent driving of displacive Higgs fluctuations in superconductors](https://arxiv.org/abs/2607.16055)
...
### [47] [Spontaneous Nanopatterning and Strain Relaxation in SiGe Layers Grown by Oxidative Solid Phase Epitaxy](https://arxiv.org/abs/2607.15332)
...
### [48] [Phase-Field Simulation of Dendrite Evolution in All-Solid-State Sodium Batteries during Cycling](https://arxiv.org/abs/2607.15387)
...
### [49] [Ab initio time-dependent GW approach for nonequilibrium exciton-phonon coupled dynamics across momentum space](https://arxiv.org/abs/2607.15411)
...
### [50] [exa-PD: A scalable high-performance workflow for multi-element phase diagram construction](https://arxiv.org/abs/2607.15476)
...
### [51] [Exploring the Potential of BY3 (Y = P, As) Monolayers as High-Capacity and Rapid-Diffusion Anodes for Sodium-Ion Batteries](https://arxiv.org/abs/2607.15514)
...
### [52] [Symbolic Predicate-Guided Language Agents for Inverse Design of Perovskite Oxides](https://arxiv.org/abs/2607.15535)
...
### [53] [Terahertz Time-Domain Spectroscopy as a Universal Defect Fingerprinting Tool for Organic Halide Perovskite Solar Cells](https://arxiv.org/abs/2607.15538)
...
### [54] [Symmetry-Enforced Dirac Fermions and Structural Metastability in Pentagonal Monolayers of Transition-Metal Ditellurides](https://arxiv.org/abs/2607.15580)
...
### [55] [General and scalable vapor etching and transformation platform for two-dimensional materials](https://arxiv.org/abs/2607.15581)
...
### [56] [Interface-Engineered Giant Multistate Resistance Switching in Altermagnetic CrSb Multiferroic Tunnel Junctions](https://arxiv.org/abs/2607.15728)
...
### [57] [Two-step growth of (In,Ga)N pseudo-substrates on GaN templates by plasma-assisted molecular beam epitaxy](https://arxiv.org/abs/2607.15748)
...
### [58] [Nonuniform pressure helps structural superlubricity](https://arxiv.org/abs/2607.15967)
...
### [59] [Structural Relaxation Enables Millisecond Infrared Photodetection in Selenium Iodine Semiconductors](https://arxiv.org/abs/2607.16054)
*Biman Jana*
...
### [60] [Emergent Interfacial Magnetism in Epitaxial RuO$_2$](https://arxiv.org/abs/2607.16093)
...
### [61] [Subgrain-resolved Analysis of Degradation in Cu Metallization via Scanning 3DXRD and Thermomechanical Modeling](https://arxiv.org/abs/2607.16108)
...
### [62] [Atomistic mechanism of corrosion-induced grain boundary migration in NiCr alloys in molten FLiNaK](https://arxiv.org/abs/2607.16167)
...
### [63] [A Dynamical Phase-Field Model for the Optical Properties of Ferroelectrics](https://arxiv.org/abs/2607.16180)
