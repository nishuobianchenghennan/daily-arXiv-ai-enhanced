...
### [7] [Collection, characterization, and precision measurement of levitated charged nanoparticles](https://arxiv.org/abs/2606.27478)
...
### [8] [Multiphoton Fingerprints of Altermagnetic Spin Splittings](https://arxiv.org/abs/2606.27548)
...
### [11] [Exceptional Points as Manifestations of Topological-Charge Breakdown in a Non-Hermitian Skyrmion](https://arxiv.org/abs/2606.27810)
*Kejun Liu*
...
### [12] [Theory of Electron Spin Resonance Scanning Tunneling Microscopy: The First Decade](https://arxiv.org/abs/2606.27830)
...
### [13] [Open Nanoacoustic Resonators Based on SrTiO$_3$/YBa$_2$Cu$_3$O$_{7-x}$ Superlattices](https://arxiv.org/abs/2606.27945)
...
### [14] [Hidden valley dynamics behind vanishing circular polarization in moiré excitons](https://arxiv.org/abs/2606.27963)
...
### [15] [Determining Electron Beam Lateral Coherence in a Scanning Electron Microscope Using Electron Diffraction](https://arxiv.org/abs/2606.28056)
...
### [16] [Population-Dominated Ergotropy in a Capacitively Coupled Double-Quantum-Dot Battery under 1/f Charge Noise](https://arxiv.org/abs/2606.28082)
...
### [17] [Role of the Casimir force in the capacitive radio-frequency microelectromechanical switches](https://arxiv.org/abs/2606.28195)
...
### [18] [Interlayer electric multipole Hall effect in twisted multilayers](https://arxiv.org/abs/2606.28205)
...
### [19] [Machine learning fully hadronic events with spectral functions](https://arxiv.org/abs/2606.27420)
...
### [20] [Collider Probes of Dark Energy Microphysics](https://arxiv.org/abs/2606.27441)
...
### [21] [The one-point charge correlator in deep inelastic scattering](https://arxiv.org/abs/2606.27454)
...
### [22] [Light and heavy meson production in small collision systems](https://arxiv.org/abs/2606.27487)
*Ivan Vitev*
...
### [23] [Nature of the newly found $Ω(2109)$](https://arxiv.org/abs/2606.27572)
...
### [24] [Radiative Corrections in Bound States: Recent Results](https://arxiv.org/abs/2606.27600)
...
### [25] [$t \bar{t}$ production as a window to invisible new physics](https://arxiv.org/abs/2606.27613)
...
### [26] [From the quark parton model to QCD](https://arxiv.org/abs/2606.27618)
*Davison E. Soper*
...
### [27] [HydroGrav: Precise hydrodynamics and gravitational waves for cosmological phase transitions](https://arxiv.org/abs/2606.27775)
...
### [28] [Bootstrapping two-loop six-gluon amplitudes in QCD](https://arxiv.org/abs/2606.27801)
...
### [29] [Leptonic CP Conservation and the Quark CP Phase from Octonionic Flavor Structure](https://arxiv.org/abs/2606.27836)
...
### [30] [Prospects for probing neutral vector-like leptons via pair production at muon collider](https://arxiv.org/abs/2606.27878)
...
### [31] [Antideuteron production from beauty-hadron decays: a first phenomenological study](https://arxiv.org/abs/2606.27910)
...
### [32] [Quantum Correlations in the Decay of $B^0$ meson and Entanglement Entropy](https://arxiv.org/abs/2606.28034)
...
### [33] [Analysis of the hidden-charm pentaquark candidates in the $J/ψΞ^*$ mass spectrum via the QCD sum rules](https://arxiv.org/abs/2606.28095)
*Zhi-Gang Wang*
...
### [34] [Dense and Cold Magnetized Quark Matter: A Review of Magnetic-Field-Independent Regularization and the Medium Separation Scheme](https://arxiv.org/abs/2606.28111)
...
### [35] [Scattering Amplitudes and Resonant Processes in QED with Chiral Chemical Potential and Chiral Magnetic Conductivity](https://arxiv.org/abs/2606.28118)
...
### [36] [Probing the neutrino chemical potential with cosmological observations](https://arxiv.org/abs/2606.28135)
...
### [37] [Pion and Kaon PDFs via Infrared-Safe Evolution augmented by $J/ψ$ Data Constraints](https://arxiv.org/abs/2606.28168)
...
### [38] [Real poles with opposite-sign residues in the non-perturbative quark propagator](https://arxiv.org/abs/2606.28212)
...
### [39] [Neural-Network extraction of TMDs with SIDIS data](https://arxiv.org/abs/2606.28218)
*Matteo Cerutti*
...
### [40] [Neutrino oscillation data and a pseudo-Dirac heavy neutral lepton](https://arxiv.org/abs/2606.28272)
*Jan Hajer*
...
### [41] [Revealing precision bounds on neutrino oscillation parameters with quantum estimation theory](https://arxiv.org/abs/2606.28275)
...
### [42] [Particle Production from Inhomogeneities: the off-shell side of gravitational waves](https://arxiv.org/abs/2606.28297)
...
### [43] [Near-threshold scattering of proton and Omega baryon and possible bound states](https://arxiv.org/abs/2606.28319)
...
### [44] [Elimination of Flux Trapping in Superconducting Circuits in Ambient Magnetic Fields](https://arxiv.org/abs/2606.27415)
...
### [45] [The Second Law, Symmetry of Time Reversal and Thermodynamic Equilibrium in Superconductors](https://arxiv.org/abs/2606.27628)
...
### [46] [Thickness dependence of diode efficiency in superconducting Fe(Se,Te)/FeTe thin-film heterostructure devices](https://arxiv.org/abs/2606.27639)
...
### [47] [Imaging geometry- and phase-controlled spectra in a surface-state Andreev cavity](https://arxiv.org/abs/2606.28189)
...
### [48] [Excitation of Collective Modes in a Chiral Superfluid by Thermal Quench](https://arxiv.org/abs/2606.28306)
...
### [49] [Ultrafast non-thermal suppression of ferroelectricity by carrier screening in LiNbO3](https://arxiv.org/abs/2606.27494)
...
### [50] [Mapping the Growth of Two-Dimensional $π$-Conjugated Polymers on Au(111): Organometallic Intermediates and Edge Terminations](https://arxiv.org/abs/2606.27512)
...
### [51] [A BRAVE Alloy Design Campaign (Bayesian Risk-aware Alloy discoVery and Exploration)](https://arxiv.org/abs/2606.27522)
...
### [52] [PtyRANNOSAUR: Ptychography with Robust Artificial Neural Networks Optimized for Sub-Angstrom Accuracy and Ultrafast Reconstruction](https://arxiv.org/abs/2606.27587)
...
### [53] [Thermal Corrections and Analysis on the Phase Stability of CsPbCl3 and Cs2AgSbCl6 during In-Situ Thermal Treatment](https://arxiv.org/abs/2606.27592)
...
### [54] [Emergence of millimeter-wave resonances in self-assembled ferroelectric metamaterials](https://arxiv.org/abs/2606.27616)
...
### [55] [Entropy engineering of BF-BT-based high-entropy ceramics for ultra-high energy storage performance](https://arxiv.org/abs/2606.27621)
...
### [56] [CoTAR: Topology and Atomic State Reconstruction in Condensed Phases](https://arxiv.org/abs/2606.27636)
...
### [57] [Circularly Polarized Magneto-Photoluminescence in Two-Dimensional Chiral Perovskites R- and S-(C4H9NH3)2PbI4 under High Magnetic Fields](https://arxiv.org/abs/2606.27673)
...
### [58] [Amorphous Fe-Sn nanofilms for anomalous-Nernst heat-flux sensing](https://arxiv.org/abs/2606.27716)
...
### [59] [Vacancy-mediated nitrogen diffusion and aggregation via high-fluence electron beam irradiation in HPHT synthesized diamond crystal](https://arxiv.org/abs/2606.27723)
...
### [60] [Single-Crystalline Al/Ge Heterostructure with an Atomically Sharp Commensurate Interface](https://arxiv.org/abs/2606.27854)
...
### [61] [Three-dimensional visualization of threading dislocation in GaN by polarized-light microscopy](https://arxiv.org/abs/2606.27744)
...
### [62] [Moiré Phonons and Emergent Exciton-Phonon Coupling in a Moiré Heterobilayer](https://arxiv.org/abs/2606.28185)
...
### [63] [Unlocking Cryogenic Energy Storage by Constructing Dipole Glass with Unit-cell-level Polar Disorder](https://arxiv.org/abs/2606.27887)
...
### [64] [Symmetry-Selective Strain Control of Spin-Momentum Locking and Spin Transport in Two-Dimensional Pentagonal Altermagnets](https://arxiv.org/abs/2606.27896)
...
### [65] [In situ synchrotron X-ray diffraction study of flash austenitization and process design insights in medium-Manganese steels for energy applications](https://arxiv.org/abs/2606.28072)
...
### [66] [Room-temperature magnon-phonon transduction in high-damping Co/Pt structures](https://arxiv.org/abs/2606.28073)
...
### [67] [Tuning the optoelectronic properties of wide bandgap perovskites: Data-driven insights from combinatorial synthesis and high-throughput experimentation](https://arxiv.org/abs/2606.28093)
...
### [68] [Uniaxial compression of crystalline HCP titanium: an atomistic modelling study of size effects](https://arxiv.org/abs/2606.28155)
...
### [69] [Mosaic: A Benchmark Suite for Differentiable Physics Solvers](https://arxiv.org/abs/2606.27895)
