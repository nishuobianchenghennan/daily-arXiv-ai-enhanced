...
### [12] [Effects of compocasting process parameters on microstructural characteristics and tensile properties of A356-SiCp composites](https://arxiv.org/abs/2605.22881)
...
### [13] [Genome-Guided Interpretable Screening of Phase-Stable, Lead-Free Double Perovskite Absorbers for All-Inorganic Semiconductors, Sensors, and Photovoltaics with DFT-Validated Design Rules](https://arxiv.org/abs/2605.22887)
...
### [15] [Thickness-Dependent Spintronic Terahertz Emission in MBE-Grown PtTe$_2$: From Semiconductor to Type-II Dirac Semimetal](https://arxiv.org/abs/2605.22932)
...
### [16] [A new method to probe conducting filaments in MoS$_2$-based memristors](https://arxiv.org/abs/2605.22943)
...
### [17] [Pulsed thermal annealing enables switching of chiral antiferromagnetic order with a sub-millitesla field in Mn$_3$Sn](https://arxiv.org/abs/2605.23205)
...
### [18] [Non-adiabatic phonon renormalization in metallic versus insulating rutile oxides](https://arxiv.org/abs/2605.23227)
...
### [19] [Thermodynamic stability of twisted domains in AgCrSe$_{2}$ thin films grown on lattice-matched YSZ(111) substrate](https://arxiv.org/abs/2605.23313)
...
### [22] [Cathodoluminescence Analysis of Defects and Grain Boundaries in Zn3P2 Thin Films Grown on Graphene by MOVPE and MBE](https://arxiv.org/abs/2605.23357)
...
### [30] [Evidence of a Hybridized Topological State in Weyl Semimetal/Topological Insulator Mn$_{3+x}$Sn$_{1-x}$/Bi$_{0.85}$Sb$_{0.15}$ Heterostructures](https://arxiv.org/abs/2605.23765)
...
### [33] [Scale-Invariant Open Quantum Systems](https://arxiv.org/abs/2605.22919)
...
### [34] [Sterile Neutrino Mixing Parameters from Solar-Neutrino Coherent Scattering](https://arxiv.org/abs/2605.22935)
...
### [35] [Finite-Size Effects on the Critical End Point of Magnetized Quark Matter in the Nonlocal PNJL Model](https://arxiv.org/abs/2605.23021)
...
### [36] [Quark orbital angular momentum as a chiral magnetic effect](https://arxiv.org/abs/2605.23125)
...
### [37] [Zee models with a non-invertible $Z_M$ symmetry](https://arxiv.org/abs/2605.23202)
...
### [38] [Yukawa-Screened Bose-Star Condensation](https://arxiv.org/abs/2605.23206)
*Jiajun Chen*
...
### [39] [Enhanced Stellar Production of Weakly Interacting Slim Particles from Non-Thermal Nuclear Cascades](https://arxiv.org/abs/2605.23317)
...
### [40] [Addressing Standard Model Tensions via X17 Vector Boson](https://arxiv.org/abs/2605.23359)
...
### [41] [Infrared behavior of the photon yield in nonlinear Compton scattering](https://arxiv.org/abs/2605.23674)
...
### [42] [Semileptonic decay of $Λ_b^0 \to Λ_c (2860)^+/Λ_c(2625)^+\ell^-\overlineν_\ell$ within QCD light-cone sum rules](https://arxiv.org/abs/2605.23716)
...
### [43] [Correlated $b \to s$ and $s \to d$ Rare Semileptonic Transitions in the Standard Model Effective Field Theory](https://arxiv.org/abs/2605.23759)
...
### [44] [Charged long-lived particles in the GMSB scenario at the Future Circular Collider (FCC-ee)](https://arxiv.org/abs/2605.23793)
...
### [45] [A Stochastic Approach for Determining the Quark Confinement Potential of Charmonia](https://arxiv.org/abs/2605.23896)
...
### [46] [Full-Scattering-Matrix Deterministic Phonon Boltzmann Transport Simulation](https://arxiv.org/abs/2605.23005)
*Y. Sungtaek Ju*
...
### [47] [Kondo singlet from ferromagnetic coupling: an analog of Anderson-Morel superconductivity in the magnetic channel](https://arxiv.org/abs/2605.23755)
...
### [48] [Fractionalization, emergent SU($N$) symmetries, and fragmentation in layered quantum spin-orbital models](https://arxiv.org/abs/2605.22908)
...
### [49] [Tuning J$_1$-J$_2$ in Quasi-2D Triangular Lattice Antiferromagnet $α$-SrCr$_2$O$_4$ via Uniaxial Pressure](https://arxiv.org/abs/2605.23133)
...
### [50] [Field evolution of the magnetic structure and spin Hamiltonian in Cs$_2$RuO$_4$](https://arxiv.org/abs/2605.23363)
...
### [51] [Interaction-Split Edge Spectral Flow and Neutral Triplet Boundary Modes in a C = 2 Hubbard Pump](https://arxiv.org/abs/2605.23769)
...
### [52] [Phase diagram of the vortex state in an amorphous Re6Zr thin film exhibiting inverse melting](https://arxiv.org/abs/2605.23567)
...
### [53] [Disorder-Induced Phase Transitions in Altermagnetic Josephson Junctions](https://arxiv.org/abs/2605.23607)
*Chang-An Li*
...
### [54] [Quantum critical collapse of a pinned vortex glass](https://arxiv.org/abs/2605.23838)
