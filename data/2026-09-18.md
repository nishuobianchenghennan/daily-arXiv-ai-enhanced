...
### [10] [Vortex-mediated spin current injection into two-dimensional superconductor NbSe2](https://arxiv.org/abs/2609.19727)
...
### [11] [Generic thermodynamics of condensates with extremely small superfluid density ---Application to UTe$_2$ and hidden second phase transition---](https://arxiv.org/abs/2609.19834)
*Kazushige Machida*
...
### [12] [Type-I superconductivity in a quasi-2D topologically nontrivial YbBi$_2$](https://arxiv.org/abs/2609.20093)
...
### [13] [Superconductivity in Pb2-xBixPd Single Crystals](https://arxiv.org/abs/2609.20364)
...
### [16] [The Roadmap of Inorganic Computational Materials Databases: Capabilities, Credibility, Coverage, and the Open Frontier](https://arxiv.org/abs/2609.19833)
...
### [17] [Anharmonic Phonon Renormalization and Defect Tolerance of the Thermoelectric Power Factor in Monolayer SnSe](https://arxiv.org/abs/2609.20019)
...
### [18] [Transport Relaxation Mechanisms in Bilayer Graphene: Effects of Pauli Blocking](https://arxiv.org/abs/2609.19643)
...
### [19] [Observation of Dyakonov-Perel-type magnon spin relaxation in uniaxial antiferromagnetic insulators](https://arxiv.org/abs/2609.19700)
...
### [20] [Highly uniform first-electron position in qubit arrays fabricated on dedicated QSOI(R) 300mm commercial platform](https://arxiv.org/abs/2609.20043)
...
### [21] [Plasmons in twisted bilayer graphene across dispersive and flat bands](https://arxiv.org/abs/2609.20158)
...
### [22] [Predictive Structure to Thermal Conductivity Modeling Framework for BEOL Interconnect Stacks in Advanced Technology Nodes Enabled by Extensive Layer Resolved Thermal Measurements](https://arxiv.org/abs/2609.20379)
...
### [23] [Coplanar Lateral Gating MoS2 on SrTiO3: A Unified Platform for Classical and Quantum Devices](https://arxiv.org/abs/2609.20426)
...
### [24] [Disorder-induced modulation of the nonlinear Hall effect in Weyl semimetals](https://arxiv.org/abs/2609.20471)
...
### [25] [Coherent and ultra-low-power EDSR with a flopping-mode spin qubit in germanium](https://arxiv.org/abs/2609.20775)
...
### [27] [Valley-Helical Superconductivity Driven by Repulsion and Quantum Geometry: Applications to Time-Reversal Symmetric Rhombohedral Graphene](https://arxiv.org/abs/2609.19283)
...
### [28] [Energy partitioning of wave packets in one-dimensional systems](https://arxiv.org/abs/2609.19450)
...
### [29] [Universality of the $1/9$ Magnetization Plateau and Quantum-Disordered States in the Kagome Family $\mathrm{Cs_8AB_3Ti_{12}F_{48}}$ ($A=\mathrm{Rb},\mathrm{Li}$; $B=\mathrm{K},\mathrm{Na}$)](https://arxiv.org/abs/2609.19572)
...
### [30] [Vestigial chirality from fluctuating loop currents on the kagome lattice](https://arxiv.org/abs/2609.19618)
...
### [31] [Fractional quantum spin Hall crystals from hidden density-wave order](https://arxiv.org/abs/2609.19638)
...
### [32] [Pressure induced structural phase transition and magneto-elastic coupling in Eu doped LaCrO$_3$](https://arxiv.org/abs/2609.19795)
...
### [33] [Tunable flat band on the surface of a rhombohedral kagome ferromagnet](https://arxiv.org/abs/2609.19857)
...
### [34] [Corner entanglement scaling with projected entangled pair states](https://arxiv.org/abs/2609.20020)
...
### [35] [When Is Kramers-Wannier Duality Invertible?](https://arxiv.org/abs/2609.20090)
...
### [36] [Pressure-induced electronic and structural evolution of EuIrGe3](https://arxiv.org/abs/2609.20376)
...
### [37] [Emergent Surface Kondo Flat Band Driven by Competing Interactions in a Topological Ferromagnet](https://arxiv.org/abs/2609.20432)
...
### [38] [Non-Thermal Effects in Fermionic Atoms Coupled to Open Cavities](https://arxiv.org/abs/2609.20434)
...
### [39] [Collective Charge-\(2e\) Bosonic Excitations in Charge-Ordered Systems](https://arxiv.org/abs/2609.20472)
*Ping Tang*
...
### [40] [Unconstrained compact lattice QED$_{2+1}$ coupled to phonons: Gauss sectors, orthogonal semimetal, and deconfined criticality](https://arxiv.org/abs/2609.20502)
...
### [41] [Multiconfigurational Analysis of Local Electronic Structure of $\mathrm{RuO_2}$ Using Relativistic Embedded Clusters](https://arxiv.org/abs/2609.20526)
...
### [42] [Lyapunov-controlled thermalization: an exact real-time example](https://arxiv.org/abs/2609.20597)
...
### [43] [Engineering Weak Universality with Quantum Dots](https://arxiv.org/abs/2609.20755)
...
### [44] [Spacetime Dynamics of Altermagnetic Magnons](https://arxiv.org/abs/2609.20767)
...
### [45] [Statistics, 't Hooft Anomaly, and the Else-Nayak Index: a careful comparison of concepts](https://arxiv.org/abs/2609.20813)
*Hanyu Xue*
...
### [46] [Hidden charm pentaquarks and the nature of $P_{c}$ states observed at LHCb](https://arxiv.org/abs/2609.19749)
...
### [47] [FLARE: an open-source data workflow orchestration tool](https://arxiv.org/abs/2609.19809)
...
### [48] [Measure of the kaon structure: generalized valence quark distribution functions and form factors](https://arxiv.org/abs/2609.19861)
...
### [49] [Colour sextet baryons in composite Higgs models](https://arxiv.org/abs/2609.19918)
*Manuel Kunkel*
...
### [50] [New massive resonances at the LHC](https://arxiv.org/abs/2609.19919)
*Rosy Caliri*
...
### [51] [Study of the $e^+e^- \to φK^+K^-$ reaction within triangle dynamics and its implications for the $φ(2170)$](https://arxiv.org/abs/2609.19951)
...
### [52] [Paired charmonium and bottomonium production in rare exclusive decays of Z boson](https://arxiv.org/abs/2609.19952)
...
### [53] [On the Maximal CP Violation in Leptogenesis with Two Right Handed Neutrinos](https://arxiv.org/abs/2609.20033)
*Swapnil Dutta*
...
### [54] [Stasis Combs: Gravitational-Wave Signatures of Recurrent Cosmological Stasis](https://arxiv.org/abs/2609.20280)
...
### [55] [Comparing theoretical descriptions of Drell-Yan angular coefficients](https://arxiv.org/abs/2609.20362)
...
### [56] [Investigation of low-lying $Ω_b(1P)$ states in an unquenched coupled-channel framework](https://arxiv.org/abs/2609.20392)
...
### [57] [Particle Physics Driven by Quantum Technology - Quantum Simulations and Quantum Sensing](https://arxiv.org/abs/2609.20500)
...
### [58] [A quantum representation of $π$ fragmentation functions through variational quantum circuits](https://arxiv.org/abs/2609.20557)
...
### [59] [Line shapes of $Ω(2012)$ production in the $Ξ\bar K $ and $Ξπ\bar K$ decay channels](https://arxiv.org/abs/2609.20654)
...
### [60] [Adiabatic hydrodynamization with transverse spatial gradients in boost-invariant plasmas](https://arxiv.org/abs/2609.20705)
...
### [61] [An invertible map between 3D Breit-frame mechanical distributions and 2D infinite-momentum-frame mechanical densities in spin-1 hadrons](https://arxiv.org/abs/2609.20714)
*Kemal Tezgin*
...
### [62] [Electromagnetic form factors of vector mesons in Einstein-dilaton holographic QCD](https://arxiv.org/abs/2609.20736)
...
### [63] [The axion mass in the post-inflationary scenario in a minimal scaling model](https://arxiv.org/abs/2609.20801)
