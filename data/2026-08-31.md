...
### [3] [Charge transfer and competing symmetry breaking drive orbital reconstruction and emergent ferromagnetism in insulating oxide superlattices](https://arxiv.org/abs/2608.28107)
...
### [4] [Compiling Chemical Knowledge into Executable Descriptors for Materials Prediction](https://arxiv.org/abs/2608.27587)
...
### [5] [Interplay between crystal structure and magnetism in CeCrB$_4$](https://arxiv.org/abs/2608.28238)
...
### [8] [Layer-Controlled Intermolecular Coupling and Many-Body Effects in C$_{60}$ Films](https://arxiv.org/abs/2608.28583)
...
### [33] [Collinear altermagnetism for 3D chiral higher-order topological insulators](https://arxiv.org/abs/2608.27552)
...
### [34] [Topological signatures in the quench dynamics of periodically driven quantum systems](https://arxiv.org/abs/2608.27588)
...
### [35] [Turning Zeeman splitting into switchable charge polarization in a double quantum dot](https://arxiv.org/abs/2608.27625)
...
### [36] [Subcritical bifurcation and on-off bistability in ballistic polariton condensates](https://arxiv.org/abs/2608.27823)
...
### [37] [Evidence for Three-component Interlayer Coherent Exciton Condensation](https://arxiv.org/abs/2608.28338)
...
### [38] [Quantum geometric bounds at finite temperature for one-dimensional chiral systems](https://arxiv.org/abs/2608.27944)
...
### [39] [Multi-dimensional spectroscopy of mobile excitons in two-dimensional semiconductors](https://arxiv.org/abs/2608.27951)
...
### [40] [Significant modulation of acoustoelectric current associated with charge density wave transitions](https://arxiv.org/abs/2608.27959)
...
### [41] [Topological signatures in the curvature-induced energy response](https://arxiv.org/abs/2608.28146)
...
### [42] [Quantum Geometric Origin of Nonlinear Current Induced Orbital Magnetization](https://arxiv.org/abs/2608.28231)
...
### [43] [Rapid Charge Stability Diagram Generation from Device-level Modeling of Semiconductor Quantum Dots](https://arxiv.org/abs/2608.28263)
...
### [44] [Crystal-phase quantum dots in AlGaAs nanowires](https://arxiv.org/abs/2608.28353)
...
### [45] [Electrically Tunable Two-Component Exciton Condensate in a Coulomb-Coupled Graphene Trilayer](https://arxiv.org/abs/2608.28381)
...
### [46] [Quantum transport and unified scaling law in graphene with polyadic Cantor electrostatic barriers](https://arxiv.org/abs/2608.28398)
...
### [47] [ScatterWorks: A Python package for building and solving scattering network models](https://arxiv.org/abs/2608.28479)
...
### [48] [Super-resolution Control of Two-dimensional Quantum Emitters](https://arxiv.org/abs/2608.28574)
...
### [49] [Detecting Axion-Like Particles With Coiled Optical Fibers I: Silica Fibers](https://arxiv.org/abs/2608.27551)
...
### [50] [Imperfect axions with no domain wall problem](https://arxiv.org/abs/2608.27553)
...
### [51] [KOFFEE: Kaon Observables at Future Fermilab Experimental Extensions](https://arxiv.org/abs/2608.27558)
...
### [52] [Next-to-Leading-Order Electroweak Corrections to Quantum Observables in Lepton-Lepton Collisions](https://arxiv.org/abs/2608.27559)
...
### [53] [A doubly critical point in the color-superconducting regime of the RG-consistent NJL model](https://arxiv.org/abs/2608.27677)
...
### [54] [Constraining Light and Strange Flavor Equilibration in Relativistic Heavy-Ion Collisions](https://arxiv.org/abs/2608.27687)
*Andrew Gordeev*
...
### [55] [Future of Artificial Intelligence for Science in Japan 2024 Community Report](https://arxiv.org/abs/2608.27807)
...
### [56] [Vector-boson-fusion timing references for four-dimensional displaced-vertex searches](https://arxiv.org/abs/2608.27868)
*Renjie Wang*
...
### [57] [Deep-neural-network extraction of unpolarized transverse-momentum-dependent parton distributions in $b_T$ space from Drell-Yan data](https://arxiv.org/abs/2608.27907)
...
### [58] [Celestial probes of dark matter electromagnetic interactions](https://arxiv.org/abs/2608.27957)
...
### [59] [Magnetic Moments and Radiative Transitions of the $T_{cc}(3875)^+$ and its partner states](https://arxiv.org/abs/2608.27961)
...
### [60] [Quantum computation of partonic Drell-Yan scattering cross sections and interference effects](https://arxiv.org/abs/2608.28057)
...
### [61] [Expansion attractor in classical Yang-Mills theory](https://arxiv.org/abs/2608.28106)
*Clemens Werthmann*
...
### [62] [Fixed points of the CKM matrix renormalization group running to all orders in perturbation theory](https://arxiv.org/abs/2608.28149)
*Brian P Dolan*
...
### [63] [Three-loop QCD corrections to heavy-to-light form factors and applications to inclusive $B$ decays](https://arxiv.org/abs/2608.28172)
...
### [64] [System-size dependence of strangeness production from p+p to Pb+Pb: quantitative tests of the $K^+/π^+$ horn](https://arxiv.org/abs/2608.28189)
*Neeraj,Amal Sarkar*
...
### [65] [Minimal-Length Deformations of Chiral Quark Matter in a 2+1-Flavor NJL Model](https://arxiv.org/abs/2608.28201)
*Sameer Ahmad Mir*
...
### [66] [HEPToolBench 1.2: Testing How Reliably Language Models Can Drive Particle Physics Software](https://arxiv.org/abs/2608.28232)
...
### [67] [HEPLocalAgent 1.0: Running Collider Simulations from Plain-Language Requests on Your Own Computer](https://arxiv.org/abs/2608.28244)
*Aadarsh Singh,Sudhir K. Vempati*
...
### [68] [Color screening versus thermal decay as the mechanism of $Υ$ suppression in high energy nuclear collisions](https://arxiv.org/abs/2608.28277)
...
### [69] [Investigation of S-wave tetraquark bound and resonant states with all Jacobi coordinates](https://arxiv.org/abs/2608.28284)
...
### [70] [Searching for vectorlike $T$ quarks in the $T\to tZ$ channel at a future muon-proton collider](https://arxiv.org/abs/2608.28285)
...
### [71] [Effect of Thermal Broadening on Light Hadron Production in Heavy-Ion Collisions](https://arxiv.org/abs/2608.28456)
...
### [72] [Impact of NLO EW and QCD corrections to dimension-6 SMEFT coefficients constraints in Higgs decays](https://arxiv.org/abs/2608.28464)
...
### [73] [Deciphering Matter Invariants via Renormalization Group Equations for Neutrino Oscillations](https://arxiv.org/abs/2608.28540)
*Xin Wang,Shun Zhou*
...
### [74] [The Pomeron loop as a perturbative correction to single Pomeron exchange revisited](https://arxiv.org/abs/2608.28544)
...
### [75] [Vectorized Symmetric and Fermionic Tensor Network Implementations for GPU-Accelerated Variational Monte Carlo](https://arxiv.org/abs/2608.27861)
...
### [76] [Higher-Order Topological Phase in the Two-Dimensional Type-IV Magnet MgCr$_2$O$_4$](https://arxiv.org/abs/2608.27918)
...
### [77] [Accelerated S-NFC for Million-Chaff RCS Computation Using Low-Rank Compression of Concatenated Block Rows](https://arxiv.org/abs/2608.27936)
...
### [78] [A Synthetic Iterative Scheme for Non-Gray Phonon Boltzmann Transport Equation with Dual Relaxation Times](https://arxiv.org/abs/2608.28101)
...
### [79] [Editorial: Promoting Green Computing in High Energy Physics and Astrophysics](https://arxiv.org/abs/2608.28193)
...
### [80] [Real-Time Monitoring of MHD Liquid Metal Flows with Shallow Recurrent Decoders](https://arxiv.org/abs/2608.28366)
...
### [81] [Modelling platelet dynamics in blood flow: an unresolved DEM approach](https://arxiv.org/abs/2608.28483)
...
### [82] [Two-dimensional quantum Griffith singularity in three-dimensional ZrN$_x$ superconducting films](https://arxiv.org/abs/2608.28166)
...
### [83] [Gauge invariance, collective modes, and the justification of normal-state subtraction in Dirac superconductors](https://arxiv.org/abs/2608.28485)
*Hiroshi Hayasaka*
...
### [84] [A Three-Fluid Model of Dissipation at Surfaces in Superconducting Radiofrequency Cavities](https://arxiv.org/abs/2608.28565)
