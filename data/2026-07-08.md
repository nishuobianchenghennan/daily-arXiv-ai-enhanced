...
### [2] [Constant Scaling Fails for Global Monopole Networks](https://arxiv.org/abs/2607.05517)
...
### [3] [Precision Study of Semileptonic and Non-Leptonic $B_c$ Decays to $η_c$ and P Wave Charmonia](https://arxiv.org/abs/2607.05527)
...
### [4] [Linear Breit-Wheeler pair production in the search for axion-like particles](https://arxiv.org/abs/2607.05572)
...
### [5] [Can blind spots save neutralino dark matter in natural supersymmetry models?](https://arxiv.org/abs/2607.05648)
...
### [6] [Compactness, mass spectra, and strong stability of singly heavy tetraquarks](https://arxiv.org/abs/2607.05793)
...
### [7] [Separating energy scales in hadron scattering](https://arxiv.org/abs/2607.05990)
...
### [8] [Anisotropic electron scattering and Migdal effect in semiconductor detectors](https://arxiv.org/abs/2607.06005)
...
### [9] [Radiative decays of $X(3872)$ within $D{\bar D}^*$ molecular framework](https://arxiv.org/abs/2607.06046)
...
### [10] [A resonance-aware MC@NLO QCD+EW-matched calculation of lepton-pair production](https://arxiv.org/abs/2607.06059)
...
### [11] [A Quantitative Framework of Nonperturbative QCD from Topological Vacuum with Application to Parton Structures](https://arxiv.org/abs/2607.06060)
*Wei-Yang Liu*
...
### [12] [ggxy: Fast and flexible NLO QCD corrections to gluon-initiated processes](https://arxiv.org/abs/2607.06099)
*Daniel Stremmer*
...
### [13] [Radiative Breaking of Two-Zero Neutrino Mass Minors: Revisiting the $\mathrm{U}(1)_{L_μ-L_τ}$ Model](https://arxiv.org/abs/2607.06102)
...
### [14] [Non-Unitarity Effects and Fake CP Violation in Neutrino Oscillation Experiments](https://arxiv.org/abs/2607.06108)
...
### [15] [Quantum decoherence: a study applied to quarkonium-like bound states in strongly interacting matter](https://arxiv.org/abs/2607.06137)
...
### [16] [Vector-Meson Spin Alignment from Anisotropic Quark or Hadron Coalescence](https://arxiv.org/abs/2607.06138)
...
### [17] [Understanding the near-threshold structures in $e^+e^- $ annihilation from a unified $N \bar N$-interaction perspective](https://arxiv.org/abs/2607.06168)
...
### [18] [Polyakov Loops Tame Phase Transitions](https://arxiv.org/abs/2607.06203)
...
### [19] [Flux-integrated inclusive and pionless cross sections for charged-current neutrino scattering off ${}^{40}\text{Ar}$ at energies available in the MicroBooNE experiment](https://arxiv.org/abs/2607.06241)
...
### [20] [Role of the $Σ(1430)(1/2^-)$ in the $J/ψ\to Λ\barΛ π^0$ reaction](https://arxiv.org/abs/2607.06255)
...
### [21] [$KX(3872)$ interaction and correlation function](https://arxiv.org/abs/2607.06317)
...
### [22] [Dispersive estimation of the LO hadronic contribution to the muon ${g-2}$: fitting incompatible ${e^+e^-}$ data](https://arxiv.org/abs/2607.06352)
...
### [23] [Interplay of CPT-Violating and CPT-Conserving Lorentz Invariance Violation at DUNE](https://arxiv.org/abs/2607.06513)
...
### [24] [Predictions for $b$-baryon lifetimes at NNLO-QCD](https://arxiv.org/abs/2607.06538)
...
### [25] [Non Hermitian Tight Binding Bands in Graphene from Tan Bo Model: Strain Effects and Bernal Bilayer Extensions](https://arxiv.org/abs/2607.05470)
...
### [26] [Raman spectroscopy of the van der Waals altermagnet Co$_{1/4}$NbSe$_2$](https://arxiv.org/abs/2607.05616)
...
### [27] [Domain-Growth Kinetics and Scaling Laws Governing Pulse-Driven Accumulative Polarization Switching in HZO](https://arxiv.org/abs/2607.05617)
*Manish Anand*
...
### [28] [Electric Field Induced Multi-Space Topological Phase Transitions in Janus Monolayer MnBi2Se2Te2](https://arxiv.org/abs/2607.05631)
...
### [29] [Ultrahigh-Entropy Compositionally Complex Ceramics: Fluorite-Pyrochlore Phase Stability and Order-Disorder Transitions](https://arxiv.org/abs/2607.05675)
*Keqi Song,Jian Luo*
...
### [30] [From Closed-Loop Optimization to Open Decision Making: Coupled Digital Twins for Predictive and Autonomous Microscopy](https://arxiv.org/abs/2607.05758)
...
### [31] [Efficient Bethe-Salpeter Equation Calculations Based on Numerical Atomic Orbitals and Norm-Conserving Pseudopotentials: Dual-${\boldsymbol k}$-Mesh Strategy](https://arxiv.org/abs/2607.05853)
...
### [32] [Anomalous Piezoelectricity from Polarization-Dependent Electrostriction in Wurtzites](https://arxiv.org/abs/2607.05854)
...
### [33] [Orientation-resolved ultrafast spin reorientation dynamics in ferrimagnetic DyCo$_5$](https://arxiv.org/abs/2607.05946)
...
### [39] [Inverse heterodyne effect in bimodal Kelvin probe force microscopy](https://arxiv.org/abs/2607.06135)
...
### [40] [On the capacitance gradient description in Heterodyne Kelvin Probe Force Microscopy](https://arxiv.org/abs/2607.06161)
*Hugo Valloire,Sylvain Clair,Christian Loppacher,Laurent Nony,Benjamin Grévin*
...
### [41] [Piezoaxial coupling for strain-selected ferroaxial domain control](https://arxiv.org/abs/2607.06209)
...
### [42] [Phonon-Mediated Thermal Transport in Nanocrystalline Silicon Using Machine-Learning Interatomic Potentials](https://arxiv.org/abs/2607.06470)
...
### [43] [Magnetotransport of tomographic electrons in a Corbino disk](https://arxiv.org/abs/2607.05540)
...
### [44] [Effect of pressure on the magnetic properties of (Co$_{0.5}$Fe$_{0.5}$)$_5$GeTe$_2$](https://arxiv.org/abs/2607.05548)
...
### [45] [Equivalence between the Axion Invariant and the $S_4$ Symmetry Indicator](https://arxiv.org/abs/2607.05719)
*Mengyao Zhang*
...
### [46] [Engineering nonlinear magnon scattering in artificial spin ice via vertex dipolar control](https://arxiv.org/abs/2607.05797)
...
### [47] [Floquet polaritons in optically driven materials](https://arxiv.org/abs/2607.05857)
...
### [48] [Machine learning prediction of the convergence criterion for a topological invariant of finite non-Hermitian chains](https://arxiv.org/abs/2607.05900)
...
### [49] [Interfacial Noncollinear Filtering of Spin Hall Currents](https://arxiv.org/abs/2607.05912)
...
### [50] [From Valley Filtering to Superconducting Diode Effect in Spin-Orbit Coupled Graphene Junctions](https://arxiv.org/abs/2607.06303)
...
### [51] [Layer-selective chirality switch in bilayer graphene intercalated by Janus monolayers](https://arxiv.org/abs/2607.06159)
*Marko Milivojević*
...
### [52] [Uncertainty relations for arbitrary currents in coherent transport](https://arxiv.org/abs/2607.06190)
...
### [53] [Classical Reversible Computation by Quantum Coherence](https://arxiv.org/abs/2607.06219)
*Daniel Loss*
...
### [54] [Local spin magnetization in itinerant non-collinear magnets: The local spin Berry curvature](https://arxiv.org/abs/2607.06253)
...
### [55] [Composite-Fermion Study of Cavity-Modified Fractional Quantum Hall Excitation Gaps](https://arxiv.org/abs/2607.06298)
...
### [56] [Half state at $ν_{tot}$ = -1/2 and its transition in Decoupled Twisted Double Bilayer Graphene](https://arxiv.org/abs/2607.06547)
...
### [57] [Radio frequency readout and control of Ge/SiGe hole spin qubits with a global accumulation gate](https://arxiv.org/abs/2607.06342)
...
### [58] [2D Transport in an in-plane magnetic field](https://arxiv.org/abs/2607.06561)
...
### [59] [Correlated Insulating States in Twisted Double Bilayer Graphene Enhanced by Interfacial Effect on CrOCl](https://arxiv.org/abs/2607.06492)
...
### [60] [Magnon-Mediated Superconductivity in a 2D Itinerant Ferromagnet with Weak Easy-plane Magnetic Anisotropy](https://arxiv.org/abs/2607.05754)
...
### [61] [Chiral-Structured Superconductors TrX4 (Tr = Rh, Ir; X = Ge, Si): A Platform for Mixed-Parity Pairing and Topological States](https://arxiv.org/abs/2607.05881)
...
### [62] [Microscopic theory of the lower critical field in superconducting thin-film strips](https://arxiv.org/abs/2607.05890)
*Takayuki Kubo*
...
### [63] [Decoupling Josephson Coupling and Supercurrent Nonreciprocity in Twisted NbSe2/NbSe2 van der Waals Junctions](https://arxiv.org/abs/2607.06304)
...
### [64] [Anomalously high quasiparticle thermal conductivity in the underdoped cuprate superconductor HgBa$_{2}$CuO$_{4+δ}$](https://arxiv.org/abs/2607.06332)
...
### [65] [Effect of charge-imbalance potential relaxation on the high-frequency vortex dynamics and kinetic inductance of superconducting circuits](https://arxiv.org/abs/2607.06390)
...
### [66] [Multi-Knob Switchable Chiral Superconductivity Quartet in Rhombohedral Graphene](https://arxiv.org/abs/2607.06520)
...
### [67] [Mass-Conserving Physics-Informed Neural Networks For The One-Dimensional Advection-Diffusion Equation](https://arxiv.org/abs/2607.06091)
...
### [68] [Gradient-Based Inverse Design of Free-Energy Landscapes with Diffusion Models](https://arxiv.org/abs/2607.06421)
...
### [69] [Three-point density correlations in a weakly interacting 2D Fermi liquid](https://arxiv.org/abs/2607.05747)
*C. L. Kane*
...
### [70] [Local moment magnon spectrum in conduction electron tunnelling](https://arxiv.org/abs/2607.05858)
...
### [71] [CE-antiferromagnetic electronic structure in LaSr$_2$Mn$_2$O$_7$ revealed by micro-focused angle-resolved photoemission spectroscopy and tight-binding models](https://arxiv.org/abs/2607.05949)
...
### [72] [Bose Einstein Condensation of Magnons in BaCuSi$_{2}$O$_{6}$: An experimental perspective](https://arxiv.org/abs/2607.06028)
...
### [73] [Weak-coupling altermagnetism and chiral magnetic excitations in a checkerboard lattice](https://arxiv.org/abs/2607.06106)
...
### [74] [Bockstein Braiding Statistics Versus Three-Loop Braiding](https://arxiv.org/abs/2607.06279)
*Hanyu Xue*
...
### [75] [Skyrmion Phase Control by Magnetic Dipole-Dipole Interaction and Electric Field in Centrosymmetric Materials](https://arxiv.org/abs/2607.06419)
...
### [76] [Instabilities of Fermi Liquids with Arbitrary Forward Scattering: Exact Approach](https://arxiv.org/abs/2607.06430)
...
### [77] [Correlation of maximum superconducting critical temperature with copper-oxygen energy distance and oxygen hole content in the Emery model](https://arxiv.org/abs/2607.06460)
...
### [78] [Charge-transfer gap size and oxygen hole content as two mechanisms controlling $T_c$ in the Emery model](https://arxiv.org/abs/2607.06462)
*Eleanor M. O'Callaghan,Nicolas Kowalski,A. -M. S. Tremblay,Giovanni Sordi*
...
### [79] [Eclipsing Kitaev: off-diagonal exchange governs the correlated high-field phases of $β$-Li$_2$IrO$_3$](https://arxiv.org/abs/2607.06463)
...
### [80] [Arbitrage-Free Multi-Maturity Risk-Neutral Marginals](https://arxiv.org/abs/2607.06204)
...
### [81] [Signature-based identification of volatility models from path geometry](https://arxiv.org/abs/2607.06340)
