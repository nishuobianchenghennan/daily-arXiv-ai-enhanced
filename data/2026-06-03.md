...
### [5] [Second-Order Synaptic Memory using Inherent Plasticity of Moiré Superlattices](https://arxiv.org/abs/2606.02931)
...
### [6] [Epitaxial $\mathrm{Co_2MnSi}$ with intrinsic magnetocrystalline anisotropy as a route to bias-field-free nonlinear half-metal magnonics at the nanoscale](https://arxiv.org/abs/2606.03431)
...
### [7] [Mechanochemical Nano-Writing of an Atomically Thin Metal](https://arxiv.org/abs/2606.03710)
...
### [8] [TransportBench: A Comprehensive Benchmark for Non-Equilibrium Flow Transport](https://arxiv.org/abs/2606.02997)
...
### [9] [On the Detection of Curl-Free Gauge Fields](https://arxiv.org/abs/2606.02622)
...
### [10] [Early Experiments on Macroscopic Quantum Tunneling](https://arxiv.org/abs/2606.02770)
*Willem den Boer*
...
### [11] [Bipolar-doped superconducting infinite-layer cuprates](https://arxiv.org/abs/2606.03981)
...
### [12] [Anharmonic lattice dynamics and superconductivity in strained bulk and surface niobium](https://arxiv.org/abs/2606.02730)
...
### [16] [Unconventional crystallization pathway bypassing the intermediate cubic phase in phase-change superlattices](https://arxiv.org/abs/2606.03309)
...
### [17] [Quantum annealing for materials](https://arxiv.org/abs/2606.03405)
...
### [18] [Microscopic derivation of the microstretch theory for carbon nanotubes](https://arxiv.org/abs/2606.03452)
...
### [19] [Reversible Superdense Ordering of Tetragonal Lithium in a Layered Material](https://arxiv.org/abs/2606.03563)
...
### [20] [Topological Weyl Phase of an Ideal Spin-Gapless Semiconductor KCrSe](https://arxiv.org/abs/2606.03959)
...
### [21] [Molecular neutron spectroscopy techniques applied to ceramics $α$-SiC and $β$-Ga$_2$O$_3$](https://arxiv.org/abs/2606.03586)
...
### [22] [Demonstrating magnetic memory in iron-rhodium structures using a quantum diamond microscope](https://arxiv.org/abs/2606.03738)
...
### [23] [RamanGPT: Bidirectional Mapping Between Crystal Structures and Raman Spectra with Graph Neural Networks and Generative Transformers](https://arxiv.org/abs/2606.03764)
...
### [24] [Quantitative Detection of Molecular Oxygen in the Gas Phase with Fluorescent Nanodiamonds](https://arxiv.org/abs/2606.03844)
...
### [25] [Predicting core-level X-ray photoemission spectra of oxide surfaces from first principles -- a case study for SnO$_2$](https://arxiv.org/abs/2606.03853)
...
### [26] [Data-driven mapping of borophene growth pathways](https://arxiv.org/abs/2606.03886)
...
### [27] [Bernoulli principle in ferroelectrics](https://arxiv.org/abs/2606.03900)
...
### [28] [Is Parity Violation a Dynamical Effect?](https://arxiv.org/abs/2606.02652)
...
### [29] [Thermal Metastable Strings in One-Scale Models and Gravitational Waves](https://arxiv.org/abs/2606.02689)
...
### [30] [Precision Electroweak Constraints on Neutrinophilic Scalars](https://arxiv.org/abs/2606.02704)
...
### [31] [Majoron Dark Matter, High-Scale Seesaw, and Leptogenesis](https://arxiv.org/abs/2606.02706)
...
### [32] [Anatomy and Phenomenology of Minimal Flavor Deconstruction in the Lepton Sector](https://arxiv.org/abs/2606.02709)
...
### [33] [On vacua and bounded masses in the general 2HDM](https://arxiv.org/abs/2606.02710)
...
### [34] [Projected Energy Correlators: Two-Loop Jet Functions and NNLL Resummation](https://arxiv.org/abs/2606.02714)
...
### [35] [Magnetized bottom-up thermalization in heavy-ion collisions](https://arxiv.org/abs/2606.02723)
...
### [36] [Deconstructing the Extra-Dimensional Axion](https://arxiv.org/abs/2606.02728)
...
### [37] [IterInt: Evaluating iterated integrals via differential equations](https://arxiv.org/abs/2606.02744)
...
### [38] [Boosted dark matter via semi-annihilation in a radiative neutrino mass model](https://arxiv.org/abs/2606.02751)
...
### [39] [The decay rate of metastable cosmic strings beyond the thin-string approximation](https://arxiv.org/abs/2606.03008)
...
### [40] [Chiral Quark Soliton Model And Nucleon Parton Distribution Functions](https://arxiv.org/abs/2606.03042)
*Masashi Wakamatsu*
...
### [41] [The Pion Gravitational Form Factors and the Trace Anomaly in QCD Factorization](https://arxiv.org/abs/2606.03055)
...
### [42] [The EIC reduced cross sections at high inelasticity](https://arxiv.org/abs/2606.03186)
*G. R. Boroun*
...
### [43] [Exotic SU(3) Flavor Structures in Fully Light Tetraquark Systems](https://arxiv.org/abs/2606.03333)
...
### [44] [Shedding Stray Light on Decaying Light Dark Matter: Constraints from NuSTAR X-ray Observations](https://arxiv.org/abs/2606.03396)
...
### [45] [Final-state rescattering mechanism of the $Δ(1232)^{++}$ production in $Λ^+_c \to K^- π^+ p$ decay](https://arxiv.org/abs/2606.03411)
...
### [46] [Experimental test of symmetron-field based dark energy model using neutron interferometry](https://arxiv.org/abs/2606.03440)
...
### [47] [Constraints on long-range neutrino interactions from a variety of $U(1)^\prime$ symmetries using atmospheric neutrinos at IceCube DeepCore](https://arxiv.org/abs/2606.03443)
...
### [48] [Gravitino Freeze-In Dark Matter with an Additional Scalar Field](https://arxiv.org/abs/2606.03448)
...
### [49] [Signatures of Ultralight Dark Matter in Space-Based Laser Interferometers](https://arxiv.org/abs/2606.03478)
...
### [50] [Probing Inelastic Dark Matter via Cosmic-Ray Upscattering in NGC 1068](https://arxiv.org/abs/2606.03487)
...
### [51] [$D^0$-$D_s^+$ Elliptic-Flow Splitting under Event-Shape Engineering: A Probe of Sequential Charm Hadronization](https://arxiv.org/abs/2606.03552)
...
### [52] [The Polymorphic Chiral Anomaly](https://arxiv.org/abs/2606.03619)
*Christopher Smith*
...
### [53] [Phase structure of strong interaction matter from Functional QCD](https://arxiv.org/abs/2606.03703)
...
### [54] [Predicting the Neutrino Mass Ordering Using Neural Networks](https://arxiv.org/abs/2606.03745)
...
### [55] [Probing lepton flavor mixing in $W_R$ searches with machine learning at the LHC](https://arxiv.org/abs/2606.03809)
*Jin-Man Cai,Gang Li*
...
### [56] [Space-like Sachs electric and magnetic form factors of the baryons in the asymmetric nuclear medium](https://arxiv.org/abs/2606.03865)
...
### [57] [Probing Singlet Vector-Like Top Quarks in the Hadronic tZ Channel at the HL-LHC using Machine and Deep Learning Architectures](https://arxiv.org/abs/2606.03913)
...
### [58] [Spin-chiral electron-phonon coupling in metallic strontium titanate](https://arxiv.org/abs/2606.03908)
...
### [59] [The pseudogap in high-$T_c$ superconductors from SU(2) gauge symmetry and dynamic correlation effects](https://arxiv.org/abs/2606.02838)
...
### [60] [Simulating Condensed Matter Physics on Quantum Hardware](https://arxiv.org/abs/2606.02721)
