...
### [28] [$a_0(1450)$-state twist-2 light-cone distribution amplitude moments within QCD sum rules and its implication in $\bar B^0\to a_0(1450)^+\ell^-\barν_\ell$ decays](https://arxiv.org/abs/2606.14980)
...
### [29] [Domain walls and magnetic monopoles in Grand Unified Models](https://arxiv.org/abs/2606.14996)
...
### [30] [Causally connected regions in relativistic heavy ion collisions](https://arxiv.org/abs/2606.15130)
...
### [31] [Exploring new physics in the angular distribution of $\bar B\rightarrow D^*(\rightarrow Dπ)τ^-(\rightarrow V^-ν_τ)\barν_τ$](https://arxiv.org/abs/2606.15166)
...
### [32] [Line-of-sight magnetic-field propagation effects on axion-like particle constraints from GRB 221009A](https://arxiv.org/abs/2606.15269)
...
### [33] [Particle and Gravitational Wave Probes of Minimal Seesaw Neutrinos](https://arxiv.org/abs/2606.15316)
...
### [34] [Constructing perfect spin-1 hydrodynamics from Boltzmann to Bose-Einstein statistics](https://arxiv.org/abs/2606.15364)
...
### [35] [Pion radiative decays of excited hidden-charm pentaquark molecules: from $Σ_c^{(*)}\bar{D}^{(*)}(2S)$ molecules to the reported $P_c$ states](https://arxiv.org/abs/2606.15619)
...
### [36] [Production of high-orbital kaon excited states in the $K^{-}p$ reaction](https://arxiv.org/abs/2606.15736)
...
### [37] [Parton wakes and field angular momentum in chiral QCD plasma](https://arxiv.org/abs/2606.15739)
...
### [38] [Why fluctuations of conserved charges in the confining regime above $T_{ch}$ behave as if the quarks were free?](https://arxiv.org/abs/2606.15798)
*L. Ya. Glozman*
...
### [39] [Rescuing flavor-symmetry-forbidden leptogenesis within the left-right symmetric framework](https://arxiv.org/abs/2606.15825)
...
### [40] [Towards the Detection of Thermal Solar Neutrinos](https://arxiv.org/abs/2606.15904)
...
### [41] [Axiverse Strings Resolved](https://arxiv.org/abs/2606.15957)
...
### [42] [LIGO, LISA and Ultralight Axion-like Dark Matter](https://arxiv.org/abs/2606.16099)
*Lawrence M. Krauss*
...
### [43] [Massive right-handed neutrinos in $\bar{B} \to D^* τ\bar X$ decay](https://arxiv.org/abs/2606.16166)
...
### [44] [Dark Matter Attenuation inside the Earth: A Boltzmann Equation Approach](https://arxiv.org/abs/2606.16204)
...
### [45] [Modular $S_4$ Scotogenic Model with Flavored Resonant Leptogenesis](https://arxiv.org/abs/2606.16207)
...
### [46] [Search for Invisibly Decaying Light Scalars at the FCC-ee](https://arxiv.org/abs/2606.16284)
...
### [47] [Determining the Spin Density Matrix via Its Rank and Probing the Quantum Entanglement and Bell Non-Locality at the Lepton Colliders](https://arxiv.org/abs/2606.16365)
...
### [48] [Static linear response of hot and dense QCD matter to electromagnetic fields: Leading hard and soft QCD corrections](https://arxiv.org/abs/2606.16377)
...
### [49] [Chiral-odd structure of the $N \to Δ$ transition: tensor form factors from QCD light-cone sum rules](https://arxiv.org/abs/2606.16433)
*Ulaş Özdem*
...
### [50] [Sommerfeld Enhancement in Spin-1 Electroweak Dark Matter](https://arxiv.org/abs/2606.16442)
...
### [51] [High-quality Axion Strings from Monopole Strings](https://arxiv.org/abs/2606.16445)
...
### [52] [Light-front diagnostics in the 't Hooft model: I. Wave functions, EMT trace decomposition, and Coulomb energy](https://arxiv.org/abs/2606.16625)
*Arkadiy I. Syamtomov*
...
### [53] [A Minimal Dark $U(1)_D$ Framework for Inverse Seesaw Neutrino Masses and Dark Matter](https://arxiv.org/abs/2606.16686)
...
### [54] [Diffractive structure functions from JIMWLK evolution](https://arxiv.org/abs/2606.16705)
...
### [55] [Revealing the nature of double-strangeness pentaquark states via femtoscopic correlation functions](https://arxiv.org/abs/2606.16727)
...
### [56] [Modern Determination of Pion and Kaon Fragmentation Functions from SIA and High-Precision COMPASS SIDIS Multiplicities](https://arxiv.org/abs/2606.16754)
...
### [57] [QCD-like theories at next-to-next-to-leading order with $N_F=2$ non-degenerate fermions](https://arxiv.org/abs/2606.16781)
...
### [58] [Spin-Selective Hadron Spectroscopy via Azimuthal Anisotropies from Entanglement-Enabled Spin Interference](https://arxiv.org/abs/2606.16966)
...
### [59] [Threshold cusp effects to measure masses of radiatively decaying hadrons: The $B_{s0}^*$ mass from the $Υφ$ spectrum](https://arxiv.org/abs/2606.16976)
...
### [60] [Hadronic tensor in lattice gauge theories by quantum computing](https://arxiv.org/abs/2606.17003)
...
### [61] [Scalar $D^{(*)}K^{(*)}$ and $D^{(*)}π(ρ)$ molecular states from B meson decays](https://arxiv.org/abs/2606.17009)
...
### [63] [First Experimental Limit on the Thermal Solar Neutrino Flux](https://arxiv.org/abs/2606.17042)
...
### [64] [Fast, Reliable, and Error-Bounded Option Pricing with Pretrained Neural Networks: A GJR--GARCH Study](https://arxiv.org/abs/2606.15502)
*Thijs van den Berg*
...
### [73] [A Multi-Level Architecture for Reusable Materials Ontologies -- The OntoCrafter Ceramics Ontology (OCO) as Reference Implementation](https://arxiv.org/abs/2606.14814)
...
### [74] [Designing Strong and Broadband Nonreciprocal Thermal Radiation in Magnetic Topological Materials](https://arxiv.org/abs/2606.14861)
...
### [75] [Absence of orbital current torque in a magnetic metal/Pt/CuOx trilayer](https://arxiv.org/abs/2606.14868)
...
### [76] [Atomistic insights into the structural, thermal, and mechanical evolution of $Zr_{47.5}Cu_{47.5}Ag_{5}$ bulk metallic glass](https://arxiv.org/abs/2606.14888)
...
### [77] [Precipitation strengthening: a collective multi-dislocation phenomenon](https://arxiv.org/abs/2606.14890)
...
### [78] [Fermi-Level-Dependent Defect Chemistry and Oxygen Evolution Reaction Activity of Fe-Doped and Oxygen-Deficient \ce{SrTiO3}(001)](https://arxiv.org/abs/2606.14938)
...
### [79] [Dynamically suppressed lattice rotations in SrTiO$_3$ as a basis for photo-induced ferroelectricity](https://arxiv.org/abs/2606.16267)
...
### [80] [Complementary Thermodynamic Mechanisms of Boron and Carbon Segregation at Grain Boundaries in Nickel Alloys](https://arxiv.org/abs/2606.14978)
...
### [81] [Lattice Matching Dictates the Growth Mode and Quality of Deuterium Crystallization in Confined Spherical Shells](https://arxiv.org/abs/2606.16550)
...
### [82] [Ternary-composition tuning of the anomalous Nernst effect in amorphous-like Gd-Co-Pt films](https://arxiv.org/abs/2606.15051)
...
### [83] [Impedance Matching and Absorption Enhancement in Helical Carbon Coil Microwave Absorbers via Tunable Anchoring Layer Thickness](https://arxiv.org/abs/2606.15289)
*Weihua Mu*
...
### [84] [Symmetry-aware generative design of flat-band materials beyond known crystal-net prototypes](https://arxiv.org/abs/2606.15321)
...
### [85] [Nonlocal Orbital-Free Kinetic Energy Functional from the Jellium-with-Gap Model for Finite Systems](https://arxiv.org/abs/2606.15336)
...
### [86] [A Unified Dielectric-Dependent Hybrid Functional for Accurate Band Gaps across Dimensions](https://arxiv.org/abs/2606.15337)
...
### [87] [NIMO: A Software Platform for Closed-Loop Materials Exploration with Diverse AI Algorithms](https://arxiv.org/abs/2606.15522)
...
### [88] [Switching Chern number by sliding and gating in alternately twisted tetralayer MoTe2](https://arxiv.org/abs/2606.15548)
...
### [89] [Unveiling AlSb as a Promising Zincblende Semiconductor for Visible-Light Shift-Current Generation](https://arxiv.org/abs/2606.15613)
...
### [90] [Dimensional Crossover of Mass Anisotropy in Ta-doped WTe2](https://arxiv.org/abs/2606.15620)
...
### [91] [Carbon Layer Orientation and Closed-Pore Construction Achieving Ultra-Low Specific Surface Area Hard Carbon for High-Performance Na-ion Storage](https://arxiv.org/abs/2606.15649)
...
### [92] [Van der waals engineering of valley polarization in WSe2 via kagome V2O3 monolayer heterostructure through magnetic proximity effect](https://arxiv.org/abs/2606.15666)
*Fazle Subhan*
...
### [93] [Surface-Sensitive Mapping of Anisotropic Phonon Cascades in T$_{d}$-WTe$_{2}$](https://arxiv.org/abs/2606.15853)
...
### [94] [Intrinsic linewidths of confined phonons in few-layer hBN](https://arxiv.org/abs/2606.15818)
...
### [95] [Confined Oxygen-Vacancy Migration Drives Ferroelectric Switching](https://arxiv.org/abs/2606.16006)
...
### [96] [Optically Active Fractional Wannier-Center Displacement Drives Giant Second-Harmonic Generation](https://arxiv.org/abs/2606.16108)
...
### [97] [Collective relaxation eigenmodes and anisotropic magnon thermal transport in $α$-MnTe](https://arxiv.org/abs/2606.16129)
...
### [98] [InvDesMobility: a reliability-gated first-principles feedback framework for closed-loop materials discovery](https://arxiv.org/abs/2606.16133)
...
### [99] [Evolution of Nonlinear Ion Transport in Nanopore Arrays: Ionic Conductance, Current Rectification, and Osmotic Power](https://arxiv.org/abs/2606.17012)
...
### [100] [Implementation of rotational invariance for first-principles phonons and application to low-dimensional materials](https://arxiv.org/abs/2606.16320)
...
### [101] [Melt-Quench Failures and Practical Solutions for Universal Machine-Learning Interatomic Potentials in Amorphous Structure Generation](https://arxiv.org/abs/2606.16385)
...
### [102] [Twistronic control of shift current in multilayer moiré system](https://arxiv.org/abs/2606.16416)
...
### [103] [Atom Probe Tomography as an Emerging Tool for Understanding Defect-driven Mechanisms in HfO$_{2}$-based Ferroelectrics](https://arxiv.org/abs/2606.16512)
...
### [104] [Moiré trapping of quadrupolar excitons in van der Waals trilayers](https://arxiv.org/abs/2606.16557)
...
### [105] [Activated Migration of Localized Ligand-Field Excitons in Atomically Thin CrCl3](https://arxiv.org/abs/2606.16702)
...
### [106] [GaN Nucleation Landscape on Patterned Sapphire Shaped by the Growth Temperature of Directly Grown Boron-Compound Masks](https://arxiv.org/abs/2606.16706)
...
### [107] [Data-Driven Micromechanical Characterization and Mapping of Shale Rocks Using High Speed Nanoindentation](https://arxiv.org/abs/2606.16812)
...
### [108] [High-entropy Fe$_2$VAl-based thermoelectric modules with improved conversion efficiency](https://arxiv.org/abs/2606.16851)
...
### [109] [Jahn-Teller effect in $j = 3/2$ Mott insulators: Ground states and thermal fluctuations](https://arxiv.org/abs/2606.14851)
...
### [110] [Topological Tricritical Ising Universality Class in One Dimension](https://arxiv.org/abs/2606.15588)
...
### [111] [Coupled-cluster study of dynamic Jahn-Teller effect in a $5d^2$ W antifluorite](https://arxiv.org/abs/2606.15697)
...
### [112] [Stabilizing Itinerant Electrons in a Corner-Sharing Kagomé Oxide Nd4Os3ZnO14](https://arxiv.org/abs/2606.15774)
...
### [113] [Probing Interfacial Magnetic Anisotropy in \texorpdfstring{CoV$_{2}$O$_{4}$}{CoV2O4} using Spin Hall Magnetoresistance](https://arxiv.org/abs/2606.15865)
...
### [114] [Staggered Virtual-Loop-Current Order in Pseudospin-1 Dirac Flat Bands](https://arxiv.org/abs/2606.16155)
...
### [115] [Evaluating the Structural Basis for Polar Altermagnet Candidate Ca$_{3}$(Ru,Ti)$_{2}$O$_{7}$](https://arxiv.org/abs/2606.16181)
...
### [116] [symveig: Verified eigenvalue enclosures for symmetry-decomposed Hermitian matrices](https://arxiv.org/abs/2606.16217)
...
### [117] [Interfacial control of magnetism and electron transport in nonisostructural SrRuO$_3$/SrCuO$_2$ heterostructure](https://arxiv.org/abs/2606.16235)
...
### [118] [Orbital-selective band evolution and out-of-plane correlation in the FeGe-family kagome antiferromagnet ScFe$_6$Ge$_6$](https://arxiv.org/abs/2606.16245)
...
### [119] [Multiband transport hierarchy and large Nernst effect in EuAuBi: Establishing a Nernst scaling for asymmetric multiband systems](https://arxiv.org/abs/2606.16249)
...
### [120] [Quantum oscillations in proximity to high-angular-momentum band inversion](https://arxiv.org/abs/2606.16397)
...
### [121] [Intervalley coherence and flavor polarization in three-valley moiré systems](https://arxiv.org/abs/2606.16622)
...
### [122] [Field-selected seven-site topological magnons in a classical frustrated triangular-lattice K-$Γ$-$Γ'$ magnet](https://arxiv.org/abs/2606.16704)
...
### [123] [Spin-orbit-entangled $J_{\rm eff}=\frac{1}{2}$ magnetism and unconventional spin freezing in the bond-disordered pyrochlore antiferromagnet NaCdCo$_2$F$_7$](https://arxiv.org/abs/2606.16875)
...
### [124] [Electronic Green's function across the pseudogap to stripe transition in the $t$-$t'$-$J$ model](https://arxiv.org/abs/2606.16968)
...
### [125] [Disentangling multi-spin dynamic correlations in the Heisenberg spin-$\frac{1}{2}$ chain](https://arxiv.org/abs/2606.16992)
...
### [126] [Compact Spin-Charge Separated Neural Quantum States for Valence-Bond States](https://arxiv.org/abs/2606.17045)
...
### [127] [Machine Learning-Driven Chemical Reactor Network Modeling of the Sandia-D Flame](https://arxiv.org/abs/2606.14729)
...
### [128] [Distilling latent electrostatics from foundation machine learning interatomic potentials](https://arxiv.org/abs/2606.15001)
...
### [129] [Atomic Design Transformer: xTB-Validated 3D Molecule Generation from Scaffolds](https://arxiv.org/abs/2606.15220)
*Takao Kotani*
...
### [130] [Contrastive learning of dynamical representations for enhanced molecular sampling](https://arxiv.org/abs/2606.15495)
...
### [131] [Liquid Random Feature Methods for Time-Dependent Partial Differential Equations](https://arxiv.org/abs/2606.15571)
...
### [132] [Accelerating Kinetic Fokker-Planck Simulations via a GPU-Native Deep Neural Network Surrogate: Application to Rarefied Internal and Hypersonic External Flows](https://arxiv.org/abs/2606.15622)
*Ehsan Roohi*
...
### [133] [A GPGPU-Oriented Full Phase-Space Parallel Unified Gas-Kinetic Scheme with Velocity-Block Pipelining](https://arxiv.org/abs/2606.15720)
